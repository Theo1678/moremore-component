import { defineComponent as a, createElementBlock as t, openBlock as l, createElementVNode as o, ref as x, computed as L, onMounted as X1, onUnmounted as K1, watch as X, createBlock as d, createCommentVNode as B, normalizeClass as H, normalizeStyle as j, Fragment as V, renderList as Z, renderSlot as l1, createTextVNode as D, toDisplayString as M, createStaticVNode as o1, createVNode as O, withModifiers as z, withCtx as q, unref as u, h as t1 } from "vue";
const W1 = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
...
}, Y1 = ["fill"], n1 = /* @__PURE__ */ a({
  __name: "IcArrowLeft",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", W1, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, J1 = ["fill"], J = /* @__PURE__ */ a({
  __name: "IcArrowRight",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", q1, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  setup(r, { expose: e, emit: s }) {
    const n = r, m = s, A = x(null), N = x(null), S = x(null), T = x(null), c = x(n.initialSlide), k = x(!1), p = x(!1), I = x({ x: 0, y: 0 }), h = x({ x: 0, y: 0 }), y = x(0), f = x(null), _ = L(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), C = L(() => Math.floor(c.value / n.slidesPerView)), v = L(() => {
      const i = Math.ceil(n.items.length / n.slidesPerView);
      return Array.from({ length: i }, (w, $) => $);
    }), g = L(() => (console.log("showPrevButton", n.loop, c.value, _.value), n.loop || c.value > 0)), b = L(() => (console.log("showNextButton", n.loop, c.value, _.value), n.loop || c.value < _.value)), R = L(() => N.value ? (N.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), S1 = L(() => ({
      overflow: "hidden",
      position: "relative"
    })), T1 = L(() => {
      const i = -(c.value * (R.value + n.spaceBetween)) + y.value;
      return {
        display: "flex",
        transition: k.value && !p.value ? `transform ${n.speed}ms ${n.easing}` : "none",
        transform: `translateX(${i}px)`,
        gap: `${n.spaceBetween}px`
      };
    }), F1 = L(() => {
      if (!n.items.length) return { width: "0%", left: "0%" };
      const i = c.value / _.value, w = n.slidesPerView / n.items.length * 100, $ = i * (100 - w);
      return {
        width: `${w}%`,
        left: `${$}%`,
        transition: k.value ? `all ${n.speed}ms ${n.easing}` : "none"
      };
    }), D1 = L(() => ({
      "swiper-pagination-horizontal": !0,
      "swiper-pagination-bullets": !0
    })), P1 = (i, w) => n.keyName && i[n.keyName] ? i[n.keyName] : w, G1 = (i) => ({}), R1 = (i) => ({
      width: `${R.value}px`,
      flexShrink: 0
    }), F = (i, w = n.speed) => {
      if (k.value && !p.value) return;
      const $ = Math.max(0, Math.min(i, _.value));
      $ !== c.value && (k.value = !0, m("transitionStart", { index: $ }), c.value = $, setTimeout(() => {
        k.value = !1, m("transitionEnd", { index: $ }), m("slideChange", { index: $, item: n.items[$] }), $ === 0 && m("reachBeginning"), $ === _.value && m("reachEnd");
      }, w));
    }, P = () => {
      n.loop && c.value === _.value ? F(0) : F(c.value + 1);
    }, U = () => {
      n.loop && c.value === 0 ? F(_.value) : F(c.value - 1);
    }, U1 = (i) => {
      n.allowTouchMove && (p.value = !0, I.value = { x: i.clientX, y: i.clientY }, h.value = { x: i.clientX, y: i.clientY }, document.addEventListener("mousemove", W), document.addEventListener("mouseup", Y), m("touchStart", i));
    }, W = (i) => {
      if (!p.value) return;
      h.value = { x: i.clientX, y: i.clientY };
      const w = (h.value.x - I.value.x) * n.touchRatio;
      y.value = w, m("touchMove", i);
    }, Y = (i) => {
      if (!p.value) return;
      const w = h.value.x - I.value.x;
      Math.abs(w) > n.threshold && (w > 0 ? U() : P()), p.value = !1, y.value = 0, document.removeEventListener("mousemove", W), document.removeEventListener("mouseup", Y), m("touchEnd", i);
    }, j1 = (i) => {
      if (!n.allowTouchMove) return;
      p.value = !0;
      const w = i.touches[0];
      I.value = { x: w.clientX, y: w.clientY }, h.value = { x: w.clientX, y: w.clientY }, m("touchStart", i);
    }, O1 = (i) => {
      if (!p.value) return;
      const w = i.touches[0];
      h.value = { x: w.clientX, y: w.clientY };
      const $ = (h.value.x - I.value.x) * n.touchRatio;
      y.value = $, m("touchMove", i);
    }, z1 = (i) => {
      if (!p.value) return;
      const w = h.value.x - I.value.x;
      Math.abs(w) > n.threshold && (w > 0 ? U() : P()), p.value = !1, y.value = 0, m("touchEnd", i);
    }, Q = () => {
      if (!n.autoplay) return;
      const i = typeof n.autoplay == "object" && n.autoplay.delay || 3e3;
      f.value = setInterval(() => {
        P();
      }, i);
    }, e1 = () => {
    ...
    return X1(() => {
      ...
      e1(), document.removeEventListener("mousemove", W), document.removeEventListener("mouseup", Y);
    }), X(
      () => n.autoplay,
      (i) => {
        i ? Q() : e1();
      ...
      slideToNext: P,
      slideToPrev: U,
      currentIndex: L(() => c.value),
      isTransitioning: L(() => k.value)
    }), (i, w) => (l(), t("div", {
      class: "swiper-container",
      ref_key: "swiperContainer",
      ref: A
    }, [
      i.showNavigation ? (l(), d(n1, {
        key: 0,
        onClick: U,
        class: H(["swiper-button-prev", {
          "type-multiple": i.multiple,
      ...
      o("div", {
        ...
        o("div", {
          ...
          (l(!0), t(V, null, Z(i.items, ($, E) => (l(), t("div", {
            key: P1($, E),
            class: H(["swiper-slide", {
              "swiper-slide-active": E === c.value,
              "swiper-slide-prev": E === c.value - 1,
              "swiper-slide-next": E === c.value + 1,
              ...G1()
            }]),
            style: j(R1())
          }, [
      ...
      i.showNavigation ? (l(), d(J, {
        key: 1,
        onClick: P,
        class: H(["swiper-button-next", {
          "type-multiple": i.multiple,
          "swiper-button-disabled": c.value === _.value,
          "swiper-button-hidden": !b.value
        }])
      }, null, 8, ["class"])) : B("", !0),
      i.showPagination ? (l(), t("div", {
        key: 2,
        class: H(["swiper-pagination", D1.value])
      }, [
        (l(!0), t(V, null, Z(v.value, ($, E) => (l(), t("button", {
          key: E,
          onClick: (Oe) => F(E * i.slidesPerView),
          class: H(["swiper-pagination-bullet", {
            "swiper-pagination-bullet-active": E === C.value
          }])
        }, [
          l1(i.$slots, "pagination-bullet", {
            index: E,
            isActive: E === C.value
          }, () => [
  ...
  for (const [n, m] of e)
    s[n] = m;
  return s;
}, K = /* @__PURE__ */ G(e2, [["__scopeId", "data-v-6ed75995"]]), l2 = { class: "w-full py-6 px-5" }, o2 = { class: "flex gap-2" }, t2 = { class: "p-3" }, s2 = { class: "flex gap-2" }, r1 = /* @__PURE__ */ a({
  __name: "CardSkeleton",
  props: {
    type: { default: "user" }
  },
  setup(r) {
    return (e, s) => (l(), t("div", {
      ...
      e.type === "admin" ? (l(), t(V, { key: 0 }, [
        s[2] || (s[2] = o1('<div class="px-3 py-[20px] md:py-[26px]"><div class="flex items-center gap-4"><div class="w-24 h-24 rounded-full bg-gray-200 flex-shrink-0"></div><div class="flex-1"><div class="flex items-center justify-between gap-3 mb-2"><div class="h-[22px] bg-gray-200 rounded w-3/4"></div><div class="h-[22px] bg-gray-200 rounded w-[80px]"></div></div><div class="space-y-2 mt-4"><div class="h-[22px] bg-gray-200 rounded w-full"></div><div class="h-[22px] bg-gray-200 rounded w-4/5"></div></div><div class="h-[20px] bg-gray-200 rounded w-1/3 mt-4"></div></div></div></div><div class="border-t border-gray-200"></div>', 2)),
        o("div", l2, [
          s[1] || (s[1] = o("div", { class: "h-[22px] bg-gray-200 rounded w-[80px] mb-4" }, null, -1)),
          o("div", o2, [
            (l(), t(V, null, Z(4, (n) => o("div", {
              key: n,
        ...
        s[4] || (s[4] = o("div", { class: "aspect-[4/3] bg-gray-200 rounded-lg" }, null, -1)),
        o("div", t2, [
          s[3] || (s[3] = o1('<div class="h-6 bg-gray-200 rounded w-[80px] mb-2"></div><div class="h-5 bg-gray-200 rounded w-3/4 mb-2"></div><div class="space-y-2 mb-3"><div class="h-4 bg-gray-200 rounded w-full"></div><div class="h-4 bg-gray-200 rounded w-5/6"></div></div><div class="h-4 bg-gray-200 rounded w-1/2 mb-3"></div><div class="h-4 bg-gray-200 rounded w-2/3 mb-3"></div>', 5)),
          o("div", s2, [
            (l(), t(V, null, Z(3, (n) => o("div", {
              key: n,
...
}), n2 = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 !gap-8 mb-12 items-start" }, r2 = { class: "w-full max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 overflow-hidden h-full flex flex-col" }, i2 = ["onClick"], a2 = { class: "flex items-center gap-4 h-full" }, c2 = { class: "w-24 h-24 rounded-full border border-gray-300 bg-gray-50 flex-shrink-0 overflow-hidden" }, d2 = ["src", "alt", "onError"], u2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-1"
}, C2 = { class: "flex-1 min-w-0 text-left flex flex-col justify-center" }, p2 = { class: "font-pretendard text-[17px] font-bold leading-[22px] line-clamp-2 text-[#060608]" }, h2 = {
  key: 0,
  class: "flex items-center gap-2 px-2 py-1 rounded-md flex-shrink-0"
}, f2 = { class: "text-xs font-medium text-[#303040]" }, _2 = {
  key: 0,
...
}, g2 = { class: "w-full py-6 px-5 mt-auto" }, w2 = {
  key: 0,
  class: "flex items-center justify-center gap-2"
}, m2 = ["onClick"], y2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, I2 = ["src", "alt"], $2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, k2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, x2 = ["onClick"], b2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, L2 = ["src", "alt"], M2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, H2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, B2 = /* @__PURE__ */ a({
  ...
  setup(r, { emit: e }) {
    const s = r, n = e, m = x(/* @__PURE__ */ new Set()), A = x(s.maxItems);
    X(
      () => s.maxItems,
      (h) => {
        A.value = h;
    ...
    const N = L(() => s.shops.slice(0, A.value)), S = (h) => {
      n("shop-click", h);
    }, T = (h) => {
      n("partnerUser-click", h);
    }, c = (h) => {
      const y = "w-2 h-2 rounded-full";
      switch (h) {
      ...
      m.value.add(h);
    }, I = (h) => h.thumbImgUrl && !m.value.has(h.collaborationId);
    return (h, y) => (l(), t("div", n2, [
      h.loading ? (l(), t(V, { key: 0 }, Z(6, (f) => O(r1, {
        key: f,
        type: "admin"
      })), 64)) : (l(!0), t(V, { key: 1 }, Z(N.value, (f) => (l(), t("div", {
        key: f.collaborationId,
            ...
            o("div", a2, [
              o("div", c2, [
                I(f) ? (l(), t("img", {
                  ...
                  src: f.thumbImgUrl,
                  alt: f.marketName,
                  onError: (_) => p(f.collaborationId),
                  class: "w-full h-full object-cover"
                }, null, 40, d2)) : (l(), t("div", u2, y[0] || (y[0] = [
              ...
              o("div", C2, [
                o("div", {
                  class: H([
                    ...
                    h.isMobile ? "flex-col items-start gap-2" : "flex-row items-center gap-3"
                  ])
                }, [
                  o("h2", p2, M(f.marketName), 1),
                  f.statusCode ? (l(), t("div", h2, [
                    o("div", {
                      class: H(c(f.statusCode))
                    }, null, 2),
                    o("span", f2, M(k(f.statusCode)), 1)
                  ])) : B("", !0)
                ], 2),
                f.description ? (l(), t("p", _2, M(f.description), 1)) : B("", !0),
                f.period ? (l(), t("p", v2, M(f.period), 1)) : B("", !0)
              ])
            ])
          ], 8, i2),
          y[4] || (y[4] = o("div", { class: "border-t border-gray-200" }, null, -1)),
          o("div", g2, [
            y[3] || (y[3] = o("h3", { class: "text-left font-pretendard text-[15px] font-bold leading-[22px] mb-2 text-[#303040]" }, " 참여작가 ", -1)),
            f.partnerUsersData && f.partnerUsersData.length > 0 ? (l(), t("div", {
              key: 0,
              class: H(f.partnerUsersData.length > 4 ? "px-8" : "")
            }, [
              f.partnerUsersData.length <= 4 ? (l(), t("div", w2, [
                (l(!0), t(V, null, Z(f.partnerUsersData, (_) => (l(), t("div", {
                  key: _.id || _.nickName,
                  class: "w-16 flex flex-col items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity",
                  onClick: z((C) => T(_), ["stop"])
                }, [
                  o("div", y2, [
                    _.profileImgUrl ? (l(), t("img", {
                      key: 0,
                      src: _.profileImgUrl,
                      alt: _.nickName,
                      class: "w-full h-full object-cover"
                    }, null, 8, I2)) : (l(), t("div", $2, y[1] || (y[1] = [
                      o("svg", {
                  ...
                  o("span", k2, M(_.nickName), 1)
                ], 8, m2))), 128))
              ])) : (l(), d(K, {
                key: 1,
                items: f.partnerUsersData,
                multiple: !0,
                slidesPerView: 4,
                spaceBetween: 8,
                "show-pagination": !1,
...
}), V2 = { class: "w-full" }, N2 = ["onClick"], E2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, Z2 = ["src", "alt", "onError"], A2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-2"
}, S2 = { class: "p-3 text-left" }, T2 = {
  key: 0,
  class: "mb-2"
}, F2 = { class: "text-sm font-bold text-[#060608] mb-2 line-clamp-1" }, D2 = {
  key: 1,
  class: "text-xs text-[#778196] mb-3 line-clamp-3"
}, P2 = {
  key: 2,
  class: "text-xs mb-3 text-[#778196]"
}, G2 = {
  key: 3,
  ...
  key: 0,
  class: "w-full"
}, j2 = ["onClick"], O2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, z2 = ["src", "alt"], X2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, K2 = { class: "text-xs text-[#060608] truncate" }, W2 = {
  key: 1,
  class: "flex items-center justify-center gap-2 flex-wrap"
}, Y2 = ["onClick"], q2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, J2 = ["src", "alt"], Q2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, e3 = { class: "text-xs text-[#060608] truncate" }, l3 = /* @__PURE__ */ a({
  ...
  props: {
    ...
    maxItems: { default: 8 },
    loading: { type: Boolean, default: !1 },
    isMobile: { type: Boolean, default: !0 }
  },
  emits: ["shop-click", "partnerUser-click"],
  setup(r, { emit: e }) {
    const s = r, n = e, m = x(!1), A = x(null), N = x(/* @__PURE__ */ new Set()), S = x(s.maxItems);
    X(
      () => s.maxItems,
      (C) => {
        S.value = C;
    ...
    const T = L(() => s.shops.slice(0, S.value)), c = (C) => {
      A.value = C, m.value = !0, n("shop-click", C);
    }, k = (C) => {
      n("partnerUser-click", C);
    }, p = (C) => {
      ...
      N.value.add(C);
    }, f = (C) => C.thumbImgUrl && !N.value.has(C.collaborationId), _ = L(() => {
      const C = s.itemsPerRow;
      let v = "grid grid-cols-1";
      return C >= 2 && (v += " md:grid-cols-2"), C >= 3 && (v += " lg:grid-cols-3"), C >= 4 && (v += " xl:grid-cols-4"), C >= 5 && (v += " 2xl:grid-cols-5"), C >= 6 && (v += " 2xl:grid-cols-6"), `${v} gap-8`;
    });
    return (C, v) => (l(), t("div", V2, [
      o("div", {
        class: H(_.value)
      }, [
        C.loading ? (l(), t(V, { key: 0 }, Z(6, (g) => O(r1, {
          key: g,
          type: "user"
        })), 64)) : (l(!0), t(V, { key: 1 }, Z(T.value, (g) => (l(), t("div", {
          ...
          o("div", E2, [
            f(g) ? (l(), t("img", {
              ...
              src: g.thumbImgUrl,
              alt: g.marketName,
              onError: (b) => y(g.collaborationId),
              class: "w-full h-full object-cover"
            }, null, 40, Z2)) : (l(), t("div", A2, v[0] || (v[0] = [
              o("div", { class: "w-8 h-8 bg-gray-300 rounded flex items-center justify-center" }, [
                o("svg", {
                  class: "w-4 h-4 text-gray-500",
                  fill: "currentColor",
          ...
          o("div", S2, [
            g.statusCode ? (l(), t("div", T2, [
              o("div", {
                class: H([p(g.statusCode), "text-[#303040]"])
              }, [
                o("div", {
                  class: H(I(g.statusCode))
                }, null, 2),
                D(" " + M(h(g.statusCode)), 1)
              ], 2)
            ])) : B("", !0),
            o("h3", F2, M(g.marketName), 1),
            g.description ? (l(), t("p", D2, M(g.description), 1)) : B("", !0),
            g.period ? (l(), t("p", P2, M(g.period), 1)) : B("", !0),
            g.hashtags ? (l(), t("p", G2, M(g.hashtags), 1)) : B("", !0),
            g.partnerUsersData && g.partnerUsersData.length > 0 ? (l(), t("div", R2, [
              C.isMobile ? (l(), t("div", U2, [
                O(K, {
                  items: g.partnerUsersData,
                  slidesPerView: g.partnerUsersData.length > 2 ? 2.5 : g.partnerUsersData.length,
                  spaceBetween: 8,
                  showNavigation: !1,
                  showPagination: !1,
                  allowTouchMove: !0
                  ...
                  default: q(({ item: b }) => [
                    o("div", {
                      ...
                      onClick: z((R) => k(b), ["stop"])
                    }, [
                      o("div", O2, [
                        b.profileImgUrl ? (l(), t("img", {
                          key: 0,
                          src: b.profileImgUrl,
                          alt: b.nickName,
                          class: "w-full h-full object-cover"
                        }, null, 8, z2)) : (l(), t("div", X2, v[1] || (v[1] = [
                          o("svg", {
                      ...
                      o("span", K2, M(b.nickName), 1)
                    ], 8, j2)
                  ]),
                  _: 2
                }, 1032, ["items", "slidesPerView"])
              ])) : (l(), t("div", W2, [
                (l(!0), t(V, null, Z(g.partnerUsersData, (b) => (l(), t("div", {
                  key: b.id,
...
}), o3 = /* @__PURE__ */ G(l3, [["__scopeId", "data-v-e70f99ca"]]), t3 = { class: "w-full" }, s3 = {
  key: 0,
  class: "px-5"
}, n3 = { class: "grid grid-cols-3 gap-2 auto-rows-fr" }, r3 = ["onClick"], i3 = {
  key: 1,
  class: "flex items-stretch px-5 flex-wrap gap-4"
}, a3 = ["onClick"], c3 = /* @__PURE__ */ a({
  __name: "TabGroup",
  props: {
    tabs: { default: () => [
      { id: "all", label: "전체" },
  ...
  setup(r, { emit: e }) {
    const s = r, n = e, m = x(s.modelValue), A = (c) => {
      m.value = c.id, n("update:modelValue", c.id), n("tab-change", c);
    }, N = (c) => {
      const k = m.value === c.id, I = `flex items-center justify-center focus:outline-none hover:border-[#F66D96] border-1 ${s.isMobile ? "rounded-lg" : "rounded-xl"}`;
      return k ? `${I} bg-[#FFE8F0] border-[#F66D96] border-2` : `${I} bg-white border-[#CFD3DA] border-2`;
    }, S = (c) => {
      const k = m.value === c.id, I = `${s.isMobile ? "text-xs" : "text-sm"} font-bold text-center whitespace-nowrap`;
      return k ? `${I} text-[#F66D96]` : `${I} text-[#424855]`;
    }, T = L(() => {
      const k = [];
      for (let p = 0; p < s.tabs.length; p += 6)
        k.push(s.tabs.slice(p, p + 6));
      return k;
    });
    return X(
      () => s.modelValue,
      ...
      c.isMobile ? (l(), t("div", s3, [
        O(K, {
          ...
          default: q(({ item: p }) => [
            o("div", n3, [
              (l(!0), t(V, null, Z(p, (I) => (l(), t("button", {
                key: I.id,
                class: H([N(I), "px-3 py-2"]),
                onClick: (h) => A(I),
                type: "button"
              }, [
                o("span", {
        ...
        (l(!0), t(V, null, Z(c.tabs, (p) => (l(), t("button", {
          key: p.id,
          class: H([N(p), "px-4 py-3"]),
          onClick: (I) => A(p),
          type: "button"
        }, [
          o("span", {
...
}), d3 = /* @__PURE__ */ G(c3, [["__scopeId", "data-v-22e6374c"]]), u3 = /* @__PURE__ */ a({
  __name: "ElementIcon",
  props: {
    elementIcon: {},
    color: {}
  ...
  setup(r) {
    return (e, s) => e.elementIcon === "IcApp" ? (l(), d(u(i1), {
      key: 0,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChart" ? (l(), d(u(a1), {
      key: 1,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPerson" ? (l(), d(u(h1), {
      key: 2,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcOption" ? (l(), d(u(C1), {
      key: 3,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcHelp" ? (l(), d(u(c1), {
      key: 4,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcInfo" ? (l(), d(u(d1), {
      key: 5,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcNotification" ? (l(), d(u(u1), {
      key: 6,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPayback" ? (l(), d(u(p1), {
      key: 7,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlane" ? (l(), d(u(f1), {
      key: 8,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSetting" ? (l(), d(u(v1), {
      key: 9,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcUpdate" ? (l(), d(u(_1), {
      key: 10,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMedia" ? (l(), d(u(g1), {
      key: 11,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLink" ? (l(), d(u(w1), {
      key: 12,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcArrowRight" ? (l(), d(u(J), {
      key: 13,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDown" ? (l(), d(u(m1), {
      key: 14,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcGraphicEmpty" ? (l(), d(u(y1), {
      key: 15,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCopy" ? (l(), d(u(I1), {
      key: 16,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDelete" ? (l(), d(u($1), {
      key: 17,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlus" ? (l(), d(u(k1), {
      key: 18,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMoreVertical" ? (l(), d(u(x1), {
      key: 19,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCancleFill" ? (l(), d(u(b1), {
      key: 20,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChecked" ? (l(), d(u(L1), {
      key: 21,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSparkle" ? (l(), d(u(M1), {
      key: 22,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcStock" ? (l(), d(u(ce), {
      key: 23,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPreview" ? (l(), d(u(H1), {
      key: 24,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLoadingPrimary" ? (l(), d(u(N1), {
      key: 25,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLayer" ? (l(), d(u(E1), {
      key: 26,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCta" ? (l(), d(u(Z1), {
      key: 27,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSearch" ? (l(), d(u(B1), {
      key: 28,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcClose" ? (l(), d(u(V1), {
      key: 29,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreUser" ? (l(), d(u(Ae), {
      key: 30,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (l(), d(u(Ge), {
      key: 31,
      color: e.color
    }, null, 8, ["color"])) : B("", !0);
  }
}), C3 = /* @__PURE__ */ G(u3, [["__scopeId", "data-v-f12d6798"]]), p3 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, h3 = ["fill"], i1 = /* @__PURE__ */ a({
  __name: "IcApp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", p3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, _3 = ["fill"], a1 = /* @__PURE__ */ a({
  __name: "IcChart",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", f3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, g3 = ["fill"], c1 = /* @__PURE__ */ a({
  __name: "IcHelp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", v3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, m3 = ["fill"], d1 = /* @__PURE__ */ a({
  __name: "IcInfo",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", w3, [
      s[0] || (s[0] = o("circle", {
        cx: "12",
        cy: "11.9922",
        r: "6",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, I3 = ["fill"], u1 = /* @__PURE__ */ a({
  __name: "IcNotification",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", y3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, k3 = ["fill"], C1 = /* @__PURE__ */ a({
  __name: "IcOption",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", $3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, b3 = ["fill"], p1 = /* @__PURE__ */ a({
  __name: "IcPayback",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", x3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, M3 = ["fill"], h1 = /* @__PURE__ */ a({
  __name: "IcPerson",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", L3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, B3 = ["fill"], f1 = /* @__PURE__ */ a({
  __name: "IcPlane",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", H3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, Z3 = ["fill"], v1 = /* @__PURE__ */ a({
  __name: "IcSetting",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", E3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, S3 = ["fill"], g1 = /* @__PURE__ */ a({
  __name: "IcMedia",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", A3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, F3 = ["fill"], w1 = /* @__PURE__ */ a({
  __name: "IcLink",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", T3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, P3 = ["fill"], m1 = /* @__PURE__ */ a({
  __name: "IcDown",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", D3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, U3 = { id: "Group 395" }, j3 = ["fill"], O3 = ["fill"], I1 = /* @__PURE__ */ a({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", R3, [
      o("g", U3, [
        o("path", {
          id: "Vector (Stroke)",
          "fill-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, X3 = ["fill"], $1 = /* @__PURE__ */ a({
  __name: "IcDelete",
  props: {
    color: { default: () => "#FF4136" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", z3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, W3 = { id: "ic-plus" }, Y3 = ["fill"], k1 = /* @__PURE__ */ a({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", K3, [
      o("g", W3, [
        o("path", {
          id: "Union",
          "fill-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, J3 = ["fill"], Q3 = ["fill"], ee = ["fill"], x1 = /* @__PURE__ */ a({
  __name: "IcMoreVertical",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", q3, [
      o("ellipse", {
        cx: "10",
        cy: "15.8333",
        rx: "1.25",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, oe = ["fill"], b1 = /* @__PURE__ */ a({
  __name: "IcCancleFill",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", le, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, se = ["fill"], L1 = /* @__PURE__ */ a({
  __name: "IcChecked",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", te, [
      o("circle", {
        cx: "8",
        cy: "8",
        r: "8",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, re = ["fill"], M1 = /* @__PURE__ */ a({
  __name: "IcSparkle",
  props: {
    color: { default: () => "#0080FF" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", ne, [
      o("path", {
  ...
  viewBox: "0 0 20 21",
  fill: "none"
}, ae = ["fill"], ce = /* @__PURE__ */ a({
  __name: "IcStock",
  props: {
    color: { default: () => "#060608" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", ie, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, ue = ["fill"], H1 = /* @__PURE__ */ a({
  __name: "IcPreview",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", de, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, pe = ["fill"], B1 = /* @__PURE__ */ a({
  __name: "IcSearch",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", Ce, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, fe = ["fill"], V1 = /* @__PURE__ */ a({
  __name: "IcClose",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", he, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, ge = { "clip-path": "url(#clip0_3951_314363)" }, we = ["fill"], me = ["fill"], ye = ["fill"], Ie = ["fill"], $e = ["fill"], ke = ["fill"], xe = ["fill"], be = ["fill"], Le = /* @__PURE__ */ a({
  __name: "IcLoadingPrimary",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(r) {
    return (e, s) => (l(), t("div", _e, [
      (l(), t("svg", ve, [
        o("g", ge, [
          o("path", {
...
}), N1 = /* @__PURE__ */ G(Le, [["__scopeId", "data-v-9156a366"]]), Me = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, He = ["fill"], E1 = /* @__PURE__ */ a({
  __name: "IcLayer",
  props: {
    color: { default: () => "#060608" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", Me, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, Ve = ["fill"], Z1 = /* @__PURE__ */ a({
  __name: "IcCta",
  props: {
    color: { default: () => "#716497" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", Be, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, Ee = ["stroke"], Ze = ["stroke"], Ae = /* @__PURE__ */ a({
  __name: "IcCoreUser",
  props: {
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, Te = { "clip-path": "url(#clip0_1979_140961)" }, Fe = ["stroke"], De = ["stroke"], Pe = ["stroke"], Ge = /* @__PURE__ */ a({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", Se, [
      o("g", Te, [
        o("path", {
...
const Ue = {
  ...
  TabGroup: d3,
  Swiper: K
}, A1 = Re(Ue), { AdminCreateCards: Xe, UserCreateCards: Ke, TabGroup: We, Swiper: Ye } = A1, s1 = [
  ...Object.values(A1),
  C3,
  i1,
  a1,
  ...
  install(r, e = {}) {
    s1.forEach((s) => {
      const n = s.name || "UnnamedComponent";
      r.component(n, s);
    }), e.prefix && s1.forEach((s) => {
      const n = s.name || "UnnamedComponent";
      r.component(`${e.prefix}${n}`, s);
    });
  }
};
typeof window < "u" && window.Vue && window.Vue.use(je);
export {
  Xe as AdminCreateCards,
  C3 as ElementIcon,
  i1 as IcApp,
  n1 as IcArrowLeft,
  J as IcArrowRight,
  ...
  $1 as IcDelete,
  m1 as IcDown,
  y1 as IcGraphicEmpty,
  c1 as IcHelp,
  d1 as IcInfo,
  E1 as IcLayer,
  w1 as IcLink,
  N1 as IcLoadingPrimary,
  g1 as IcMedia,
  x1 as IcMoreVertical,
