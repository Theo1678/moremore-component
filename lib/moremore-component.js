import { defineComponent as a, createElementBlock as t, openBlock as l, createElementVNode as o, ref as $, computed as b, onMounted as z1, onUnmounted as X1, watch as j, createBlock as c, createCommentVNode as M, normalizeClass as H, normalizeStyle as U, Fragment as B, renderList as E, renderSlot as J, createTextVNode as D, toDisplayString as L, createStaticVNode as Q, createVNode as o1, withModifiers as K, withCtx as K1, unref as d, h as e1 } from "vue";
const W1 = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
  ...
  setup(r, { expose: e, emit: s }) {
    const n = r, v = s, Z = $(null), V = $(null), F = $(null), k = $(null), C = $(n.initialSlide), y = $(!1), x = $(!1), A = $({ x: 0, y: 0 }), h = $({ x: 0, y: 0 }), m = $(0), p = $(null), f = b(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), u = b(() => Math.floor(C.value / n.slidesPerView)), g = b(() => {
      const i = Math.ceil(n.items.length / n.slidesPerView);
      return Array.from({ length: i }, (_, I) => I);
    }), w = b(() => (console.log("showPrevButton", n.loop, C.value, f.value), n.loop || C.value > 0)), S = b(() => (console.log("showNextButton", n.loop, C.value, f.value), n.loop || C.value < f.value)), O = b(() => V.value ? (V.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), A1 = b(() => ({
      overflow: "hidden",
      position: "relative"
    })), S1 = b(() => {
      const i = -(C.value * (O.value + n.spaceBetween)) + m.value;
      return {
        display: "flex",
        transition: y.value && !x.value ? `transform ${n.speed}ms ${n.easing}` : "none",
        transform: `translateX(${i}px)`,
        gap: `${n.spaceBetween}px`
      };
    }), F1 = b(() => {
      if (!n.items.length) return { width: "0%", left: "0%" };
      const i = C.value / f.value, _ = n.slidesPerView / n.items.length * 100, I = i * (100 - _);
      return {
        width: `${_}%`,
        left: `${I}%`,
        transition: y.value ? `all ${n.speed}ms ${n.easing}` : "none"
      };
    }), T1 = b(() => ({
      "swiper-pagination-horizontal": !0,
      "swiper-pagination-bullets": !0
    })), D1 = (i, _) => n.keyName && i[n.keyName] ? i[n.keyName] : _, R1 = (i) => ({}), G1 = (i) => ({
      width: `${O.value}px`,
      flexShrink: 0
    }), T = (i, _ = n.speed) => {
      if (y.value && !x.value) return;
      const I = Math.max(0, Math.min(i, f.value));
      I !== C.value && (y.value = !0, v("transitionStart", { index: I }), C.value = I, setTimeout(() => {
        y.value = !1, v("transitionEnd", { index: I }), v("slideChange", { index: I, item: n.items[I] }), I === 0 && v("reachBeginning"), I === f.value && v("reachEnd");
      }, _));
    }, R = () => {
      n.loop && C.value === f.value ? T(0) : T(C.value + 1);
    }, P = () => {
      n.loop && C.value === 0 ? T(f.value) : T(C.value - 1);
    }, P1 = (i) => {
      n.allowTouchMove && (x.value = !0, A.value = { x: i.clientX, y: i.clientY }, h.value = { x: i.clientX, y: i.clientY }, document.addEventListener("mousemove", z), document.addEventListener("mouseup", X), v("touchStart", i));
    }, z = (i) => {
      if (!x.value) return;
      h.value = { x: i.clientX, y: i.clientY };
      const _ = (h.value.x - A.value.x) * n.touchRatio;
      m.value = _, v("touchMove", i);
    }, X = (i) => {
      if (!x.value) return;
      const _ = h.value.x - A.value.x;
      Math.abs(_) > n.threshold && (_ > 0 ? P() : R()), x.value = !1, m.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", X), v("touchEnd", i);
    }, U1 = (i) => {
      if (!n.allowTouchMove) return;
      x.value = !0;
      const _ = i.touches[0];
      A.value = { x: _.clientX, y: _.clientY }, h.value = { x: _.clientX, y: _.clientY }, v("touchStart", i);
    }, j1 = (i) => {
      if (!x.value) return;
      const _ = i.touches[0];
      h.value = { x: _.clientX, y: _.clientY };
      const I = (h.value.x - A.value.x) * n.touchRatio;
      m.value = I, v("touchMove", i);
    }, O1 = (i) => {
      if (!x.value) return;
      const _ = h.value.x - A.value.x;
      Math.abs(_) > n.threshold && (_ > 0 ? P() : R()), x.value = !1, m.value = 0, v("touchEnd", i);
    }, Y = () => {
    ...
    return z1(() => {
      ...
      o("div", {
        ...
        o("div", {
          ...
          (l(!0), t(B, null, E(i.items, (I, N) => (l(), t("div", {
            key: D1(I, N),
            class: H(["swiper-slide", {
              "swiper-slide-active": N === C.value,
              "swiper-slide-prev": N === C.value - 1,
              "swiper-slide-next": N === C.value + 1,
              ...R1()
            }]),
            style: U(G1())
          }, [
      ...
      i.showNavigation ? (l(), c(W, {
        key: 1,
        onClick: R,
        class: H(["swiper-button-next", {
          "type-multiple": i.multiple,
          "swiper-button-disabled": C.value === f.value,
          "swiper-button-hidden": !S.value
        }])
      }, null, 8, ["class"])) : M("", !0),
      i.showPagination ? (l(), t("div", {
        key: 2,
        class: H(["swiper-pagination", T1.value])
      }, [
        (l(!0), t(B, null, E(g.value, (I, N) => (l(), t("button", {
          key: N,
          onClick: (A9) => T(N * i.slidesPerView),
          class: H(["swiper-pagination-bullet", {
            "swiper-pagination-bullet-active": N === u.value
          }])
        }, [
          J(i.$slots, "pagination-bullet", {
            index: N,
            isActive: N === u.value
          }, () => [
            _[0] || (_[0] = o("span", { class: "swiper-bullet-dot" }, null, -1))
          ], !0)
        ], 10, Q1))), 128))
      ], 2)) : M("", !0),
  ...
  for (const [n, v] of e)
    s[n] = v;
  return s;
}, s1 = /* @__PURE__ */ G(e2, [["__scopeId", "data-v-6ed75995"]]), l2 = { class: "w-full py-6 px-5" }, o2 = { class: "flex gap-2" }, t2 = { class: "p-3" }, s2 = { class: "flex gap-2" }, n1 = /* @__PURE__ */ a({
  __name: "CardSkeleton",
  props: {
    type: { default: "user" }
  },
  setup(r) {
    return (e, s) => (l(), t("div", {
      ...
      e.type === "admin" ? (l(), t(B, { key: 0 }, [
        s[2] || (s[2] = Q('<div class="px-3 py-[20px] md:py-[26px]"><div class="flex items-center gap-4"><div class="w-24 h-24 rounded-full bg-gray-200 flex-shrink-0"></div><div class="flex-1"><div class="flex items-center justify-between gap-3 mb-2"><div class="h-[22px] bg-gray-200 rounded w-3/4"></div><div class="h-[22px] bg-gray-200 rounded w-[80px]"></div></div><div class="space-y-2 mt-4"><div class="h-[22px] bg-gray-200 rounded w-full"></div><div class="h-[22px] bg-gray-200 rounded w-4/5"></div></div><div class="h-[20px] bg-gray-200 rounded w-1/3 mt-4"></div></div></div></div><div class="border-t border-gray-200"></div>', 2)),
        o("div", l2, [
          s[1] || (s[1] = o("div", { class: "h-[22px] bg-gray-200 rounded w-[80px] mb-4" }, null, -1)),
          o("div", o2, [
            (l(), t(B, null, E(4, (n) => o("div", {
              key: n,
        ...
        o("div", t2, [
          s[3] || (s[3] = Q('<div class="h-6 bg-gray-200 rounded w-[80px] mb-2"></div><div class="h-5 bg-gray-200 rounded w-3/4 mb-2"></div><div class="space-y-2 mb-3"><div class="h-4 bg-gray-200 rounded w-full"></div><div class="h-4 bg-gray-200 rounded w-5/6"></div></div><div class="h-4 bg-gray-200 rounded w-1/2 mb-3"></div><div class="h-4 bg-gray-200 rounded w-2/3 mb-3"></div>', 5)),
          o("div", s2, [
            (l(), t(B, null, E(3, (n) => o("div", {
              key: n,
...
}, m2 = { class: "w-full py-6 px-5 mt-auto" }, g2 = {
  key: 0,
  class: "flex items-center justify-center gap-2"
}, w2 = ["onClick"], y2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, I2 = ["src", "alt"], $2 = {
  key: 1,
  ...
  setup(r, { emit: e }) {
    const s = r, n = e, v = $(/* @__PURE__ */ new Set()), Z = $(s.maxItems);
    j(
      () => s.maxItems,
      (h) => {
        Z.value = h;
    ...
    const V = b(() => s.shops.slice(0, Z.value)), F = (h) => {
      n("shop-click", h);
    }, k = (h) => {
      n("partnerUser-click", h);
    }, C = (h) => {
      const m = "w-2 h-2 rounded-full";
      switch (h) {
      ...
      v.value.add(h);
    }, A = (h) => h.thumbImgUrl && !v.value.has(h.collaborationId);
    return (h, m) => (l(), t("div", n2, [
      h.loading ? (l(), t(B, { key: 0 }, E(6, (p) => o1(n1, {
        key: p,
        type: "admin"
      })), 64)) : (l(!0), t(B, { key: 1 }, E(V.value, (p) => (l(), t("div", {
        key: p.collaborationId,
            ...
            o("div", a2, [
              o("div", c2, [
                A(p) ? (l(), t("img", {
                  ...
                  src: p.thumbImgUrl,
                  alt: p.marketName,
                  onError: (f) => x(p.collaborationId),
                  class: "w-full h-full object-cover"
                }, null, 40, d2)) : (l(), t("div", u2, m[0] || (m[0] = [
              ...
              o("div", C2, [
                o("div", {
                  ...
                  o("h2", p2, L(p.marketName), 1),
                  p.statusCode ? (l(), t("div", h2, [
                    o("div", {
                      class: H(C(p.statusCode))
                    }, null, 2),
                    o("span", f2, L(y(p.statusCode)), 1)
                  ])) : M("", !0)
                ], 2),
                p.description ? (l(), t("p", _2, L(p.description), 1)) : M("", !0),
                p.period ? (l(), t("p", v2, L(p.period), 1)) : M("", !0)
              ])
            ])
          ], 8, i2),
          m[4] || (m[4] = o("div", { class: "border-t border-gray-200" }, null, -1)),
          o("div", m2, [
            m[3] || (m[3] = o("h3", { class: "text-left font-pretendard text-[15px] font-bold leading-[22px] mb-2 text-[#303040]" }, " 참여작가 ", -1)),
            p.partnerUsersData && p.partnerUsersData.length > 0 ? (l(), t("div", {
              key: 0,
              class: H(p.partnerUsersData.length > 4 ? "px-8" : "")
            }, [
              p.partnerUsersData.length <= 4 ? (l(), t("div", g2, [
                (l(!0), t(B, null, E(p.partnerUsersData, (f) => (l(), t("div", {
                  key: f.id || f.nickName,
                  class: "w-16 flex flex-col items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity",
                  onClick: K((u) => k(f), ["stop"])
                }, [
                  o("div", y2, [
                    f.profileImgUrl ? (l(), t("img", {
                      key: 0,
                      src: f.profileImgUrl,
                      alt: f.nickName,
                      class: "w-full h-full object-cover"
                    }, null, 8, I2)) : (l(), t("div", $2, m[1] || (m[1] = [
                      o("svg", {
                  ...
                  o("span", k2, L(f.nickName), 1)
                ], 8, w2))), 128))
              ])) : (l(), c(s1, {
                key: 1,
                items: p.partnerUsersData,
                multiple: !0,
                slidesPerView: 4,
                spaceBetween: 8,
                "show-pagination": !1,
...
}, S2 = { class: "p-3 text-left" }, F2 = {
  key: 0,
  class: "mb-2"
}, T2 = { class: "text-sm font-bold text-[#060608] mb-2 line-clamp-1" }, D2 = {
  key: 1,
  ...
  key: 4,
  class: "flex items-center justify-center gap-2"
}, U2 = ["onClick"], j2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, O2 = ["src", "alt"], z2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, X2 = { class: "text-xs text-[#060608] truncate" }, K2 = /* @__PURE__ */ a({
  ...
  emits: ["shop-click", "partnerUser-click"],
  setup(r, { emit: e }) {
    const s = r, n = e, v = $(!1), Z = $(null), V = $(/* @__PURE__ */ new Set()), F = $(s.maxItems);
    j(
      () => s.maxItems,
      (u) => {
        F.value = u;
    ...
    const k = b(() => s.shops.slice(0, F.value)), C = (u) => {
      Z.value = u, v.value = !0, n("shop-click", u);
    }, y = (u) => {
      n("partnerUser-click", u);
    }, x = (u) => {
      const g = "inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-medium";
      switch (u) {
        case "RECRUITING_PENDING":
          return `${g} bg-[#EFEBFB]`;
        case "RECRUITING_ONGOING":
      ...
      const g = "w-1.5 h-1.5 rounded-full";
      switch (u) {
        case "RECRUITING_PENDING":
          return `${g} bg-[#6540DE]`;
        case "RECRUITING_ONGOING":
      ...
      V.value.add(u);
    }, p = (u) => u.thumbImgUrl && !V.value.has(u.collaborationId), f = b(() => {
      const u = s.itemsPerRow;
      let g = "grid grid-cols-1";
      return u >= 2 && (g += " md:grid-cols-2"), u >= 3 && (g += " lg:grid-cols-3"), u >= 4 && (g += " xl:grid-cols-4"), u >= 5 && (g += " 2xl:grid-cols-5"), u >= 6 && (g += " 2xl:grid-cols-6"), `${g} gap-8`;
    });
    return (u, g) => (l(), t("div", V2, [
      o("div", {
        class: H(f.value)
      }, [
        u.loading ? (l(), t(B, { key: 0 }, E(6, (w) => o1(n1, {
          key: w,
          type: "user"
        })), 64)) : (l(!0), t(B, { key: 1 }, E(k.value, (w) => (l(), t("div", {
          key: w.collaborationId,
          ...
          o("div", E2, [
            p(w) ? (l(), t("img", {
              ...
              src: w.thumbImgUrl,
              alt: w.marketName,
              onError: (S) => m(w.collaborationId),
              class: "w-full h-full object-cover"
            }, null, 40, Z2)) : (l(), t("div", A2, g[0] || (g[0] = [
              o("div", { class: "w-8 h-8 bg-gray-300 rounded flex items-center justify-center" }, [
                o("svg", {
                  class: "w-4 h-4 text-gray-500",
                  fill: "currentColor",
          ...
          o("div", S2, [
            w.statusCode ? (l(), t("div", F2, [
              o("div", {
                class: H([x(w.statusCode), "text-[#303040]"])
              }, [
                o("div", {
                  class: H(A(w.statusCode))
                }, null, 2),
                D(" " + L(h(w.statusCode)), 1)
              ], 2)
            ])) : M("", !0),
            o("h3", T2, L(w.marketName), 1),
            w.description ? (l(), t("p", D2, L(w.description), 1)) : M("", !0),
            w.period ? (l(), t("p", R2, L(w.period), 1)) : M("", !0),
            w.hashtags ? (l(), t("p", G2, L(w.hashtags), 1)) : M("", !0),
            w.partnerUsersData && w.partnerUsersData.length > 0 ? (l(), t("div", P2, [
              (l(!0), t(B, null, E(w.partnerUsersData, (S) => (l(), t("div", {
                key: S.id,
                ...
                onClick: K((O) => y(S), ["stop"])
              }, [
                o("div", j2, [
                  S.profileImgUrl ? (l(), t("img", {
                    key: 0,
                    src: S.profileImgUrl,
                    alt: S.nickName,
                    class: "w-full h-full object-cover"
                  }, null, 8, O2)) : (l(), t("div", z2, g[1] || (g[1] = [
                    o("svg", {
...
}), W2 = /* @__PURE__ */ G(K2, [["__scopeId", "data-v-1b1ac295"]]), Y2 = { class: "w-full" }, q2 = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, J2 = ["onClick"], Q2 = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
    ...
    variant: {
      ...
      default: "default",
      // 'default' | 'compact'
      validator: (r) => ["default", "compact"].includes(r)
    }
  },
  emits: ["update:modelValue", "tab-change"],
  setup(r, { emit: e }) {
    const s = r, n = e, v = $(s.modelValue), Z = (k) => {
      v.value = k.id, n("update:modelValue", k.id), n("tab-change", k);
    }, V = (k) => {
      const C = v.value === k.id, y = "flex items-center justify-center focus:outline-none hover:border-[#F66D96] border-1";
      return C ? `${y} bg-[#FFE8F0] border-[#F66D96] border-2` : `${y} bg-white border-[#CFD3DA] border-2`;
    }, F = (k) => {
      const C = v.value === k.id, y = "text-sm font-bold text-center whitespace-nowrap";
      return C ? `${y} text-[#F66D96]` : `${y} text-[#424855]`;
    };
    return j(
      () => s.modelValue,
      (k) => {
      ...
      o("div", q2, [
        (l(!0), t(B, null, E(r.tabs, (y) => (l(), t("button", {
          key: y.id,
          class: H(V(y)),
          onClick: (x) => Z(y),
          type: "button"
...
}, e3 = /* @__PURE__ */ G(Q2, [["__scopeId", "data-v-497d3204"]]), l3 = /* @__PURE__ */ a({
  __name: "ElementIcon",
  props: {
    elementIcon: {},
    color: {}
  ...
  setup(r) {
    return (e, s) => e.elementIcon === "IcApp" ? (l(), c(d(r1), {
      key: 0,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChart" ? (l(), c(d(i1), {
      key: 1,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPerson" ? (l(), c(d(p1), {
      key: 2,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcOption" ? (l(), c(d(u1), {
      key: 3,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcHelp" ? (l(), c(d(a1), {
      key: 4,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcInfo" ? (l(), c(d(c1), {
      key: 5,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcNotification" ? (l(), c(d(d1), {
      key: 6,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPayback" ? (l(), c(d(C1), {
      key: 7,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlane" ? (l(), c(d(h1), {
      key: 8,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSetting" ? (l(), c(d(_1), {
      key: 9,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcUpdate" ? (l(), c(d(f1), {
      key: 10,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMedia" ? (l(), c(d(v1), {
      key: 11,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLink" ? (l(), c(d(m1), {
      key: 12,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcArrowRight" ? (l(), c(d(W), {
      key: 13,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDown" ? (l(), c(d(g1), {
      key: 14,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcGraphicEmpty" ? (l(), c(d(w1), {
      key: 15,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCopy" ? (l(), c(d(y1), {
      key: 16,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDelete" ? (l(), c(d(I1), {
      key: 17,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlus" ? (l(), c(d($1), {
      key: 18,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMoreVertical" ? (l(), c(d(k1), {
      key: 19,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCancleFill" ? (l(), c(d(x1), {
      key: 20,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChecked" ? (l(), c(d(b1), {
      key: 21,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSparkle" ? (l(), c(d(L1), {
      key: 22,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcStock" ? (l(), c(d(Q3), {
      key: 23,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPreview" ? (l(), c(d(M1), {
      key: 24,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLoadingPrimary" ? (l(), c(d(V1), {
      key: 25,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLayer" ? (l(), c(d(N1), {
      key: 26,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCta" ? (l(), c(d(E1), {
      key: 27,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSearch" ? (l(), c(d(H1), {
      key: 28,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcClose" ? (l(), c(d(B1), {
      key: 29,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreUser" ? (l(), c(d(x9), {
      key: 30,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (l(), c(d(V9), {
      key: 31,
      color: e.color
    }, null, 8, ["color"])) : M("", !0);
  }
}), o3 = /* @__PURE__ */ G(l3, [["__scopeId", "data-v-f12d6798"]]), t3 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, s3 = ["fill"], r1 = /* @__PURE__ */ a({
  __name: "IcApp",
  props: {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, r3 = ["fill"], i1 = /* @__PURE__ */ a({
  __name: "IcChart",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", n3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, a3 = ["fill"], a1 = /* @__PURE__ */ a({
  __name: "IcHelp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", i3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, d3 = ["fill"], c1 = /* @__PURE__ */ a({
  __name: "IcInfo",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", c3, [
      s[0] || (s[0] = o("circle", {
        cx: "12",
        cy: "11.9922",
        r: "6",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, C3 = ["fill"], d1 = /* @__PURE__ */ a({
  __name: "IcNotification",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", u3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, w3 = ["fill"], h1 = /* @__PURE__ */ a({
  __name: "IcPlane",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", g3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, E3 = { id: "Group 395" }, Z3 = ["fill"], A3 = ["fill"], y1 = /* @__PURE__ */ a({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, F3 = ["fill"], I1 = /* @__PURE__ */ a({
  __name: "IcDelete",
  props: {
    color: { default: () => "#FF4136" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", S3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, D3 = { id: "ic-plus" }, R3 = ["fill"], $1 = /* @__PURE__ */ a({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, P3 = ["fill"], U3 = ["fill"], j3 = ["fill"], k1 = /* @__PURE__ */ a({
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, z3 = ["fill"], x1 = /* @__PURE__ */ a({
  __name: "IcCancleFill",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", O3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, l9 = ["fill"], M1 = /* @__PURE__ */ a({
  __name: "IcPreview",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", e9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, t9 = ["fill"], H1 = /* @__PURE__ */ a({
  __name: "IcSearch",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", o9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, n9 = ["fill"], B1 = /* @__PURE__ */ a({
  __name: "IcClose",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", s9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, a9 = { "clip-path": "url(#clip0_3951_314363)" }, c9 = ["fill"], d9 = ["fill"], u9 = ["fill"], C9 = ["fill"], p9 = ["fill"], h9 = ["fill"], f9 = ["fill"], _9 = ["fill"], v9 = /* @__PURE__ */ a({
  __name: "IcLoadingPrimary",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(r) {
    return (e, s) => (l(), t("div", r9, [
      (l(), t("svg", i9, [
        o("g", a9, [
          o("path", {
...
}), V1 = /* @__PURE__ */ G(v9, [["__scopeId", "data-v-9156a366"]]), m9 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, g9 = ["fill"], N1 = /* @__PURE__ */ a({
  __name: "IcLayer",
  props: {
    color: { default: () => "#060608" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", m9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, y9 = ["fill"], E1 = /* @__PURE__ */ a({
  __name: "IcCta",
  props: {
    color: { default: () => "#716497" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", w9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, $9 = ["stroke"], k9 = ["stroke"], x9 = /* @__PURE__ */ a({
  __name: "IcCoreUser",
  props: {
    color: { default: () => "#303040" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", I9, [
      o("path", {
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, L9 = { "clip-path": "url(#clip0_1979_140961)" }, M9 = ["stroke"], H9 = ["stroke"], B9 = ["stroke"], V9 = /* @__PURE__ */ a({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", b9, [
      o("g", L9, [
        o("path", {
...
const E9 = {
  ...
  TabGroup: e3,
  Swiper: s1
}, Z1 = N9(E9), { AdminCreateCards: F9, UserCreateCards: T9, TabGroup: D9, Swiper: R9 } = Z1, l1 = [
  ...Object.values(Z1),
  o3,
  r1,
  i1,
  ...
  install(r, e = {}) {
    l1.forEach((s) => {
      ...
      r.component(n, s);
    }), e.prefix && l1.forEach((s) => {
      const n = s.name || "UnnamedComponent";
      r.component(`${e.prefix}${n}`, s);
    });
  }
};
typeof window < "u" && window.Vue && window.Vue.use(Z9);
export {
  F9 as AdminCreateCards,
  o3 as ElementIcon,
  r1 as IcApp,
  t1 as IcArrowLeft,
  W as IcArrowRight,
  ...
  I1 as IcDelete,
  g1 as IcDown,
  w1 as IcGraphicEmpty,
  a1 as IcHelp,
  c1 as IcInfo,
  N1 as IcLayer,
  m1 as IcLink,
  V1 as IcLoadingPrimary,
  v1 as IcMedia,
  k1 as IcMoreVertical,
  d1 as IcNotification,
  u1 as IcOption,
  C1 as IcPayback,
  p1 as IcPerson,
  h1 as IcPlane,
