import { defineComponent as d, createElementBlock as s, openBlock as l, createElementVNode as o, ref as b, computed as x, onMounted as X1, onUnmounted as K1, watch as U, createBlock as u, createCommentVNode as B, normalizeClass as $, normalizeStyle as G, Fragment as M, renderList as V, renderSlot as e1, createTextVNode as P, toDisplayString as L, createStaticVNode as l1, createVNode as W, withModifiers as K, withCtx as s1, unref as C, h as o1 } from "vue";
const W1 = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
...
}, Y1 = ["fill"], n1 = /* @__PURE__ */ d({
  __name: "IcArrowLeft",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", W1, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, J1 = ["fill"], Y = /* @__PURE__ */ d({
  __name: "IcArrowRight",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", q1, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  setup(i, { expose: e, emit: t }) {
    const n = i, w = t, N = b(null), H = b(null), A = b(null), T = b(null), v = b(n.initialSlide), E = b(!1), p = b(!1), k = b({ x: 0, y: 0 }), r = b({ x: 0, y: 0 }), a = b(0), h = b(null), _ = x(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), f = x(() => Math.floor(v.value / n.slidesPerView)), m = x(() => {
      const c = Math.ceil(n.items.length / n.slidesPerView);
      return Array.from({ length: c }, (g, I) => I);
    }), y = x(() => (console.log("showPrevButton", n.loop, v.value, _.value), n.loop || v.value > 0)), S = x(() => (console.log("showNextButton", n.loop, v.value, _.value), n.loop || v.value < _.value)), O = x(() => H.value ? (H.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), S1 = x(() => ({
      overflow: "hidden",
      position: "relative"
    })), T1 = x(() => {
      const c = -(v.value * (O.value + n.spaceBetween)) + a.value;
      return {
        display: "flex",
        transition: E.value && !p.value ? `transform ${n.speed}ms ${n.easing}` : "none",
        transform: `translateX(${c}px)`,
        gap: `${n.spaceBetween}px`
      };
    }), F1 = x(() => {
      if (!n.items.length) return { width: "0%", left: "0%" };
      const c = v.value / _.value, g = n.slidesPerView / n.items.length * 100, I = c * (100 - g);
      return {
        width: `${g}%`,
        left: `${I}%`,
        transition: E.value ? `all ${n.speed}ms ${n.easing}` : "none"
      };
    }), P1 = x(() => ({
      "swiper-pagination-horizontal": !0,
      "swiper-pagination-bullets": !0
    })), D1 = (c, g) => n.keyName && c[n.keyName] ? c[n.keyName] : g, R1 = (c) => ({}), G1 = (c) => ({
      width: `${O.value}px`,
      flexShrink: 0
    }), F = (c, g = n.speed) => {
      if (E.value && !p.value) return;
      const I = Math.max(0, Math.min(c, _.value));
      I !== v.value && (E.value = !0, w("transitionStart", { index: I }), v.value = I, setTimeout(() => {
        E.value = !1, w("transitionEnd", { index: I }), w("slideChange", { index: I, item: n.items[I] }), I === 0 && w("reachBeginning"), I === _.value && w("reachEnd");
      }, g));
    }, D = () => {
      n.loop && v.value === _.value ? F(0) : F(v.value + 1);
    }, R = () => {
      n.loop && v.value === 0 ? F(_.value) : F(v.value - 1);
    }, U1 = (c) => {
      n.allowTouchMove && (p.value = !0, k.value = { x: c.clientX, y: c.clientY }, r.value = { x: c.clientX, y: c.clientY }, document.addEventListener("mousemove", z), document.addEventListener("mouseup", X), w("touchStart", c));
    }, z = (c) => {
      if (!p.value) return;
      r.value = { x: c.clientX, y: c.clientY };
      const g = (r.value.x - k.value.x) * n.touchRatio;
      a.value = g, w("touchMove", c);
    }, X = (c) => {
      if (!p.value) return;
      const g = r.value.x - k.value.x;
      Math.abs(g) > n.threshold && (g > 0 ? R() : D()), p.value = !1, a.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", X), w("touchEnd", c);
    }, j1 = (c) => {
      if (!n.allowTouchMove) return;
      p.value = !0;
      const g = c.touches[0];
      k.value = { x: g.clientX, y: g.clientY }, r.value = { x: g.clientX, y: g.clientY }, w("touchStart", c);
    }, O1 = (c) => {
      if (!p.value) return;
      const g = c.touches[0];
      r.value = { x: g.clientX, y: g.clientY };
      const I = (r.value.x - k.value.x) * n.touchRatio;
      a.value = I, w("touchMove", c);
    }, z1 = (c) => {
      if (!p.value) return;
      const g = r.value.x - k.value.x;
      Math.abs(g) > n.threshold && (g > 0 ? R() : D()), p.value = !1, a.value = 0, w("touchEnd", c);
    }, J = () => {
      if (!n.autoplay) return;
      const c = typeof n.autoplay == "object" && n.autoplay.delay || 3e3;
      h.value = setInterval(() => {
        D();
      }, c);
    }, Q = () => {
    ...
    return X1(() => {
      ...
      slideToNext: D,
      slideToPrev: R,
      currentIndex: x(() => v.value),
      isTransitioning: x(() => E.value)
    }), (c, g) => (l(), s("div", {
      class: "swiper-container",
      ref_key: "swiperContainer",
      ref: N
    }, [
      c.showNavigation ? (l(), u(n1, {
        key: 0,
        onClick: R,
        class: $(["swiper-button-prev", {
          "type-multiple": c.multiple,
      ...
      o("div", {
        ...
        o("div", {
          ...
          (l(!0), s(M, null, V(c.items, (I, Z) => (l(), s("div", {
            key: D1(I, Z),
            class: $(["swiper-slide", {
              "swiper-slide-active": Z === v.value,
              "swiper-slide-prev": Z === v.value - 1,
              "swiper-slide-next": Z === v.value + 1,
              ...R1()
            }]),
            style: G(G1())
          }, [
      ...
      c.showNavigation ? (l(), u(Y, {
        key: 1,
        onClick: D,
        class: $(["swiper-button-next", {
          "type-multiple": c.multiple,
          "swiper-button-disabled": v.value === _.value,
          "swiper-button-hidden": !S.value
        }])
      }, null, 8, ["class"])) : B("", !0),
      c.showPagination ? (l(), s("div", {
        key: 2,
        class: $(["swiper-pagination", P1.value])
      }, [
        (l(!0), s(M, null, V(m.value, (I, Z) => (l(), s("button", {
          key: Z,
          onClick: (T9) => F(Z * c.slidesPerView),
          class: $(["swiper-pagination-bullet", {
            "swiper-pagination-bullet-active": Z === f.value
          }])
        }, [
          e1(c.$slots, "pagination-bullet", {
            index: Z,
            isActive: Z === f.value
          }, () => [
            g[0] || (g[0] = o("span", { class: "swiper-bullet-dot" }, null, -1))
          ], !0)
        ], 10, Q1))), 128))
      ], 2)) : B("", !0),
      c.showScrollbar ? (l(), s("div", {
        key: 3,
  ...
  for (const [n, w] of e)
    t[n] = w;
  return t;
}, q = /* @__PURE__ */ j(e2, [["__scopeId", "data-v-6ed75995"]]), l2 = { class: "w-full py-6 px-5" }, o2 = { class: "flex gap-2" }, t2 = { class: "p-3" }, s2 = { class: "flex gap-2" }, r1 = /* @__PURE__ */ d({
  __name: "CardSkeleton",
  props: {
    type: { default: "user" }
  },
...
}), n2 = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 !gap-8 mb-12 items-start" }, r2 = { class: "w-full max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 overflow-hidden h-full flex flex-col" }, i2 = ["onClick"], a2 = { class: "flex items-center gap-4 h-full" }, c2 = ["src", "alt", "onError"], d2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-1"
}, u2 = { class: "flex-1 min-w-0 text-left flex flex-col justify-center" }, C2 = { class: "font-pretendard text-[17px] font-bold leading-[22px] line-clamp-2 text-[#060608]" }, p2 = {
  key: 0,
  class: "flex items-center gap-2 px-2 py-1 rounded-md flex-shrink-0"
}, h2 = { class: "text-xs font-medium text-[#303040]" }, f2 = {
  key: 0,
...
}, _2 = { class: "w-full py-6 px-5 mt-auto" }, g2 = {
  key: 0,
  class: "flex items-center justify-center gap-2"
}, w2 = ["onClick"], m2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, y2 = ["src", "alt"], I2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, $2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, k2 = ["onClick"], x2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, b2 = ["src", "alt"], L2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, M2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, H2 = /* @__PURE__ */ d({
  ...
  setup(i, { emit: e }) {
    const t = i, n = e, w = b(/* @__PURE__ */ new Set()), N = b(t.maxItems);
    U(
      () => t.maxItems,
      (r) => {
        N.value = r;
    ...
    const H = x(() => t.shops.slice(0, N.value)), A = (r) => {
      n("shop-click", r);
    }, T = (r) => {
      n("partnerUser-click", r);
    }, v = (r) => {
      const a = "w-2 h-2 rounded-full";
      switch (r) {
      ...
      w.value.add(r);
    }, k = (r) => r.thumbImgUrl && !w.value.has(r.collaborationId);
    return (r, a) => (l(), s("div", n2, [
      r.loading ? (l(), s(M, { key: 0 }, V(6, (h) => W(r1, {
        key: h,
        type: "admin"
        ...
        o("div", r2, [
          o("div", {
            ...
            o("div", a2, [
              o("div", {
                class: $(["rounded-full border border-gray-300 bg-gray-50 flex-shrink-0 overflow-hidden", r.isMobile ? "w-20 h-20" : "w-24 h-24"])
              }, [
                k(h) ? (l(), s("img", {
                  key: 0,
                  src: h.thumbImgUrl,
                  alt: h.marketName,
                  onError: (_) => p(h.collaborationId),
                  class: "w-full h-full object-cover"
                }, null, 40, c2)) : (l(), s("div", d2, a[0] || (a[0] = [
              ...
              o("div", u2, [
                o("div", {
                  class: $([
                    ...
                    r.isMobile ? "flex-col items-start gap-2" : "flex-row items-center gap-3"
                  ])
                }, [
                  o("h2", C2, L(h.marketName), 1),
                  h.statusCode ? (l(), s("div", p2, [
                    o("div", {
                      class: $(v(h.statusCode))
                    }, null, 2),
                    o("span", h2, L(E(h.statusCode)), 1)
                  ])) : B("", !0)
                ], 2),
                h.description ? (l(), s("p", f2, L(h.description), 1)) : B("", !0),
                h.period ? (l(), s("p", v2, L(h.period), 1)) : B("", !0)
              ])
            ])
          ], 8, i2),
          a[4] || (a[4] = o("div", { class: "border-t border-gray-200" }, null, -1)),
          o("div", _2, [
            a[3] || (a[3] = o("h3", { class: "text-left font-pretendard text-[15px] font-bold leading-[22px] mb-2 text-[#303040]" }, " 참여작가 ", -1)),
            h.partnerUsersData && h.partnerUsersData.length > 0 ? (l(), s("div", {
              key: 0,
              class: $(h.partnerUsersData.length > 4 ? "px-8" : "")
            }, [
              h.partnerUsersData.length <= 4 ? (l(), s("div", g2, [
                (l(!0), s(M, null, V(h.partnerUsersData, (_) => (l(), s("div", {
                  key: _.id || _.nickName,
                  class: "w-16 flex flex-col items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity",
                  onClick: K((f) => T(_), ["stop"])
                }, [
                  o("div", m2, [
                    _.profileImgUrl ? (l(), s("img", {
                      key: 0,
                      src: _.profileImgUrl,
                      alt: _.nickName,
                      class: "w-full h-full object-cover"
                    }, null, 8, y2)) : (l(), s("div", I2, a[1] || (a[1] = [
                      o("svg", {
...
}), B2 = { class: "w-full" }, V2 = ["onClick"], N2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, E2 = ["src", "alt", "onError"], Z2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-2"
}, A2 = { class: "p-3 text-left" }, S2 = {
  key: 0,
  class: "mb-2"
}, T2 = { class: "text-sm font-bold text-[#060608] mb-2 line-clamp-1" }, F2 = {
  key: 1,
...
}, G2 = ["onClick"], U2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, j2 = ["src", "alt"], O2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, z2 = { class: "text-xs text-[#060608] whitespace-nowrap" }, X2 = /* @__PURE__ */ d({
  ...
  emits: ["shop-click", "partnerUser-click"],
  setup(i, { emit: e }) {
    const t = i, n = e, w = b(!1), N = b(null), H = b(/* @__PURE__ */ new Set()), A = b(t.maxItems);
    U(
      () => t.maxItems,
      (f) => {
        A.value = f;
    ...
    const T = x(() => t.shops.slice(0, A.value)), v = (f) => {
      N.value = f, w.value = !0, n("shop-click", f);
    }, E = (f) => {
      ...
      H.value.add(f);
    }, h = (f) => f.thumbImgUrl && !H.value.has(f.collaborationId), _ = x(() => {
    ...
    return (f, m) => (l(), s("div", B2, [
      o("div", {
        ...
        f.loading ? (l(), s(M, { key: 0 }, V(6, (y) => W(r1, {
          key: y,
          type: "user"
        })), 64)) : (l(!0), s(M, { key: 1 }, V(T.value, (y) => (l(), s("div", {
          ...
          o("div", N2, [
            h(y) ? (l(), s("img", {
              ...
              src: y.thumbImgUrl,
              alt: y.marketName,
              onError: (S) => a(y.collaborationId),
              class: "w-full h-full object-cover"
            }, null, 40, E2)) : (l(), s("div", Z2, m[0] || (m[0] = [
              o("div", { class: "w-8 h-8 bg-gray-300 rounded flex items-center justify-center" }, [
                o("svg", {
                  class: "w-4 h-4 text-gray-500",
                  fill: "currentColor",
          ...
          o("div", A2, [
            y.statusCode ? (l(), s("div", S2, [
              o("div", {
                ...
                P(" " + L(r(y.statusCode)), 1)
              ], 2)
            ])) : B("", !0),
            o("h3", T2, L(y.marketName), 1),
            y.description ? (l(), s("p", F2, L(y.description), 1)) : B("", !0),
            y.period ? (l(), s("p", P2, L(y.period), 1)) : B("", !0),
            y.hashtags ? (l(), s("p", D2, L(y.hashtags), 1)) : B("", !0),
            y.partnerUsersData && y.partnerUsersData.length > 0 ? (l(), s("div", R2, [
...
}), K2 = /* @__PURE__ */ j(X2, [["__scopeId", "data-v-89e8a200"]]), W2 = { class: "w-full" }, Y2 = {
  key: 0,
  class: "relative"
}, q2 = ["onClick"], J2 = {
  key: 1,
  ...
  setup(i, { emit: e }) {
    const t = i, n = e, w = b(t.modelValue), N = (p) => {
      w.value = p.id, n("update:modelValue", p.id), n("tab-change", p);
    }, H = (p) => {
      const k = w.value === p.id, a = `flex items-center justify-center focus:outline-none hover:border-[#F66D96] border-1 ${t.isMobile ? "rounded-lg" : "rounded-xl"}`;
      return k ? `${a} bg-[#FFE8F0] border-[#F66D96] border-2` : `${a} bg-white border-[#CFD3DA] border-2`;
    }, A = (p) => {
      const k = w.value === p.id, a = `${t.isMobile ? "text-xs" : "text-sm"} font-bold text-center whitespace-nowrap`;
      return k ? `${a} text-[#F66D96]` : `${a} text-[#424855]`;
    }, T = x(() => {
      if (t.tabs.length <= 10) {
        const r = [];
        for (let a = 0; a < t.tabs.length; a += 5)
          r.push(t.tabs.slice(a, a + 5));
        return r;
      } else {
        const r = [];
        for (let a = 0; a < t.tabs.length; a += 8)
          r.push(t.tabs.slice(a, a + 8));
        return r;
      }
    }), v = x(() => t.tabs.length > 10), E = x(
      () => t.isMobile && t.tabs.length > (v.value ? 6 : 5)
    );
    return U(
      () => t.modelValue,
      (p) => {
            ...
            default: s1(({ item: r }) => [
              o("div", {
                class: $([
                  ...
                  v.value ? "grid-cols-4" : "grid-cols-5"
                ])
              }, [
                (l(!0), s(M, null, V(r, (a) => (l(), s("button", {
                  key: a.id,
                  class: $([H(a), "px-3 py-2"]),
                  onClick: (h) => N(a),
                  type: "button"
      ...
      ])) : p.isMobile ? (l(), s("div", J2, [
        o("div", {
          class: $([
            "grid gap-2 auto-rows-fr",
            v.value ? "grid-cols-3" : "grid-cols-5"
          ])
        }, [
          (l(!0), s(M, null, V(p.tabs, (r) => (l(), s("button", {
            key: r.id,
            class: $([H(r), "px-3 py-2"]),
            onClick: (a) => N(r),
            type: "button"
  ...
  setup(i) {
    return (e, t) => e.elementIcon === "IcApp" ? (l(), u(C(i1), {
      ...
      key: 8,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSetting" ? (l(), u(C(_1), {
      key: 9,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcUpdate" ? (l(), u(C(v1), {
      key: 10,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMedia" ? (l(), u(C(g1), {
      key: 11,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLink" ? (l(), u(C(w1), {
      key: 12,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcArrowRight" ? (l(), u(C(Y), {
      key: 13,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDown" ? (l(), u(C(m1), {
      key: 14,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcGraphicEmpty" ? (l(), u(C(y1), {
      key: 15,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCopy" ? (l(), u(C(I1), {
      key: 16,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDelete" ? (l(), u(C($1), {
      key: 17,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlus" ? (l(), u(C(k1), {
      key: 18,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMoreVertical" ? (l(), u(C(x1), {
      key: 19,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCancleFill" ? (l(), u(C(b1), {
      key: 20,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChecked" ? (l(), u(C(L1), {
      key: 21,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSparkle" ? (l(), u(C(M1), {
      key: 22,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcStock" ? (l(), u(C(l9), {
      key: 23,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPreview" ? (l(), u(C(H1), {
      key: 24,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLoadingPrimary" ? (l(), u(C(N1), {
      key: 25,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLayer" ? (l(), u(C(E1), {
      key: 26,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCta" ? (l(), u(C(Z1), {
      key: 27,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSearch" ? (l(), u(C(B1), {
      key: 28,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcClose" ? (l(), u(C(V1), {
      key: 29,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreUser" ? (l(), u(C(L9), {
      key: 30,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (l(), u(C(E9), {
      key: 31,
      color: e.color
    }, null, 8, ["color"])) : B("", !0);
  }
}), s3 = /* @__PURE__ */ j(t3, [["__scopeId", "data-v-f12d6798"]]), n3 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, r3 = ["fill"], i1 = /* @__PURE__ */ d({
  __name: "IcApp",
  props: {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, A3 = { id: "Group 395" }, S3 = ["fill"], T3 = ["fill"], I1 = /* @__PURE__ */ d({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, R3 = { id: "ic-plus" }, G3 = ["fill"], k1 = /* @__PURE__ */ d({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, j3 = ["fill"], O3 = ["fill"], z3 = ["fill"], x1 = /* @__PURE__ */ d({
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, t9 = ["fill"], H1 = /* @__PURE__ */ d({
  __name: "IcPreview",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", o9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, n9 = ["fill"], B1 = /* @__PURE__ */ d({
  __name: "IcSearch",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", s9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, i9 = ["fill"], V1 = /* @__PURE__ */ d({
  __name: "IcClose",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", r9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, d9 = { "clip-path": "url(#clip0_3951_314363)" }, u9 = ["fill"], C9 = ["fill"], p9 = ["fill"], h9 = ["fill"], f9 = ["fill"], v9 = ["fill"], _9 = ["fill"], g9 = ["fill"], w9 = /* @__PURE__ */ d({
  __name: "IcLoadingPrimary",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(i) {
    return (e, t) => (l(), s("div", a9, [
      (l(), s("svg", c9, [
        o("g", d9, [
          o("path", {
...
}), N1 = /* @__PURE__ */ j(w9, [["__scopeId", "data-v-9156a366"]]), m9 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, y9 = ["fill"], E1 = /* @__PURE__ */ d({
  __name: "IcLayer",
  props: {
    color: { default: () => "#060608" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", m9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, $9 = ["fill"], Z1 = /* @__PURE__ */ d({
  __name: "IcCta",
  props: {
    color: { default: () => "#716497" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", I9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, x9 = ["stroke"], b9 = ["stroke"], L9 = /* @__PURE__ */ d({
  __name: "IcCoreUser",
  props: {
    color: { default: () => "#303040" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", k9, [
      o("path", {
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, H9 = { "clip-path": "url(#clip0_1979_140961)" }, B9 = ["stroke"], V9 = ["stroke"], N9 = ["stroke"], E9 = /* @__PURE__ */ d({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
...
const A9 = {
  ...
  TabGroup: o3,
  Swiper: q
}, A1 = Z9(A9), { AdminCreateCards: P9, UserCreateCards: D9, TabGroup: R9, Swiper: G9 } = A1, t1 = [
  ...Object.values(A1),
  s3,
  i1,
  a1,
...
typeof window < "u" && window.Vue && window.Vue.use(S9);
export {
  P9 as AdminCreateCards,
  s3 as ElementIcon,
  i1 as IcApp,
  n1 as IcArrowLeft,
  Y as IcArrowRight,
