...
const R1 = {
  ...
  setup(r, { expose: e, emit: s }) {
    const n = r, _ = s, A = $(null), H = $(null), F = $(null), k = $(null), C = $(n.initialSlide), w = $(!1), L = $(!1), y = $({ x: 0, y: 0 }), v = $({ x: 0, y: 0 }), p = $(0), x = $(null), d = I(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), h = I(() => Math.floor(C.value / n.slidesPerView)), m = I(() => {
      const i = Math.ceil(n.items.length / n.slidesPerView);
      return Array.from({ length: i }, (f, g) => g);
    }), Z = I(() => (console.log("showPrevButton", n.loop, C.value, d.value), n.loop || C.value > 0)), R = I(() => (console.log("showNextButton", n.loop, C.value, d.value), n.loop || C.value < d.value)), W = I(() => H.value ? (H.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), V1 = I(() => ({
      overflow: "hidden",
      position: "relative"
    })), Z1 = I(() => {
      ...
      return {
        display: "flex",
        transition: w.value && !L.value ? `transform ${n.speed}ms ${n.easing}` : "none",
      ...
      n.allowTouchMove && (L.value = !0, y.value = { x: i.clientX, y: i.clientY }, v.value = { x: i.clientX, y: i.clientY }, document.addEventListener("mousemove", z), document.addEventListener("mouseup", O), _("touchStart", i));
    }, z = (i) => {
      if (!L.value) return;
      ...
      Math.abs(f) > n.threshold && (f > 0 ? T() : N()), L.value = !1, p.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", O), _("touchEnd", i);
    }, N1 = (i) => {
      ...
      if (!L.value) return;
      const f = v.value.x - y.value.x;
      Math.abs(f) > n.threshold && (f > 0 ? T() : N()), L.value = !1, p.value = 0, _("touchEnd", i);
    }, Y = () => {
  ...
  setup(r, { emit: e }) {
    const s = r, n = e, _ = $(/* @__PURE__ */ new Set()), A = $(s.maxItems), H = I(() => s.shops.slice(0, A.value)), F = (y) => {
      n("shop-click", y);
    }, k = (y) => {
  ...
  emits: ["shop-click", "partnerUser-click"],
  setup(r, { emit: e }) {
    const s = r, n = e, _ = $(!1), A = $(null), H = $(/* @__PURE__ */ new Set()), F = $(s.maxItems), k = I(() => s.shops.slice(0, F.value)), C = (d) => {
...
}), E2 = /* @__PURE__ */ j(P2, [["__scopeId", "data-v-6a05c515"]]), D2 = { class: "w-full" }, N2 = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, j2 = ["onClick"], T2 = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
