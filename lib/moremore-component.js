...
const R1 = {
  ...
  setup(r, { expose: e, emit: s }) {
    const n = r, _ = s, A = $(null), H = $(null), F = $(null), k = $(null), C = $(n.initialSlide), w = $(!1), I = $(!1), y = $({ x: 0, y: 0 }), v = $({ x: 0, y: 0 }), p = $(0), x = $(null), d = L(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), h = L(() => Math.floor(C.value / n.slidesPerView)), m = L(() => {
      ...
      return {
        display: "flex",
        transition: w.value && !I.value ? `transform ${n.speed}ms ${n.easing}` : "none",
      ...
      g !== C.value && (w.value = !0, _("transitionStart", { index: g }), C.value = g, setTimeout(() => {
        w.value = !1, _("transitionEnd", { index: g }), _("slideChange", { index: g, item: n.items[g] }), g === 0 && _("reachBeginning"), g === d.value && _("reachEnd");
      }, f));
    }, N = () => {
    ...
    return (d, h) => (l(), t("div", m2, [
      o("div", {
        ...
        (l(!0), t(E, null, D(k.value, (m) => (l(), t("div", {
          ...
          o("div", I2, [
            m.statusMessage ? (l(), t("div", L2, [
              o("div", {
                class: V([I(m.statusMessage), "text-[#303040]"])
              }, [
                o("div", {
