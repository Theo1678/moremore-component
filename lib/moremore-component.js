import { defineComponent as A, createElementBlock as o, openBlock as a, createElementVNode as l, ref as w, computed as _, onMounted as de, onUnmounted as ue, watch as K, createBlock as G, createCommentVNode as C, normalizeClass as $, normalizeStyle as z, Fragment as N, renderList as j, renderSlot as Z, createTextVNode as V, toDisplayString as k, createVNode as ve, withCtx as pe, withModifiers as q } from "vue";
const fe = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
  ...
  setup(h, { expose: y, emit: c }) {
    const e = h, v = c, T = w(null), B = w(null), I = w(null), x = w(null), n = w(e.initialSlide), f = w(!1), b = w(!1), M = w({ x: 0, y: 0 }), d = w({ x: 0, y: 0 }), u = w(0), r = w(null), s = _(() => e.loop ? e.items.length - 1 : Math.max(0, e.items.length - e.slidesPerView)), p = _(() => Math.floor(n.value / e.slidesPerView)), m = _(() => {
      const t = Math.ceil(e.items.length / e.slidesPerView);
      return Array.from({ length: t }, (i, g) => g);
    }), E = _(() => (console.log("showPrevButton", e.loop, n.value, s.value), e.loop || n.value > 0)), U = _(() => (console.log("showNextButton", e.loop, n.value, s.value), e.loop || n.value < s.value)), W = _(() => B.value ? (B.value.clientWidth - (e.slidesPerView - 1) * e.spaceBetween) / e.slidesPerView : 0), Q = _(() => ({
      overflow: "hidden",
      position: "relative"
    })), ee = _(() => {
      const t = -(n.value * (W.value + e.spaceBetween)) + u.value;
      return {
        display: "flex",
      ...
      const t = n.value / s.value, i = e.slidesPerView / e.items.length * 100, g = t * (100 - i);
      return {
        width: `${i}%`,
        left: `${g}%`,
      ...
      const g = Math.max(0, Math.min(t, s.value));
      g !== n.value && (f.value = !0, v("transitionStart", { index: g }), n.value = g, setTimeout(() => {
        f.value = !1, v("transitionEnd", { index: g }), v("slideChange", { index: g, item: e.items[g] }), g === 0 && v("reachBeginning"), g === s.value && v("reachEnd");
      }, i));
    }, L = () => {
      e.loop && n.value === s.value ? P(0) : P(n.value + 1);
    }, X = () => {
      e.loop && n.value === 0 ? P(s.value) : P(n.value - 1);
    }, ne = (t) => {
      e.allowTouchMove && (b.value = !0, M.value = { x: t.clientX, y: t.clientY }, d.value = { x: t.clientX, y: t.clientY }, document.addEventListener("mousemove", R), document.addEventListener("mouseup", D), v("touchStart", t));
    }, R = (t) => {
      if (!b.value) return;
      d.value = { x: t.clientX, y: t.clientY };
      const i = (d.value.x - M.value.x) * e.touchRatio;
      u.value = i, v("touchMove", t);
    }, D = (t) => {
      if (!b.value) return;
      const i = d.value.x - M.value.x;
      Math.abs(i) > e.threshold && (i > 0 ? X() : L()), b.value = !1, u.value = 0, document.removeEventListener("mousemove", R), document.removeEventListener("mouseup", D), v("touchEnd", t);
    }, re = (t) => {
      if (!e.allowTouchMove) return;
      b.value = !0;
      const i = t.touches[0];
      M.value = { x: i.clientX, y: i.clientY }, d.value = { x: i.clientX, y: i.clientY }, v("touchStart", t);
    }, ie = (t) => {
      if (!b.value) return;
      const i = t.touches[0];
      d.value = { x: i.clientX, y: i.clientY };
      const g = (d.value.x - M.value.x) * e.touchRatio;
      u.value = g, v("touchMove", t);
    }, ce = (t) => {
      if (!b.value) return;
      const i = d.value.x - M.value.x;
      Math.abs(i) > e.threshold && (i > 0 ? X() : L()), b.value = !1, u.value = 0, v("touchEnd", t);
    }, Y = () => {
    ...
    return de(() => {
      ...
      l("div", {
        ...
        l("div", {
          ...
          (a(!0), o(N, null, j(t.items, (g, S) => (a(), o("div", {
            key: se(g, S),
            class: $(["swiper-slide", {
      ...
      t.showNavigation ? (a(), G(ye, {
        key: 1,
        onClick: L,
        disabled: n.value === s.value,
        class: $(["swiper-button-next", {
          "type-multiple": t.multiple,
          "swiper-button-disabled": n.value === s.value,
          "swiper-button-hidden": !U.value
        }])
      }, null, 8, ["disabled", "class"])) : C("", !0),
      t.showPagination ? (a(), o("div", {
        key: 2,
        class: $(["swiper-pagination", le.value])
      }, [
        (a(!0), o(N, null, j(m.value, (g, S) => (a(), o("button", {
          key: S,
  ...
  setup(h, { emit: y }) {
    const c = h, e = y, v = w(/* @__PURE__ */ new Set()), T = w(c.maxItems), B = _(() => c.shops.slice(0, T.value)), I = (d) => {
      e("shop-click", d);
    }, x = (d) => {
      ...
      v.value.add(d);
    }, M = (d) => d.image && !v.value.has(d.id);
    return (d, u) => (a(), o("div", _e, [
      (a(!0), o(N, null, j(B.value, (r) => (a(), o("div", {
        key: r.id,
        ...
        l("div", ke, [
          l("div", {
            ...
            l("div", $e, [
              ...
              l("div", Ee, [
                ...
                r.description ? (a(), o("p", Ve, k(r.description), 1)) : C("", !0),
                r.period ? (a(), o("p", Ne, k(r.period), 1)) : C("", !0)
              ])
            ])
          ], 8, Ce),
          ...
          l("div", je, [
            ...
            r.participants && r.participants.length > 0 ? (a(), o("div", {
              key: 0,
  ...
  emits: ["shop-click", "participant-click"],
  setup(h, { emit: y }) {
    const c = h, e = y, v = w(!1), T = w(null), B = w(/* @__PURE__ */ new Set()), I = w(c.maxItems), x = _(() => c.shops.slice(0, I.value)), n = (s) => {
      T.value = s, v.value = !0, e("shop-click", s);
    }, f = (s) => {
      ...
      B.value.add(s);
    }, u = (s) => s.image && !B.value.has(s.id), r = _(() => {
      const s = c.itemsPerRow;
      let p = "grid grid-cols-1";
      return s >= 2 && (p += " md:grid-cols-2"), s >= 3 && (p += " lg:grid-cols-3"), s >= 4 && (p += " xl:grid-cols-4"), s >= 5 && (p += " 2xl:grid-cols-5"), s >= 6 && (p += " 2xl:grid-cols-6"), `${p} gap-8`;
    });
    return (s, p) => (a(), o("div", He, [
      l("div", {
        class: $(r.value)
      }, [
        (a(!0), o(N, null, j(x.value, (m) => (a(), o("div", {
          key: m.id,
          ...
          l("div", Ge, [
            ...
            l("h3", Fe, k(m.title), 1),
            m.description ? (a(), o("p", Ke, k(m.description), 1)) : C("", !0),
            m.period ? (a(), o("p", qe, k(m.period), 1)) : C("", !0),
            m.hashtags ? (a(), o("p", Je, k(m.hashtags), 1)) : C("", !0),
            m.participants && m.participants.length > 0 ? (a(), o("div", Qe, [
              (a(!0), o(N, null, j(m.participants, (E) => (a(), o("div", {
                key: E.id,
...
}), nt = /* @__PURE__ */ H(ot, [["__scopeId", "data-v-8a83f4f8"]]), rt = { class: "w-full" }, it = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, ct = ["onClick"], dt = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
  ...
  setup(h, { emit: y }) {
    const c = h, e = y, v = w(c.modelValue), T = (x) => {
      v.value = x.id, e("update:modelValue", x.id), e("tab-change", x);
    }, B = (x) => {
      const n = v.value === x.id, f = "flex items-center justify-center px-3 py-3 rounded-xl border transition-all duration-200 cursor-pointer";
      return n ? `${f} bg-pink-100 border-pink-400 border-2` : `${f} bg-white border-gray-300 border hover:border-gray-400 hover:bg-gray-50`;
    }, I = (x) => {
      const n = v.value === x.id, f = "text-sm font-bold text-center whitespace-nowrap";
    ...
    return K(
      ...
      l("div", it, [
        (a(!0), o(N, null, j(h.tabs, (f) => (a(), o("button", {
          key: f.id,
          class: $(B(f)),
          onClick: (b) => T(f),
          type: "button"
...
}, ut = /* @__PURE__ */ H(dt, [["__scopeId", "data-v-861c3166"]]), F = [De, nt, ut, J], vt = {
  install(h, y = {}) {
    F.forEach((c) => {
