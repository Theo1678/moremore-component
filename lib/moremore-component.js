import { defineComponent as c, createElementBlock as t, openBlock as l, createElementVNode as o, ref as $, computed as x, onMounted as N1, onUnmounted as U1, watch as e1, createBlock as u, createCommentVNode as b, normalizeClass as H, normalizeStyle as U, Fragment as E, renderList as T, renderSlot as K, createTextVNode as W, toDisplayString as M, createVNode as z1, withCtx as X1, withModifiers as l1, unref as C, h as J } from "vue";
const R1 = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
  ...
  setup(r, { expose: e, emit: n }) {
    const s = r, m = n, S = $(null), V = $(null), F = $(null), L = $(null), p = $(s.initialSlide), g = $(!1), k = $(!1), Z = $({ x: 0, y: 0 }), v = $({ x: 0, y: 0 }), w = $(0), h = $(null), a = x(() => s.loop ? s.items.length - 1 : Math.max(0, s.items.length - s.slidesPerView)), f = x(() => Math.floor(p.value / s.slidesPerView)), y = x(() => {
      const i = Math.ceil(s.items.length / s.slidesPerView);
      return Array.from({ length: i }, (_, I) => I);
    }), A = x(() => (console.log("showPrevButton", s.loop, p.value, a.value), s.loop || p.value > 0)), O = x(() => (console.log("showNextButton", s.loop, p.value, a.value), s.loop || p.value < a.value)), Y = x(() => V.value ? (V.value.clientWidth - (s.slidesPerView - 1) * s.spaceBetween) / s.slidesPerView : 0), V1 = x(() => ({
      overflow: "hidden",
      position: "relative"
    })), Z1 = x(() => {
      const i = -(p.value * (Y.value + s.spaceBetween)) + w.value;
      return {
        display: "flex",
        transition: g.value && !k.value ? `transform ${s.speed}ms ${s.easing}` : "none",
        transform: `translateX(${i}px)`,
        gap: `${s.spaceBetween}px`
      };
    }), A1 = x(() => {
      if (!s.items.length) return { width: "0%", left: "0%" };
      const i = p.value / a.value, _ = s.slidesPerView / s.items.length * 100, I = i * (100 - _);
      return {
        width: `${_}%`,
        left: `${I}%`,
        transition: g.value ? `all ${s.speed}ms ${s.easing}` : "none"
      };
    }), S1 = x(() => ({
      "swiper-pagination-horizontal": !0,
      "swiper-pagination-bullets": !0
    })), F1 = (i, _) => s.keyName && i[s.keyName] ? i[s.keyName] : _, P1 = (i) => ({}), W1 = (i) => ({
      width: `${Y.value}px`,
      flexShrink: 0
    }), P = (i, _ = s.speed) => {
      if (g.value && !k.value) return;
      const I = Math.max(0, Math.min(i, a.value));
      I !== p.value && (g.value = !0, m("transitionStart", { index: I }), p.value = I, setTimeout(() => {
        g.value = !1, m("transitionEnd", { index: I }), m("slideChange", { index: I, item: s.items[I] }), I === 0 && m("reachBeginning"), I === a.value && m("reachEnd");
      }, _));
    }, j = () => {
      s.loop && p.value === a.value ? P(0) : P(p.value + 1);
    }, N = () => {
      s.loop && p.value === 0 ? P(a.value) : P(p.value - 1);
    }, E1 = (i) => {
      s.allowTouchMove && (k.value = !0, Z.value = { x: i.clientX, y: i.clientY }, v.value = { x: i.clientX, y: i.clientY }, document.addEventListener("mousemove", z), document.addEventListener("mouseup", X), m("touchStart", i));
    }, z = (i) => {
      if (!k.value) return;
      v.value = { x: i.clientX, y: i.clientY };
      const _ = (v.value.x - Z.value.x) * s.touchRatio;
      w.value = _, m("touchMove", i);
    }, X = (i) => {
      if (!k.value) return;
      const _ = v.value.x - Z.value.x;
      Math.abs(_) > s.threshold && (_ > 0 ? N() : j()), k.value = !1, w.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", X), m("touchEnd", i);
    }, T1 = (i) => {
      if (!s.allowTouchMove) return;
      k.value = !0;
      const _ = i.touches[0];
      Z.value = { x: _.clientX, y: _.clientY }, v.value = { x: _.clientX, y: _.clientY }, m("touchStart", i);
    }, j1 = (i) => {
      if (!k.value) return;
      const _ = i.touches[0];
      v.value = { x: _.clientX, y: _.clientY };
      const I = (v.value.x - Z.value.x) * s.touchRatio;
      w.value = I, m("touchMove", i);
    }, D1 = (i) => {
      if (!k.value) return;
      const _ = v.value.x - Z.value.x;
      Math.abs(_) > s.threshold && (_ > 0 ? N() : j()), k.value = !1, w.value = 0, m("touchEnd", i);
    }, G = () => {
    ...
    return N1(() => {
      ...
      i.showNavigation ? (l(), u(o1, {
        key: 0,
        onClick: N,
        class: H(["swiper-button-prev", {
          "type-multiple": i.multiple,
          "swiper-button-disabled": p.value === 0,
      ...
      o("div", {
        ...
        o("div", {
          ...
          (l(!0), t(E, null, T(i.items, (I, B) => (l(), t("div", {
            key: F1(I, B),
            class: H(["swiper-slide", {
              "swiper-slide-active": B === p.value,
              "swiper-slide-prev": B === p.value - 1,
              "swiper-slide-next": B === p.value + 1,
              ...P1()
            }]),
            style: U(W1())
          }, [
      ...
      i.showNavigation ? (l(), u(R, {
        key: 1,
        onClick: j,
        class: H(["swiper-button-next", {
          "type-multiple": i.multiple,
          "swiper-button-disabled": p.value === a.value,
          "swiper-button-hidden": !O.value
        }])
      }, null, 8, ["class"])) : b("", !0),
      i.showPagination ? (l(), t("div", {
        key: 2,
        class: H(["swiper-pagination", S1.value])
      }, [
        (l(!0), t(E, null, T(y.value, (I, B) => (l(), t("button", {
          key: B,
          onClick: (q9) => P(B * i.slidesPerView),
          class: H(["swiper-pagination-bullet", {
            "swiper-pagination-bullet-active": B === f.value
          }])
        }, [
          K(i.$slots, "pagination-bullet", {
            index: B,
            isActive: B === f.value
          }, () => [
...
}, u2 = { class: "w-full py-6 px-5 mt-auto" }, C2 = ["onClick"], p2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, h2 = ["src", "alt"], f2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, _2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, v2 = /* @__PURE__ */ c({
  ...
  setup(r, { emit: e }) {
    const n = r, s = e, m = $(/* @__PURE__ */ new Set()), S = $(n.maxItems), V = x(() => n.shops.slice(0, S.value)), F = (v) => {
      s("shop-click", v);
    }, L = (v) => {
      s("participant-click", v);
    }, p = (v) => {
      const w = "flex items-center gap-2 px-2 py-1 rounded-md";
      switch (v) {
        case "blue":
          return `${w}`;
        case "green":
      ...
      switch (v) {
        case "yellow":
          return `${w} bg-yellow-400`;
        case "gray":
        default:
          return `${w} bg-gray-400`;
      }
    }, k = (v) => {
      m.value.add(v);
    }, Z = (v) => v.image && !m.value.has(v.id);
    return (v, w) => (l(), t("div", J1, [
      (l(!0), t(E, null, T(V.value, (h) => (l(), t("div", {
        key: h.id,
            ...
            o("div", l2, [
              ...
              o("div", s2, [
                o("div", r2, [
                  ...
                  h.badge ? (l(), t("div", {
                    key: 0,
                    class: H([p(h.badgeColor), "flex-shrink-0"])
                  }, [
                    o("div", {
                      class: H(g(h.badgeColor))
                    }, null, 2),
                    o("span", a2, M(h.badge), 1)
                  ], 2)) : b("", !0)
                ]),
                h.description ? (l(), t("p", c2, M(h.description), 1)) : b("", !0),
                h.period ? (l(), t("p", d2, M(h.period), 1)) : b("", !0)
              ])
            ])
          ], 8, e2),
          w[3] || (w[3] = o("div", { class: "border-t border-gray-200" }, null, -1)),
          o("div", u2, [
            w[2] || (w[2] = o("h3", { class: "text-left font-pretendard text-[15px] font-bold leading-[22px] mb-2 text-[#303040]" }, " 참여작가 ", -1)),
            h.participants && h.participants.length > 0 ? (l(), t("div", {
              key: 0,
              class: H(h.participants.length > 4 ? "px-8" : "")
            }, [
              z1(t1, {
                items: h.participants,
                multiple: !0,
                slidesPerView: 4,
                spaceBetween: 8,
                "show-pagination": !1,
                showNavigation: h.participants.length > 4
              }, {
                default: X1(({ item: a }) => [
                  o("div", {
                    class: "w-16 flex flex-col items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity",
                    onClick: l1((f) => L(a), ["stop"])
                  }, [
                    o("div", p2, [
                      a.avatar ? (l(), t("img", {
                        key: 0,
...
}), w2 = { class: "w-full" }, m2 = ["onClick"], g2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, y2 = ["src", "alt", "onError"], I2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-2"
}, $2 = { class: "p-3 text-left" }, L2 = {
  key: 0,
  class: "mb-2"
}, k2 = { class: "text-sm font-bold text-[#060608] mb-2 line-clamp-1" }, x2 = {
  key: 1,
...
}, B2 = ["onClick"], V2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, Z2 = ["src", "alt"], A2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, S2 = { class: "text-xs text-[#060608] truncate" }, F2 = /* @__PURE__ */ c({
  ...
  emits: ["shop-click", "participant-click"],
  setup(r, { emit: e }) {
    const n = r, s = e, m = $(!1), S = $(null), V = $(/* @__PURE__ */ new Set()), F = $(n.maxItems), L = x(() => n.shops.slice(0, F.value)), p = (a) => {
      S.value = a, m.value = !0, s("shop-click", a);
    }, g = (a) => {
      s("participant-click", a);
    }, k = (a) => {
      ...
      V.value.add(a);
    }, w = (a) => a.image && !V.value.has(a.id), h = x(() => {
      const a = n.itemsPerRow;
      let f = "grid grid-cols-1";
      return a >= 2 && (f += " md:grid-cols-2"), a >= 3 && (f += " lg:grid-cols-3"), a >= 4 && (f += " xl:grid-cols-4"), a >= 5 && (f += " 2xl:grid-cols-5"), a >= 6 && (f += " 2xl:grid-cols-6"), `${f} gap-8`;
    });
    return (a, f) => (l(), t("div", w2, [
      o("div", {
        class: H(h.value)
      }, [
        (l(!0), t(E, null, T(L.value, (y) => (l(), t("div", {
          key: y.id,
          ...
          o("div", $2, [
            y.badge ? (l(), t("div", L2, [
              o("div", {
                class: H([k(y.badgeColor), "text-[#303040]"])
              }, [
                o("div", {
                  class: H(Z(y.badgeColor))
                }, null, 2),
                W(" " + M(y.badge), 1)
              ], 2)
            ])) : b("", !0),
            o("h3", k2, M(y.title), 1),
            y.description ? (l(), t("p", x2, M(y.description), 1)) : b("", !0),
            y.period ? (l(), t("p", b2, M(y.period), 1)) : b("", !0),
            y.hashtags ? (l(), t("p", M2, M(y.hashtags), 1)) : b("", !0),
            y.participants && y.participants.length > 0 ? (l(), t("div", H2, [
              (l(!0), t(E, null, T(y.participants, (A) => (l(), t("div", {
                key: A.id,
...
}), P2 = /* @__PURE__ */ D(F2, [["__scopeId", "data-v-b37b33f4"]]), W2 = { class: "w-full" }, E2 = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, T2 = ["onClick"], j2 = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
  ...
  setup(r, { emit: e }) {
    const n = r, s = e, m = $(n.modelValue), S = (L) => {
      m.value = L.id, s("update:modelValue", L.id), s("tab-change", L);
    }, V = (L) => {
      const p = m.value === L.id, g = "flex items-center justify-center focus:outline-none hover:border-[#F66D96] border-1";
      return p ? `${g} bg-[#FFE8F0] border-[#F66D96] border-2` : `${g} bg-white border-[#CFD3DA] border-2`;
    }, F = (L) => {
      const p = m.value === L.id, g = "text-sm font-bold text-center whitespace-nowrap";
      return p ? `${g} text-[#F66D96]` : `${g} text-[#424855]`;
    };
    return e1(
      () => n.modelValue,
      (L) => {
      ...
      o("div", E2, [
        (l(!0), t(E, null, T(r.tabs, (g) => (l(), t("button", {
          key: g.id,
          class: H(V(g)),
          onClick: (k) => S(g),
          type: "button"
...
}, D2 = /* @__PURE__ */ D(j2, [["__scopeId", "data-v-497d3204"]]), N2 = /* @__PURE__ */ c({
  __name: "ElementIcon",
  props: {
    elementIcon: {},
    color: {}
  ...
  setup(r) {
    return (e, n) => e.elementIcon === "IcApp" ? (l(), u(C(n1), {
      key: 0,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChart" ? (l(), u(C(s1), {
      key: 1,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPerson" ? (l(), u(C(u1), {
      key: 2,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcOption" ? (l(), u(C(c1), {
      key: 3,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcHelp" ? (l(), u(C(r1), {
      key: 4,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcInfo" ? (l(), u(C(i1), {
      key: 5,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcNotification" ? (l(), u(C(a1), {
      key: 6,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPayback" ? (l(), u(C(d1), {
      key: 7,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlane" ? (l(), u(C(C1), {
      key: 8,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSetting" ? (l(), u(C(h1), {
      key: 9,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcUpdate" ? (l(), u(C(p1), {
      key: 10,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMedia" ? (l(), u(C(f1), {
      key: 11,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLink" ? (l(), u(C(_1), {
      key: 12,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcArrowRight" ? (l(), u(C(R), {
      key: 13,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDown" ? (l(), u(C(v1), {
      key: 14,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCopy" ? (l(), u(C(w1), {
      key: 15,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDelete" ? (l(), u(C(m1), {
      key: 16,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlus" ? (l(), u(C(g1), {
      key: 17,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMoreVertical" ? (l(), u(C(y1), {
      key: 18,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCancleFill" ? (l(), u(C(I1), {
      key: 19,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChecked" ? (l(), u(C($1), {
      key: 20,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSparkle" ? (l(), u(C(L1), {
      key: 21,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPreview" ? (l(), u(C(k1), {
      key: 22,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLoadingPrimary" ? (l(), u(C(M1), {
      key: 23,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLayer" ? (l(), u(C(H1), {
      key: 24,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCta" ? (l(), u(C(B1), {
      key: 25,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSearch" ? (l(), u(C(x1), {
      key: 26,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcClose" ? (l(), u(C(b1), {
      key: 27,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreUser" ? (l(), u(C(a9), {
      key: 28,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (l(), u(C(h9), {
      key: 29,
      color: e.color
    }, null, 8, ["color"])) : b("", !0);
  }
}), U2 = /* @__PURE__ */ D(N2, [["__scopeId", "data-v-a9ae99e0"]]), z2 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, X2 = ["fill"], n1 = /* @__PURE__ */ c({
  __name: "IcApp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", z2, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, O2 = ["fill"], s1 = /* @__PURE__ */ c({
  __name: "IcChart",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", R2, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, G2 = ["fill"], r1 = /* @__PURE__ */ c({
  __name: "IcHelp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", Y2, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, Q2 = ["fill"], a1 = /* @__PURE__ */ c({
  __name: "IcNotification",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", J2, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, l3 = ["fill"], c1 = /* @__PURE__ */ c({
  __name: "IcOption",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", e3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, t3 = ["fill"], d1 = /* @__PURE__ */ c({
  __name: "IcPayback",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", o3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, s3 = ["fill"], u1 = /* @__PURE__ */ c({
  __name: "IcPerson",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", n3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, i3 = ["fill"], C1 = /* @__PURE__ */ c({
  __name: "IcPlane",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", r3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, c3 = ["fill"], p1 = /* @__PURE__ */ c({
  __name: "IcUpdate",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", a3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, f3 = ["fill"], _1 = /* @__PURE__ */ c({
  __name: "IcLink",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", h3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, v3 = ["fill"], v1 = /* @__PURE__ */ c({
  __name: "IcDown",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", _3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, m3 = { id: "Group 395" }, g3 = ["fill"], y3 = ["fill"], w1 = /* @__PURE__ */ c({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", w3, [
      o("g", m3, [
        o("path", {
          id: "Vector (Stroke)",
          "fill-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, k3 = { id: "ic-plus" }, x3 = ["fill"], g1 = /* @__PURE__ */ c({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, M3 = ["fill"], H3 = ["fill"], B3 = ["fill"], y1 = /* @__PURE__ */ c({
  __name: "IcMoreVertical",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", b3, [
      o("ellipse", {
        cx: "10",
        cy: "15.8333",
        rx: "1.25",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, X3 = { "clip-path": "url(#clip0_3951_314363)" }, R3 = ["fill"], O3 = ["fill"], Y3 = ["fill"], G3 = ["fill"], q3 = ["fill"], K3 = ["fill"], J3 = ["fill"], Q3 = ["fill"], e9 = /* @__PURE__ */ c({
  __name: "IcLoadingPrimary",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(r) {
    return (e, n) => (l(), t("div", U3, [
      (l(), t("svg", z3, [
        o("g", X3, [
          o("path", {
...
}), M1 = /* @__PURE__ */ D(e9, [["__scopeId", "data-v-9156a366"]]), l9 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, o9 = ["fill"], H1 = /* @__PURE__ */ c({
  __name: "IcLayer",
  props: {
    color: { default: () => "#060608" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", l9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, n9 = ["fill"], B1 = /* @__PURE__ */ c({
  __name: "IcCta",
  props: {
    color: { default: () => "#716497" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", t9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, r9 = ["stroke"], i9 = ["stroke"], a9 = /* @__PURE__ */ c({
  __name: "IcCoreUser",
  props: {
    color: { default: () => "#303040" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", s9, [
      o("path", {
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, d9 = { "clip-path": "url(#clip0_1979_140961)" }, u9 = ["stroke"], C9 = ["stroke"], p9 = ["stroke"], h9 = /* @__PURE__ */ c({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", c9, [
      o("g", d9, [
        o("path", {
...
function d(r) {
  return c({
    name: `Wrapped${r.name || "Component"}`,
    setup(e, { attrs: n, slots: s }) {
      return () => J(
        "div",
        {
...
const f9 = d(v2), _9 = d(P2), v9 = d(D2), w9 = d(t1), m9 = d(U2), g9 = d(n1), y9 = d(s1), I9 = d(r1), $9 = d(i1), L9 = d(a1), k9 = d(c1), x9 = d(d1), b9 = d(u1), M9 = d(C1), H9 = d(p1), B9 = d(h1), V9 = d(f1), Z9 = d(_1), A9 = d(o1), S9 = d(R), F9 = d(v1), P9 = d(w1), W9 = d(m1), E9 = d(g1), T9 = d(y1), j9 = d(I1), D9 = d($1), N9 = d(L1), U9 = d(k1), z9 = d(M1), X9 = d(H1), R9 = d(B1), O9 = d(x1), Y9 = d(b1), Q = [
  f9,
  _9,
  v9,
  w9,
  ...
  install(r, e = {}) {
    Q.forEach((n) => {
      const s = n.__name || n.name || "UnnamedComponent";
      r.component(s, n);
    }), e.prefix && Q.forEach((n) => {
      const s = n.__name || n.name || "UnnamedComponent";
      r.component(`${e.prefix}${s}`, n);
    });
  }
};
typeof window < "u" && window.Vue && window.Vue.use(G9);
export {
  ...
  X9 as IcLayer,
  Z9 as IcLink,
  z9 as IcLoadingPrimary,
  V9 as IcMedia,
  T9 as IcMoreVertical,
  L9 as IcNotification,
  k9 as IcOption,
  x9 as IcPayback,
  b9 as IcPerson,
  M9 as IcPlane,
