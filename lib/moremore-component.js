...
const K1 = {
...
}, W1 = ["fill"], t1 = /* @__PURE__ */ a({
  __name: "IcArrowLeft",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", K1, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  setup(r, { expose: e, emit: t }) {
    const n = r, _ = t, E = $(null), B = $(null), T = $(null), k = $(null), u = $(n.initialSlide), m = $(!1), b = $(!1), Z = $({ x: 0, y: 0 }), h = $({ x: 0, y: 0 }), w = $(0), p = $(null), I = x(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), C = x(() => Math.floor(u.value / n.slidesPerView)), v = x(() => {
      const i = Math.ceil(n.items.length / n.slidesPerView);
      return Array.from({ length: i }, (f, y) => y);
    }), g = x(() => (console.log("showPrevButton", n.loop, u.value, I.value), n.loop || u.value > 0)), A = x(() => (console.log("showNextButton", n.loop, u.value, I.value), n.loop || u.value < I.value)), j = x(() => B.value ? (B.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), Z1 = x(() => ({
      overflow: "hidden",
      position: "relative"
    })), A1 = x(() => {
    ...
    })), F1 = (i, f) => n.keyName && i[n.keyName] ? i[n.keyName] : f, R1 = (i) => ({}), D1 = (i) => ({
      width: `${j.value}px`,
      flexShrink: 0
    }), F = (i, f = n.speed) => {
      ...
      n.loop && u.value === I.value ? F(0) : F(u.value + 1);
    }, G = () => {
      n.loop && u.value === 0 ? F(I.value) : F(u.value - 1);
    }, P1 = (i) => {
      ...
      Math.abs(f) > n.threshold && (f > 0 ? G() : D()), b.value = !1, w.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", X), _("touchEnd", i);
    }, G1 = (i) => {
      ...
      if (!b.value) return;
      const f = h.value.x - Z.value.x;
      Math.abs(f) > n.threshold && (f > 0 ? G() : D()), b.value = !1, w.value = 0, _("touchEnd", i);
    }, Y = () => {
    ...
    return j1(() => {
      ...
      i.showPagination ? (o(), s("div", {
        ...
        (o(!0), s(N, null, S(v.value, (y, V) => (o(), s("button", {
          key: V,
          onClick: (M9) => F(V * i.slidesPerView),
  ...
  for (const [n, _] of e)
    t[n] = _;
  return t;
}, s1 = /* @__PURE__ */ P(Q1, [["__scopeId", "data-v-6ed75995"]]), e2 = { class: "w-full py-6 px-5" }, l2 = { class: "flex gap-2" }, o2 = { class: "p-3" }, t2 = { class: "flex gap-2" }, n1 = /* @__PURE__ */ a({
  __name: "CardSkeleton",
  props: {
    type: { default: "user" }
  },
...
}, g2 = { class: "w-full py-6 px-5 mt-auto" }, w2 = ["onClick"], m2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, y2 = ["src", "alt"], I2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, $2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, k2 = /* @__PURE__ */ a({
  ...
  setup(r, { emit: e }) {
    ...
    const B = x(() => t.shops.slice(0, E.value)), T = (h) => {
      n("shop-click", h);
    }, k = (h) => {
            ...
            l("div", i2, [
              ...
              l("div", u2, [
                l("div", C2, [
                  ...
                  p.statusCode ? (o(), s("div", h2, [
                    l("div", {
                      class: H(u(p.statusCode))
                    }, null, 2),
                    l("span", f2, M(m(p.statusCode)), 1)
                  ])) : L("", !0)
                ]),
                p.description ? (o(), s("p", _2, M(p.description), 1)) : L("", !0),
                p.period ? (o(), s("p", v2, M(p.period), 1)) : L("", !0)
              ])
            ])
          ], 8, r2),
...
}), b2 = { class: "w-full" }, x2 = ["onClick"], L2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, M2 = ["src", "alt", "onError"], H2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-2"
}, B2 = { class: "p-3 text-left" }, V2 = {
  key: 0,
  class: "mb-2"
}, N2 = { class: "text-sm font-bold text-[#060608] mb-2 line-clamp-1" }, E2 = {
  key: 1,
...
}, T2 = ["onClick"], F2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, R2 = ["src", "alt"], D2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, P2 = { class: "text-xs text-[#060608] truncate" }, G2 = /* @__PURE__ */ a({
  ...
  emits: ["shop-click", "partnerUser-click"],
  setup(r, { emit: e }) {
    const t = r, n = e, _ = $(!1), E = $(null), B = $(/* @__PURE__ */ new Set()), T = $(t.maxItems);
    O(
      () => t.maxItems,
      (C) => {
        T.value = C;
    ...
    const k = x(() => t.shops.slice(0, T.value)), u = (C) => {
    ...
    return (C, v) => (o(), s("div", b2, [
      l("div", {
        class: H(I.value)
      }, [
        C.loading ? (o(), s(N, { key: 0 }, S(6, (g) => K(n1, {
          key: g,
          type: "user"
        })), 64)) : (o(!0), s(N, { key: 1 }, S(k.value, (g) => (o(), s("div", {
          ...
          l("div", L2, [
            p(g) ? (o(), s("img", {
              ...
              src: g.thumbImgUrl,
              alt: g.marketName,
              onError: (A) => w(g.collaborationId),
              class: "w-full h-full object-cover"
            }, null, 40, M2)) : (o(), s("div", H2, v[0] || (v[0] = [
              l("div", { class: "w-8 h-8 bg-gray-300 rounded flex items-center justify-center" }, [
                l("svg", {
                  class: "w-4 h-4 text-gray-500",
                  fill: "currentColor",
          ...
          l("div", B2, [
            g.statusCode ? (o(), s("div", V2, [
              l("div", {
                class: H([b(g.statusCode), "text-[#303040]"])
              }, [
                l("div", {
                  class: H(Z(g.statusCode))
                }, null, 2),
                R(" " + M(h(g.statusCode)), 1)
              ], 2)
            ])) : L("", !0),
            l("h3", N2, M(g.marketName), 1),
            g.description ? (o(), s("p", E2, M(g.description), 1)) : L("", !0),
            g.period ? (o(), s("p", Z2, M(g.period), 1)) : L("", !0),
            g.hashtags ? (o(), s("p", A2, M(g.hashtags), 1)) : L("", !0),
            g.partnerUsersData && g.partnerUsersData.length > 0 ? (o(), s("div", S2, [
              (o(!0), s(N, null, S(g.partnerUsersData, (A) => (o(), s("div", {
                key: A.id,
...
}), U2 = /* @__PURE__ */ P(G2, [["__scopeId", "data-v-1b1ac295"]]), O2 = { class: "w-full" }, j2 = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, z2 = ["onClick"], X2 = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
...
}, K2 = /* @__PURE__ */ P(X2, [["__scopeId", "data-v-497d3204"]]), W2 = {
  xmlns: "http://www.w3.org/2000/svg",
  width: "20",
  height: "21",
  viewBox: "0 0 20 21",
  fill: "none"
}, Y2 = ["fill"], q2 = /* @__PURE__ */ a({
  __name: "IcStock",
  props: {
    color: { default: () => "#060608" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", W2, [
      l("path", {
  ...
  setup(r) {
    return (e, t) => e.elementIcon === "IcApp" ? (o(), c(d(r1), {
      ...
      key: 11,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLink" ? (o(), c(d(g1), {
      key: 12,
      color: e.color
      ...
      key: 14,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCopy" ? (o(), c(d(m1), {
      key: 15,
      color: e.color
      ...
      key: 21,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcStock" ? (o(), c(q2, {
      key: 22,
      color: e.color
      ...
      key: 28,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreUser" ? (o(), c(d(g9), {
      key: 29,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (o(), c(d(k9), {
      key: 30,
      color: e.color
    }, null, 8, ["color"])) : L("", !0);
  }
}), Q2 = /* @__PURE__ */ P(J2, [["__scopeId", "data-v-dc22d926"]]), e3 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, l3 = ["fill"], r1 = /* @__PURE__ */ a({
  __name: "IcApp",
  props: {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, H3 = { id: "Group 395" }, B3 = ["fill"], V3 = ["fill"], m1 = /* @__PURE__ */ a({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, A3 = { id: "ic-plus" }, S3 = ["fill"], I1 = /* @__PURE__ */ a({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, F3 = ["fill"], R3 = ["fill"], D3 = ["fill"], $1 = /* @__PURE__ */ a({
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, l9 = { "clip-path": "url(#clip0_3951_314363)" }, o9 = ["fill"], t9 = ["fill"], s9 = ["fill"], n9 = ["fill"], r9 = ["fill"], i9 = ["fill"], a9 = ["fill"], c9 = ["fill"], d9 = /* @__PURE__ */ a({
...
}), B1 = /* @__PURE__ */ P(d9, [["__scopeId", "data-v-9156a366"]]), u9 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, _9 = ["stroke"], v9 = ["stroke"], g9 = /* @__PURE__ */ a({
  __name: "IcCoreUser",
  props: {
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, m9 = { "clip-path": "url(#clip0_1979_140961)" }, y9 = ["stroke"], I9 = ["stroke"], $9 = ["stroke"], k9 = /* @__PURE__ */ a({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", w9, [
      l("g", m9, [
        l("path", {
...
const x9 = {
  ...
  TabGroup: K2,
  Swiper: s1
}, E1 = b9(x9), { AdminCreateCards: B9, UserCreateCards: V9, TabGroup: N9, Swiper: E9 } = E1, l1 = [
  ...Object.values(E1),
  Q2,
  r1,
  i1,
...
typeof window < "u" && window.Vue && window.Vue.use(L9);
export {
  B9 as AdminCreateCards,
  Q2 as ElementIcon,
  r1 as IcApp,
  t1 as IcArrowLeft,
  W as IcArrowRight,
