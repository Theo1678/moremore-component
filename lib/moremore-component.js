...
const W1 = {
  ...
  setup(r, { expose: e, emit: t }) {
    const n = r, _ = t, E = $(null), B = $(null), F = $(null), k = $(null), u = $(n.initialSlide), g = $(!1), b = $(!1), Z = $({ x: 0, y: 0 }), h = $({ x: 0, y: 0 }), w = $(0), p = $(null), I = x(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), C = x(() => Math.floor(u.value / n.slidesPerView)), v = x(() => {
      const i = Math.ceil(n.items.length / n.slidesPerView);
      return Array.from({ length: i }, (f, y) => y);
    }), m = x(() => (console.log("showPrevButton", n.loop, u.value, I.value), n.loop || u.value > 0)), A = x(() => (console.log("showNextButton", n.loop, u.value, I.value), n.loop || u.value < I.value)), j = x(() => B.value ? (B.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), Z1 = x(() => ({
      overflow: "hidden",
      position: "relative"
    })), A1 = x(() => {
    ...
    return j1(() => {
      ...
      slideToNext: G,
      slideToPrev: P,
      currentIndex: x(() => u.value),
      isTransitioning: x(() => g.value)
    }), (i, f) => (o(), s("div", {
  ...
  setup(r, { emit: e }) {
    ...
    const B = x(() => t.shops.slice(0, E.value)), F = (h) => {
      n("shop-click", h);
    }, k = (h) => {
          ...
          l("div", {
            ...
            l("div", a2, [
              ...
              l("div", C2, [
                ...
                p.description ? (o(), s("p", v2, M(p.description), 1)) : L("", !0),
                p.period ? (o(), s("p", m2, M(p.period), 1)) : L("", !0)
              ])
            ])
          ], 8, i2),
...
}), x2 = { class: "w-full" }, L2 = ["onClick"], M2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, H2 = ["src", "alt", "onError"], B2 = {
  key: 1,
  ...
  setup(r, { emit: e }) {
    ...
    const k = x(() => t.shops.slice(0, F.value)), u = (C) => {
      ...
      B.value.add(C);
    }, p = (C) => C.thumbImgUrl && !B.value.has(C.collaborationId), I = x(() => {
      ...
      l("div", {
        ...
        C.loading ? (o(), s(N, { key: 0 }, S(6, (m) => K(n1, {
          ...
          l("div", V2, [
            ...
            m.description ? (o(), s("p", Z2, M(m.description), 1)) : L("", !0),
            m.period ? (o(), s("p", A2, M(m.period), 1)) : L("", !0),
            m.hashtags ? (o(), s("p", S2, M(m.hashtags), 1)) : L("", !0),
  ...
  setup(r) {
    return (e, t) => {
      ...
      return e.elementIcon === "IcApp" ? (o(), c(d(r1), {
        ...
        key: 21,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcSparkle" ? (o(), c(d(x1), {
        key: 22,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcStock" ? (o(), c(J2, {
        key: 23,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcPreview" ? (o(), c(d(L1), {
        key: 24,
        color: e.color
        ...
        key: 30,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (o(), c(d(L9), {
        key: 31,
        color: e.color
      }, null, 8, ["color"])) : L("", !0);
    };
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, $9 = { "clip-path": "url(#clip0_1979_140961)" }, k9 = ["stroke"], b9 = ["stroke"], x9 = ["stroke"], L9 = /* @__PURE__ */ a({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
