...
const J1 = {
  ...
  setup(r, { expose: e, emit: t }) {
    const n = r, g = t, E = L(null), H = L(null), S = L(null), F = L(null), _ = L(n.initialSlide), N = L(!1), p = L(!1), k = L({ x: 0, y: 0 }), i = L({ x: 0, y: 0 }), c = L(0), h = L(null), v = x(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), T = x(() => Math.floor(_.value / n.slidesPerView)), f = x(() => {
      ...
      n.loop && _.value === v.value ? P(0) : P(_.value + 1);
    }, G = () => {
      n.loop && _.value === 0 ? P(v.value) : P(_.value - 1);
    }, z1 = (a) => {
    ...
    return Y1(() => {
        ...
        o("div", {
          ...
          (l(!0), s(M, null, V(a.items, (I, Z) => (l(), s("div", {
            ...
            class: $(["swiper-slide", {
              ...
              "swiper-width-100": a.slidesPerView === 1,
              ...j1()
            }]),
            style: U(O1())
          }, [
      ...
      a.showPagination ? (l(), s("div", {
        ...
        (l(!0), s(M, null, V(f.value, (I, Z) => (l(), s("button", {
          key: Z,
          onClick: (z6) => P(Z * a.slidesPerView),
  ...
  for (const [n, g] of e)
    t[n] = g;
  return t;
}, q = /* @__PURE__ */ O(t2, [["__scopeId", "data-v-eb46919c"]]), s2 = { class: "w-full py-6 px-5" }, n2 = { class: "flex gap-2" }, r2 = { class: "p-3" }, i2 = { class: "flex gap-2" }, i1 = /* @__PURE__ */ d({
  __name: "CardSkeleton",
  props: {
    type: { default: "user" }
  },
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, T6 = { "clip-path": "url(#clip0_1979_140961)" }, P6 = ["stroke"], D6 = ["stroke"], R6 = ["stroke"], G6 = /* @__PURE__ */ d({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
...
const j6 = {
  ...
  TabGroup: n3,
  Swiper: q
}, P1 = U6(j6), { AdminCreateCards: K6, UserCreateCards: W6, TabGroup: Y6, Swiper: q6 } = P1, s1 = [
  ...Object.values(P1),
  i3,
  a1,
  c1,
