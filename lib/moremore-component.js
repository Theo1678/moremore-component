import { defineComponent as c, createElementBlock as o, openBlock as l, createElementVNode as t, ref as $, computed as I, onMounted as T1, onUnmounted as N1, watch as J, createBlock as u, createCommentVNode as b, normalizeClass as M, normalizeStyle as X, Fragment as F, renderList as T, renderSlot as G, createTextVNode as E, toDisplayString as k, createVNode as j1, withCtx as D1, withModifiers as Q, unref as h } from "vue";
const X1 = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
...
}, z1 = ["fill"], e1 = /* @__PURE__ */ c({
  __name: "IcArrowLeft",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, n) => (l(), o("svg", X1, [
      t("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  setup(i, { expose: e, emit: n }) {
    const s = i, v = n, S = $(null), B = $(null), A = $(null), L = $(null), d = $(s.initialSlide), g = $(!1), x = $(!1), V = $({ x: 0, y: 0 }), f = $({ x: 0, y: 0 }), _ = $(0), C = $(null), a = I(() => s.loop ? s.items.length - 1 : Math.max(0, s.items.length - s.slidesPerView)), w = I(() => Math.floor(d.value / s.slidesPerView)), m = I(() => {
      const r = Math.ceil(s.items.length / s.slidesPerView);
      return Array.from({ length: r }, (p, y) => y);
    }), Z = I(() => (console.log("showPrevButton", s.loop, d.value, a.value), s.loop || d.value > 0)), O = I(() => (console.log("showNextButton", s.loop, d.value, a.value), s.loop || d.value < a.value)), W = I(() => B.value ? (B.value.clientWidth - (s.slidesPerView - 1) * s.spaceBetween) / s.slidesPerView : 0), k1 = I(() => ({
      overflow: "hidden",
      position: "relative"
    })), M1 = I(() => {
      const r = -(d.value * (W.value + s.spaceBetween)) + _.value;
      return {
        display: "flex",
        transition: g.value && !x.value ? `transform ${s.speed}ms ${s.easing}` : "none",
        transform: `translateX(${r}px)`,
        gap: `${s.spaceBetween}px`
      };
    }), H1 = I(() => {
      if (!s.items.length) return { width: "0%", left: "0%" };
      const r = d.value / a.value, p = s.slidesPerView / s.items.length * 100, y = r * (100 - p);
      return {
        width: `${p}%`,
        left: `${y}%`,
    ...
    })), V1 = (r, p) => s.keyName && r[s.keyName] ? r[s.keyName] : p, Z1 = (r) => ({}), S1 = (r) => ({
      width: `${W.value}px`,
      flexShrink: 0
    }), P = (r, p = s.speed) => {
      if (g.value && !x.value) return;
      const y = Math.max(0, Math.min(r, a.value));
      y !== d.value && (g.value = !0, v("transitionStart", { index: y }), d.value = y, setTimeout(() => {
        g.value = !1, v("transitionEnd", { index: y }), v("slideChange", { index: y, item: s.items[y] }), y === 0 && v("reachBeginning"), y === a.value && v("reachEnd");
      }, p));
    }, N = () => {
      s.loop && d.value === a.value ? P(0) : P(d.value + 1);
    }, D = () => {
      s.loop && d.value === 0 ? P(a.value) : P(d.value - 1);
    }, A1 = (r) => {
      ...
      const p = (f.value.x - V.value.x) * s.touchRatio;
      _.value = p, v("touchMove", r);
    }, U = (r) => {
      if (!x.value) return;
      const p = f.value.x - V.value.x;
      Math.abs(p) > s.threshold && (p > 0 ? D() : N()), x.value = !1, _.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", U), v("touchEnd", r);
    }, P1 = (r) => {
      if (!s.allowTouchMove) return;
      x.value = !0;
      const p = r.touches[0];
      V.value = { x: p.clientX, y: p.clientY }, f.value = { x: p.clientX, y: p.clientY }, v("touchStart", r);
    }, E1 = (r) => {
      if (!x.value) return;
      const p = r.touches[0];
      f.value = { x: p.clientX, y: p.clientY };
      const y = (f.value.x - V.value.x) * s.touchRatio;
      _.value = y, v("touchMove", r);
    }, F1 = (r) => {
      if (!x.value) return;
      const p = f.value.x - V.value.x;
      Math.abs(p) > s.threshold && (p > 0 ? D() : N()), x.value = !1, _.value = 0, v("touchEnd", r);
    }, Y = () => {
    ...
    return T1(() => {
      ...
      r.showNavigation ? (l(), u(e1, {
        key: 0,
        onClick: D,
        class: M(["swiper-button-prev", {
          "type-multiple": r.multiple,
          "swiper-button-disabled": d.value === 0,
        ...
        t("div", {
          ...
          (l(!0), o(F, null, T(r.items, (y, H) => (l(), o("div", {
            ...
            class: M(["swiper-slide", {
              "swiper-slide-active": H === d.value,
              "swiper-slide-prev": H === d.value - 1,
              "swiper-slide-next": H === d.value + 1,
              ...Z1()
            }]),
            style: X(S1())
          }, [
      ...
      r.showNavigation ? (l(), u(R, {
        key: 1,
        onClick: N,
        class: M(["swiper-button-next", {
          "type-multiple": r.multiple,
          "swiper-button-disabled": d.value === a.value,
          "swiper-button-hidden": !O.value
        }])
      }, null, 8, ["class"])) : b("", !0),
      r.showPagination ? (l(), o("div", {
        key: 2,
        class: M(["swiper-pagination", B1.value])
      }, [
        (l(!0), o(F, null, T(m.value, (y, H) => (l(), o("button", {
          key: H,
          ...
          G(r.$slots, "pagination-bullet", {
            ...
            p[0] || (p[0] = t("span", { class: "swiper-bullet-dot" }, null, -1))
          ], !0)
        ], 10, O1))), 128))
      ], 2)) : b("", !0),
  ...
  for (const [s, v] of e)
    n[s] = v;
  return n;
}, l1 = /* @__PURE__ */ j(W1, [["__scopeId", "data-v-6ed75995"]]), Y1 = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 items-start" }, q1 = { class: "w-full max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 overflow-hidden h-full flex flex-col" }, G1 = ["onClick"], K1 = { class: "flex items-center gap-4 h-full" }, J1 = { class: "w-24 h-24 rounded-full border border-gray-300 bg-gray-50 flex-shrink-0 overflow-hidden" }, Q1 = ["src", "alt", "onError"], e2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-1"
}, l2 = { class: "flex-1 min-w-0 text-left flex flex-col justify-center" }, t2 = { class: "flex items-center justify-between gap-3 mb-2" }, o2 = { class: "font-pretendard text-[17px] font-bold leading-[22px] line-clamp-2 text-[#303040]" }, n2 = { class: "text-xs font-medium text-[#303040]" }, s2 = {
  key: 0,
...
}, i2 = { class: "w-full py-6 px-5 mt-auto" }, a2 = ["onClick"], c2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, d2 = ["src", "alt"], u2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, C2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, p2 = /* @__PURE__ */ c({
  ...
  setup(i, { emit: e }) {
    ...
    return (f, _) => (l(), o("div", Y1, [
      (l(!0), o(F, null, T(B.value, (C) => (l(), o("div", {
        key: C.id,
        ...
        t("div", q1, [
            ...
            t("div", K1, [
              ...
              t("div", l2, [
                t("div", t2, [
                  ...
                  C.badge ? (l(), o("div", {
                    key: 0,
                    class: M([d(C.badgeColor), "flex-shrink-0"])
                  }, [
                    t("div", {
                      class: M(g(C.badgeColor))
                    }, null, 2),
                    t("span", n2, k(C.badge), 1)
                  ], 2)) : b("", !0)
                ]),
                C.description ? (l(), o("p", s2, k(C.description), 1)) : b("", !0),
                C.period ? (l(), o("p", r2, k(C.period), 1)) : b("", !0)
              ])
            ])
          ], 8, G1),
          ...
          t("div", i2, [
            ...
            C.participants && C.participants.length > 0 ? (l(), o("div", {
              key: 0,
              class: M(C.participants.length > 4 ? "px-8" : "")
            }, [
              j1(l1, {
                ...
                spaceBetween: 8,
                "show-pagination": !1,
                showNavigation: C.participants.length > 4
              }, {
                default: D1(({ item: a }) => [
                  t("div", {
...
}), h2 = { class: "w-full" }, f2 = ["onClick"], _2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, v2 = ["src", "alt", "onError"], w2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-2"
}, g2 = { class: "p-3 text-left" }, m2 = {
  key: 0,
  class: "mb-2"
}, y2 = { class: "text-sm font-bold text-[#060608] mb-2 line-clamp-1" }, $2 = {
  key: 1,
...
}, b2 = ["onClick"], k2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, M2 = ["src", "alt"], H2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, B2 = { class: "text-xs text-[#060608] truncate" }, V2 = /* @__PURE__ */ c({
  ...
  emits: ["shop-click", "participant-click"],
  setup(i, { emit: e }) {
    const n = i, s = e, v = $(!1), S = $(null), B = $(/* @__PURE__ */ new Set()), A = $(n.maxItems), L = I(() => n.shops.slice(0, A.value)), d = (a) => {
      ...
      B.value.add(a);
    }, _ = (a) => a.image && !B.value.has(a.id), C = I(() => {
    ...
    return (a, w) => (l(), o("div", h2, [
      t("div", {
        class: M(C.value)
      }, [
        (l(!0), o(F, null, T(L.value, (m) => (l(), o("div", {
          key: m.id,
          ...
          t("div", g2, [
            m.badge ? (l(), o("div", m2, [
              t("div", {
                class: M([x(m.badgeColor), "text-[#303040]"])
              }, [
                t("div", {
            ...
            t("h3", y2, k(m.title), 1),
            m.description ? (l(), o("p", $2, k(m.description), 1)) : b("", !0),
            m.period ? (l(), o("p", L2, k(m.period), 1)) : b("", !0),
            m.hashtags ? (l(), o("p", x2, k(m.hashtags), 1)) : b("", !0),
            m.participants && m.participants.length > 0 ? (l(), o("div", I2, [
              (l(!0), o(F, null, T(m.participants, (Z) => (l(), o("div", {
                key: Z.id,
...
}), Z2 = /* @__PURE__ */ j(V2, [["__scopeId", "data-v-d3412538"]]), S2 = { class: "w-full" }, A2 = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, P2 = ["onClick"], E2 = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
  ...
  setup(i, { emit: e }) {
    const n = i, s = e, v = $(n.modelValue), S = (L) => {
      ...
      const d = v.value === L.id, g = "flex items-center justify-center focus:outline-none hover:border-gray-400 border bg-white border-gray-300 hover:bg-gray-50";
      return d ? `${g} bg-[#FFE8F0] border-[#F66D96] border-2 hover:border-red-400 hover:bg-pink-600` : `${g}`;
    }, A = (L) => {
      const d = v.value === L.id, g = "text-sm font-bold text-center whitespace-nowrap";
      return d ? `${g} text-[#F66D96]` : `${g} text-gray-700`;
    };
    return J(
      () => n.modelValue,
      (L) => {
      ...
      t("div", A2, [
        (l(!0), o(F, null, T(i.tabs, (g) => (l(), o("button", {
          key: g.id,
          class: M([B(g), "button"]),
          onClick: (x) => S(g),
          type: "button"
...
}, F2 = /* @__PURE__ */ j(E2, [["__scopeId", "data-v-4e784765"]]), T2 = /* @__PURE__ */ c({
  __name: "ElementIcon",
  props: {
    elementIcon: {},
    color: {}
  ...
  setup(i) {
    return (e, n) => e.elementIcon === "IcApp" ? (l(), u(h(t1), {
      key: 0,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChart" ? (l(), u(h(o1), {
      key: 1,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPerson" ? (l(), u(h(c1), {
      key: 2,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcOption" ? (l(), u(h(i1), {
      key: 3,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcHelp" ? (l(), u(h(n1), {
      key: 4,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcInfo" ? (l(), u(h(s1), {
      key: 5,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcNotification" ? (l(), u(h(r1), {
      key: 6,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPayback" ? (l(), u(h(a1), {
      key: 7,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlane" ? (l(), u(h(d1), {
      key: 8,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSetting" ? (l(), u(h(C1), {
      key: 9,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcUpdate" ? (l(), u(h(u1), {
      key: 10,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMedia" ? (l(), u(h(p1), {
      key: 11,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLink" ? (l(), u(h(h1), {
      key: 12,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcArrowRight" ? (l(), u(h(R), {
      key: 13,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDown" ? (l(), u(h(f1), {
      key: 14,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCopy" ? (l(), u(h(_1), {
      key: 15,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDelete" ? (l(), u(h(v1), {
      key: 16,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlus" ? (l(), u(h(w1), {
      key: 17,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMoreVertical" ? (l(), u(h(g1), {
      key: 18,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCancleFill" ? (l(), u(h(m1), {
      key: 19,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChecked" ? (l(), u(h(y1), {
      key: 20,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSparkle" ? (l(), u(h($1), {
      key: 21,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPreview" ? (l(), u(h(L1), {
      key: 22,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLoadingPrimary" ? (l(), u(h(x1), {
      key: 23,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLayer" ? (l(), u(h(I1), {
      key: 24,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCta" ? (l(), u(h(b1), {
      key: 25,
      color: e.color
    }, null, 8, ["color"])) : b("", !0);
  }
}), N2 = /* @__PURE__ */ j(T2, [["__scopeId", "data-v-80dff00e"]]), j2 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, D2 = ["fill"], t1 = /* @__PURE__ */ c({
  __name: "IcApp",
  props: {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, f3 = { id: "Group 395" }, _3 = ["fill"], v3 = ["fill"], _1 = /* @__PURE__ */ c({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, g3 = ["fill"], v1 = /* @__PURE__ */ c({
  __name: "IcDelete",
  props: {
    color: { default: () => "#FF4136" }
  },
  setup(i) {
    return (e, n) => (l(), o("svg", w3, [
      t("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, y3 = { id: "ic-plus" }, $3 = ["fill"], w1 = /* @__PURE__ */ c({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, n) => (l(), o("svg", m3, [
      t("g", y3, [
        t("path", {
          id: "Union",
          "fill-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, x3 = ["fill"], I3 = ["fill"], b3 = ["fill"], g1 = /* @__PURE__ */ c({
  __name: "IcMoreVertical",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, n) => (l(), o("svg", L3, [
      t("ellipse", {
        cx: "10",
        cy: "15.8333",
        rx: "1.25",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, M3 = ["fill"], m1 = /* @__PURE__ */ c({
  __name: "IcCancleFill",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(i) {
    return (e, n) => (l(), o("svg", k3, [
      t("path", {
...
}), x1 = /* @__PURE__ */ j(J3, [["__scopeId", "data-v-9156a366"]]), Q3 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, e9 = ["fill"], I1 = /* @__PURE__ */ c({
  __name: "IcLayer",
  props: {
