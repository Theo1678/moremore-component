...
const fe = {
  ...
  setup(g, { expose: y, emit: c }) {
    const e = g, p = c, T = w(null), B = w(null), I = w(null), x = w(null), o = w(e.initialSlide), f = w(!1), b = w(!1), M = w({ x: 0, y: 0 }), u = w({ x: 0, y: 0 }), d = w(0), r = w(null), a = _(() => e.loop ? e.items.length - 1 : Math.max(0, e.items.length - e.slidesPerView)), v = _(() => Math.floor(o.value / e.slidesPerView)), m = _(() => {
      ...
      h !== o.value && (f.value = !0, p("transitionStart", { index: h }), o.value = h, setTimeout(() => {
        f.value = !1, p("transitionEnd", { index: h }), p("slideChange", { index: h, item: e.items[h] }), h === 0 && p("reachBeginning"), h === a.value && p("reachEnd");
      }, i));
    }, L = () => {
  ...
  setup(g, { emit: y }) {
    const c = g, e = y, p = w(/* @__PURE__ */ new Set()), T = w(c.maxItems), B = _(() => c.shops.slice(0, T.value)), I = (u) => {
      e("shop-click", u);
    }, x = (u) => {
  ...
  emits: ["shop-click", "participant-click"],
  setup(g, { emit: y }) {
    const c = g, e = y, p = w(!1), T = w(null), B = w(/* @__PURE__ */ new Set()), I = w(c.maxItems), x = _(() => c.shops.slice(0, I.value)), o = (a) => {
...
}), ot = /* @__PURE__ */ H(nt, [["__scopeId", "data-v-4ecf87d9"]]), rt = { class: "w-full" }, it = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, ct = ["onClick"], ut = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
  ...
  setup(g, { emit: y }) {
    const c = g, e = y, p = w(c.modelValue), T = (x) => {
      p.value = x.id, e("update:modelValue", x.id), e("tab-change", x);
    }, B = (x) => {
      const o = p.value === x.id, f = "flex items-center justify-center focus:outline-none hover:border-pink-100 border-2";
...
}, dt = /* @__PURE__ */ H(ut, [["__scopeId", "data-v-3ac8bcb4"]]), F = [De, ot, dt, J], pt = {
  install(g, y = {}) {
    F.forEach((c) => {
