import { defineComponent as A, createElementBlock as n, openBlock as s, createElementVNode as l, ref as w, computed as _, onMounted as de, onUnmounted as ue, watch as K, createBlock as G, createCommentVNode as C, normalizeClass as $, normalizeStyle as z, Fragment as N, renderList as j, renderSlot as Z, createTextVNode as P, toDisplayString as k, createVNode as pe, withCtx as ve, withModifiers as q } from "vue";
const fe = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
  ...
  setup(h, { expose: y, emit: c }) {
    const e = h, p = c, T = w(null), B = w(null), I = w(null), x = w(null), o = w(e.initialSlide), f = w(!1), b = w(!1), M = w({ x: 0, y: 0 }), d = w({ x: 0, y: 0 }), u = w(0), r = w(null), a = _(() => e.loop ? e.items.length - 1 : Math.max(0, e.items.length - e.slidesPerView)), v = _(() => Math.floor(o.value / e.slidesPerView)), m = _(() => {
      const t = Math.ceil(e.items.length / e.slidesPerView);
      return Array.from({ length: t }, (i, g) => g);
    }), E = _(() => e.loop || o.value > 0), U = _(() => e.loop || o.value < a.value), W = _(() => B.value ? (B.value.clientWidth - (e.slidesPerView - 1) * e.spaceBetween) / e.slidesPerView : 0), Q = _(() => ({
      overflow: "hidden",
      position: "relative"
    })), ee = _(() => {
      const t = -(o.value * (W.value + e.spaceBetween)) + u.value;
      return {
        display: "flex",
      ...
      e.allowTouchMove && (b.value = !0, M.value = { x: t.clientX, y: t.clientY }, d.value = { x: t.clientX, y: t.clientY }, document.addEventListener("mousemove", R), document.addEventListener("mouseup", D), p("touchStart", t));
    }, R = (t) => {
      if (!b.value) return;
      ...
      b.value = !0;
      const i = t.touches[0];
      M.value = { x: i.clientX, y: i.clientY }, d.value = { x: i.clientX, y: i.clientY }, p("touchStart", t);
    }, ie = (t) => {
      if (!b.value) return;
      const i = t.touches[0];
    ...
    return de(() => {
      ...
      l("div", {
        ...
        l("div", {
          ...
          (s(!0), n(N, null, j(t.items, (g, S) => (s(), n("div", {
            key: se(g, S),
            class: $(["swiper-slide", {
      ...
      t.showPagination ? (s(), n("div", {
        ...
        (s(!0), n(N, null, j(m.value, (g, S) => (s(), n("button", {
          key: S,
          onClick: (vt) => V(S * t.slidesPerView),
...
}, je = { class: "py-6 px-5 mt-auto" }, Le = ["onClick"], Ae = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, Xe = ["src", "alt"], ze = {
  key: 1,
  ...
  setup(h, { emit: y }) {
    const c = h, e = y, p = w(/* @__PURE__ */ new Set()), T = w(c.maxItems), B = _(() => c.shops.slice(0, T.value)), I = (d) => {
      ...
      p.value.add(d);
    }, M = (d) => d.image && !p.value.has(d.id);
    return (d, u) => (s(), n("div", _e, [
              ...
              l("div", Ee, [
                l("div", Te, [
                  ...
                  r.badge ? (s(), n("div", {
                    ...
                    l("span", Ve, k(r.badge), 1)
                  ], 2)) : C("", !0)
                ]),
                r.description ? (s(), n("p", Pe, k(r.description), 1)) : C("", !0),
...
}), ot = /* @__PURE__ */ H(nt, [["__scopeId", "data-v-8a83f4f8"]]), rt = { class: "w-full" }, it = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, ct = ["onClick"], dt = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
  ...
  setup(h, { emit: y }) {
    ...
    return K(
      ...
      l("div", it, [
        (s(!0), n(N, null, j(h.tabs, (f) => (s(), n("button", {
          key: f.id,
          class: $(B(f)),
          onClick: (b) => T(f),
          type: "button"
...
}, ut = /* @__PURE__ */ H(dt, [["__scopeId", "data-v-861c3166"]]), F = [De, ot, ut, J], pt = {
  install(h, y = {}) {
    F.forEach((c) => {
