...
const e2 = {
  ...
  setup(i, { expose: e, emit: t }) {
    const n = i, $ = L(() => {
    ...
    }), y = t, Z = b(null), A = b(null), F = b(null), T = b(null), v = b(n.initialSlide), _ = b(!1), m = b(!1), a = b({ x: 0, y: 0 }), c = b({ x: 0, y: 0 }), h = b(0), I = b(null), E = L(() => {
      var r, d;
    ...
    }), g = L(() => (console.log("showPrevButton", n.loop, v.value, E.value), n.loop || v.value > 0)), S = L(() => (console.log("showNextButton", n.loop, v.value, E.value), n.loop || v.value < E.value)), z = L(() => A.value ? (A.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), R1 = L(() => ({
      overflow: "hidden",
      position: "relative"
    })), G1 = L(() => {
      ...
      const r = v.value / E.value, d = n.slidesPerView / ((W = $.value) == null ? void 0 : W.length) * 100, k = r * (100 - d);
      return {
        width: `${d}%`,
        left: `${k}%`,
      ...
      try {
        n.loop && v.value === E.value ? P(0) : P(v.value + 1);
      } catch (r) {
        console.error("Error in slideToNext method:", r);
      }
    }, G = () => {
      try {
        n.loop && v.value === 0 ? P(E.value) : P(v.value - 1);
      } catch (r) {
    ...
    return J1(() => {
      ...
      r.showNavigation ? (l(), C(J, {
        ...
        class: x(["swiper-button-next", {
          "type-multiple": r.multiple,
          "swiper-button-disabled": v.value === E.value,
...
}), d2 = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 !gap-8 mb-12 items-start" }, u2 = { class: "w-full max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 overflow-hidden h-full flex flex-col" }, C2 = ["onClick"], p2 = { class: "flex items-center gap-4 h-full" }, h2 = ["src", "alt", "onError"], f2 = {
  key: 1,
  ...
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, N2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, Z2 = /* @__PURE__ */ u({
          ...
          o("div", {
            ...
            o("div", p2, [
              ...
              o("div", v2, [
                ...
                h.description ? (l(), s("p", m2, H(h.description), 1)) : V("", !0),
                h.period ? (l(), s("p", y2, H(h.period), 1)) : V("", !0)
              ])
            ])
          ], 8, C2),
...
}), A2 = { class: "w-full" }, S2 = ["onClick"], T2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, F2 = ["src", "alt", "onError"], P2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-2"
}, D2 = { class: "p-3 text-left" }, R2 = {
  key: 0,
  class: "mb-2"
}, G2 = { class: "text-sm font-bold text-[#060608] mb-2 line-clamp-1" }, U2 = {
  key: 1,
...
}, X2 = ["onClick"], K2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, W2 = ["src", "alt"], Y2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, q2 = {
  ...
  setup(i, { emit: e }) {
    ...
    const F = L(() => t.shops.filter((f) => !f.isHide)), T = L(() => F.value.slice(0, A.value)), v = (f) => {
      ...
      Z.value.add(f);
    }, I = (f) => f.thumbImgUrl && !Z.value.has(f.collaborationId), E = L(() => {
      ...
      o("div", {
        ...
        f.loading ? (l(), s(B, { key: 0 }, N(6, (g) => q(a1, {
          ...
          o("div", D2, [
            ...
            o("h3", G2, H(g.marketName), 1),
            g.description ? (l(), s("p", U2, H(g.description), 1)) : V("", !0),
            g.period ? (l(), s("p", j2, H(g.period), 1)) : V("", !0),
            g.hashtags ? (l(), s("p", O2, H(g.hashtags), 1)) : V("", !0),
            g.partnerUsersData && g.partnerUsersData.length > 0 ? (l(), s("div", z2, [
...
}), Q2 = /* @__PURE__ */ O(J2, [["__scopeId", "data-v-dc4bb508"]]), e3 = { class: "w-full" }, l3 = {
  key: 0,
  class: "relative"
}, o3 = ["onClick"], t3 = {
  key: 1,
  ...
  setup(i) {
    return (e, t) => e.elementIcon === "IcApp" ? (l(), C(p(c1), {
      ...
      key: 25,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcStock" ? (l(), C(p(C6), {
      key: 26,
      color: e.color
      ...
      key: 32,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreUser" ? (l(), C(p(F6), {
      key: 33,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (l(), C(p(j6), {
      key: 34,
      color: e.color
    }, null, 8, ["color"])) : V("", !0);
  }
}), c3 = /* @__PURE__ */ O(a3, [["__scopeId", "data-v-f9e2815a"]]), d3 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, u3 = ["fill"], c1 = /* @__PURE__ */ u({
  __name: "IcApp",
  props: {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, N3 = ["fill"], m1 = /* @__PURE__ */ u({
  __name: "IcMedia",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", E3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, T3 = ["fill"], I1 = /* @__PURE__ */ u({
  __name: "IcLink",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", S3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, z3 = { id: "Group 395" }, X3 = ["fill"], K3 = ["fill"], b1 = /* @__PURE__ */ u({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", O3, [
      o("g", z3, [
        o("path", {
          id: "Vector (Stroke)",
          "fill-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, J3 = { id: "ic-plus" }, Q3 = ["fill"], H1 = /* @__PURE__ */ u({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, l6 = ["fill"], o6 = ["fill"], t6 = ["fill"], B1 = /* @__PURE__ */ u({
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, c6 = ["fill"], N1 = /* @__PURE__ */ u({
  __name: "IcSparkle",
  props: {
    color: { default: () => "#0080FF" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", a6, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, h6 = ["fill"], Z1 = /* @__PURE__ */ u({
  __name: "IcPreview",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", p6, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, v6 = ["fill"], A1 = /* @__PURE__ */ u({
  __name: "IcSearch",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", f6, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, w6 = ["fill"], S1 = /* @__PURE__ */ u({
  __name: "IcClose",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", _6, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, y6 = { "clip-path": "url(#clip0_3951_314363)" }, I6 = ["fill"], $6 = ["fill"], k6 = ["fill"], x6 = ["fill"], L6 = ["fill"], b6 = ["fill"], M6 = ["fill"], H6 = ["fill"], B6 = /* @__PURE__ */ u({
  __name: "IcLoadingPrimary",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(i) {
    return (e, t) => (l(), s("div", g6, [
      (l(), s("svg", m6, [
        o("g", y6, [
          o("path", {
...
}), T1 = /* @__PURE__ */ O(B6, [["__scopeId", "data-v-9156a366"]]), V6 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, E6 = ["fill"], F1 = /* @__PURE__ */ u({
  __name: "IcLayer",
  props: {
    color: { default: () => "#060608" }
  },
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, S6 = ["stroke"], T6 = ["stroke"], F6 = /* @__PURE__ */ u({
  __name: "IcCoreUser",
  props: {
    color: { default: () => "#303040" }
  },
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, D6 = { "clip-path": "url(#clip0_1979_140961)" }, R6 = ["stroke"], G6 = ["stroke"], U6 = ["stroke"], j6 = /* @__PURE__ */ u({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
...
const z6 = {
  ...
  TabGroup: i3,
  Swiper: Q
}, D1 = O6(z6), { AdminCreateCards: W6, UserCreateCards: Y6, TabGroup: q6, Swiper: J6 } = D1, r1 = [
  ...Object.values(D1),
  c3,
  c1,
  d1,
...
typeof window < "u" && window.Vue && window.Vue.use(X6);
export {
  W6 as AdminCreateCards,
  c3 as ElementIcon,
  c1 as IcApp,
  i1 as IcArrowLeft,
  J as IcArrowRight,
