import { defineComponent as a, createElementBlock as t, openBlock as l, createElementVNode as o, ref as $, computed as I, onMounted as U1, onUnmounted as z1, watch as Q, createBlock as c, createCommentVNode as b, normalizeClass as V, normalizeStyle as U, Fragment as E, renderList as D, renderSlot as q, createTextVNode as P, toDisplayString as M, createVNode as O1, withCtx as X1, withModifiers as e1, unref as u, h as K } from "vue";
const R1 = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
...
}, W1 = ["fill"], l1 = /* @__PURE__ */ a({
  __name: "IcArrowLeft",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", R1, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, G1 = ["fill"], X = /* @__PURE__ */ a({
  __name: "IcArrowRight",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", Y1, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  setup(r, { expose: e, emit: n }) {
    const s = r, _ = n, A = $(null), H = $(null), F = $(null), k = $(null), C = $(s.initialSlide), w = $(!1), L = $(!1), y = $({ x: 0, y: 0 }), v = $({ x: 0, y: 0 }), p = $(0), x = $(null), d = I(() => s.loop ? s.items.length - 1 : Math.max(0, s.items.length - s.slidesPerView)), h = I(() => Math.floor(C.value / s.slidesPerView)), m = I(() => {
      const i = Math.ceil(s.items.length / s.slidesPerView);
      return Array.from({ length: i }, (f, g) => g);
    }), Z = I(() => (console.log("showPrevButton", s.loop, C.value, d.value), s.loop || C.value > 0)), R = I(() => (console.log("showNextButton", s.loop, C.value, d.value), s.loop || C.value < d.value)), W = I(() => H.value ? (H.value.clientWidth - (s.slidesPerView - 1) * s.spaceBetween) / s.slidesPerView : 0), V1 = I(() => ({
      overflow: "hidden",
      position: "relative"
    })), Z1 = I(() => {
      const i = -(C.value * (W.value + s.spaceBetween)) + p.value;
      return {
        display: "flex",
        transition: w.value && !L.value ? `transform ${s.speed}ms ${s.easing}` : "none",
        transform: `translateX(${i}px)`,
        gap: `${s.spaceBetween}px`
      };
    }), A1 = I(() => {
      if (!s.items.length) return { width: "0%", left: "0%" };
      const i = C.value / d.value, f = s.slidesPerView / s.items.length * 100, g = i * (100 - f);
      return {
        width: `${f}%`,
        left: `${g}%`,
        transition: w.value ? `all ${s.speed}ms ${s.easing}` : "none"
      };
    }), F1 = I(() => ({
      "swiper-pagination-horizontal": !0,
      "swiper-pagination-bullets": !0
    })), S1 = (i, f) => s.keyName && i[s.keyName] ? i[s.keyName] : f, P1 = (i) => ({}), E1 = (i) => ({
      width: `${W.value}px`,
      flexShrink: 0
    }), S = (i, f = s.speed) => {
      if (w.value && !L.value) return;
      const g = Math.max(0, Math.min(i, d.value));
      g !== C.value && (w.value = !0, _("transitionStart", { index: g }), C.value = g, setTimeout(() => {
        w.value = !1, _("transitionEnd", { index: g }), _("slideChange", { index: g, item: s.items[g] }), g === 0 && _("reachBeginning"), g === d.value && _("reachEnd");
      }, f));
    }, N = () => {
      s.loop && C.value === d.value ? S(0) : S(C.value + 1);
    }, T = () => {
      s.loop && C.value === 0 ? S(d.value) : S(C.value - 1);
    }, D1 = (i) => {
      s.allowTouchMove && (L.value = !0, y.value = { x: i.clientX, y: i.clientY }, v.value = { x: i.clientX, y: i.clientY }, document.addEventListener("mousemove", z), document.addEventListener("mouseup", O), _("touchStart", i));
    }, z = (i) => {
      if (!L.value) return;
      v.value = { x: i.clientX, y: i.clientY };
      const f = (v.value.x - y.value.x) * s.touchRatio;
      p.value = f, _("touchMove", i);
    }, O = (i) => {
      if (!L.value) return;
      const f = v.value.x - y.value.x;
      Math.abs(f) > s.threshold && (f > 0 ? T() : N()), L.value = !1, p.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", O), _("touchEnd", i);
    }, N1 = (i) => {
      if (!s.allowTouchMove) return;
      L.value = !0;
      const f = i.touches[0];
      y.value = { x: f.clientX, y: f.clientY }, v.value = { x: f.clientX, y: f.clientY }, _("touchStart", i);
    }, j1 = (i) => {
      if (!L.value) return;
      const f = i.touches[0];
      v.value = { x: f.clientX, y: f.clientY };
      const g = (v.value.x - y.value.x) * s.touchRatio;
      p.value = g, _("touchMove", i);
    }, T1 = (i) => {
      if (!L.value) return;
      const f = v.value.x - y.value.x;
      Math.abs(f) > s.threshold && (f > 0 ? T() : N()), L.value = !1, p.value = 0, _("touchEnd", i);
    }, Y = () => {
      if (!s.autoplay) return;
      const i = typeof s.autoplay == "object" && s.autoplay.delay || 3e3;
      x.value = setInterval(() => {
        N();
      }, i);
    }, G = () => {
    ...
    return U1(() => {
      ...
      G(), document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", O);
    }), Q(
      () => s.autoplay,
      (i) => {
        i ? Y() : G();
      ...
      slideToNext: N,
      slideToPrev: T,
      currentIndex: I(() => C.value),
      isTransitioning: I(() => w.value)
    }), (i, f) => (l(), t("div", {
      class: "swiper-container",
      ref_key: "swiperContainer",
      ref: A
    }, [
      i.showNavigation ? (l(), c(l1, {
        key: 0,
        onClick: T,
        class: V(["swiper-button-prev", {
          "type-multiple": i.multiple,
          "swiper-button-disabled": C.value === 0,
          "swiper-button-hidden": !Z.value
        }])
      }, null, 8, ["class"])) : b("", !0),
      o("div", {
        ...
        o("div", {
          ...
          (l(!0), t(E, null, D(i.items, (g, B) => (l(), t("div", {
            key: S1(g, B),
            class: V(["swiper-slide", {
              "swiper-slide-active": B === C.value,
              "swiper-slide-prev": B === C.value - 1,
              "swiper-slide-next": B === C.value + 1,
              ...P1()
            }]),
            style: U(E1())
          }, [
      ...
      i.showNavigation ? (l(), c(X, {
        key: 1,
        onClick: N,
        class: V(["swiper-button-next", {
          "type-multiple": i.multiple,
          "swiper-button-disabled": C.value === d.value,
          "swiper-button-hidden": !R.value
        }])
      }, null, 8, ["class"])) : b("", !0),
      i.showPagination ? (l(), t("div", {
        key: 2,
        class: V(["swiper-pagination", F1.value])
      }, [
        (l(!0), t(E, null, D(m.value, (g, B) => (l(), t("button", {
          key: B,
          onClick: (m9) => S(B * i.slidesPerView),
          class: V(["swiper-pagination-bullet", {
            "swiper-pagination-bullet-active": B === h.value
          }])
        }, [
          q(i.$slots, "pagination-bullet", {
            index: B,
            isActive: B === h.value
          }, () => [
            f[0] || (f[0] = o("span", { class: "swiper-bullet-dot" }, null, -1))
          ], !0)
        ], 10, q1))), 128))
      ], 2)) : b("", !0),
  ...
  for (const [s, _] of e)
    n[s] = _;
  return n;
}, o1 = /* @__PURE__ */ j(K1, [["__scopeId", "data-v-6ed75995"]]), J1 = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 !gap-8 mb-12 items-start" }, Q1 = { class: "w-full max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 overflow-hidden h-full flex flex-col" }, e2 = ["onClick"], l2 = { class: "flex items-center gap-4 h-full" }, o2 = { class: "w-24 h-24 rounded-full border border-gray-300 bg-gray-50 flex-shrink-0 overflow-hidden" }, t2 = ["src", "alt", "onError"], n2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-1"
}, s2 = { class: "flex-1 min-w-0 text-left flex flex-col justify-center" }, r2 = { class: "flex flex-nowrap items-center justify-between gap-3 mb-2" }, i2 = { class: "font-pretendard text-[17px] font-bold leading-[22px] line-clamp-2 text-[#060608]" }, a2 = {
  key: 0,
  class: "flex items-center gap-2 px-2 py-1 rounded-md flex-shrink-0"
}, c2 = { class: "text-xs font-medium text-[#303040]" }, d2 = {
  key: 0,
...
}, C2 = { class: "w-full py-6 px-5 mt-auto" }, p2 = ["onClick"], h2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, f2 = ["src", "alt"], _2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, v2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, w2 = /* @__PURE__ */ a({
  ...
  setup(r, { emit: e }) {
    const n = r, s = e, _ = $(/* @__PURE__ */ new Set()), A = $(n.maxItems), H = I(() => n.shops.slice(0, A.value)), F = (y) => {
      s("shop-click", y);
    }, k = (y) => {
      s("participant-click", y);
    }, C = (y) => {
      const v = "w-2 h-2 rounded-full";
      switch (y) {
        case "모집중":
          return `${v} bg-[#0E6CF5]`;
        case "모집마감":
      ...
      _.value.add(y);
    }, L = (y) => y.image && !_.value.has(y.id);
    return (y, v) => (l(), t("div", J1, [
      (l(!0), t(E, null, D(H.value, (p) => (l(), t("div", {
            ...
            o("div", l2, [
              o("div", o2, [
                L(p) ? (l(), t("img", {
                  ...
                  src: p.thumbImgUrl,
                  alt: p.marketName,
                  onError: (x) => w(p.collaborationId),
                  class: "w-full h-full object-cover"
                }, null, 40, t2)) : (l(), t("div", n2, v[0] || (v[0] = [
              ...
              o("div", s2, [
                o("div", r2, [
                  o("h2", i2, M(p.marketName), 1),
                  p.statusMessage ? (l(), t("div", a2, [
                    o("div", {
                      class: V(C(p.statusMessage))
                    }, null, 2),
                    o("span", c2, M(p.statusMessage), 1)
                  ])) : b("", !0)
                ]),
                p.description ? (l(), t("p", d2, M(p.description), 1)) : b("", !0),
                p.period ? (l(), t("p", u2, M(p.period), 1)) : b("", !0)
              ])
            ])
          ], 8, e2),
          v[3] || (v[3] = o("div", { class: "border-t border-gray-200" }, null, -1)),
          o("div", C2, [
            v[2] || (v[2] = o("h3", { class: "text-left font-pretendard text-[15px] font-bold leading-[22px] mb-2 text-[#303040]" }, " 참여작가 ", -1)),
            p.partnerUsersData && p.partnerUsersData.length > 0 ? (l(), t("div", {
              key: 0,
              class: V(p.partnerUsersData.length > 4 ? "px-8" : "")
            }, [
              O1(o1, {
                ...
                default: X1(({ item: x }) => [
                  o("div", {
                    ...
                    onClick: e1((d) => k(x), ["stop"])
                  }, [
                    o("div", h2, [
                      x.profileImgUrl ? (l(), t("img", {
                        key: 0,
                        src: x.profileImgUrl,
                        alt: x.nickName,
                        class: "w-full h-full object-cover"
                      }, null, 8, f2)) : (l(), t("div", _2, v[1] || (v[1] = [
                        o("svg", {
...
}), m2 = { class: "w-full" }, g2 = ["onClick"], y2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, $2 = ["src", "alt", "onError"], k2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-2"
}, L2 = { class: "p-3 text-left" }, I2 = {
  key: 0,
  class: "mb-2"
}, x2 = { class: "text-sm font-bold text-[#060608] mb-2 line-clamp-1" }, b2 = {
  key: 1,
...
}, V2 = ["onClick"], Z2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, A2 = ["src", "alt"], F2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, S2 = { class: "text-xs text-[#060608] truncate" }, P2 = /* @__PURE__ */ a({
  ...
  emits: ["shop-click", "participant-click"],
  setup(r, { emit: e }) {
    const n = r, s = e, _ = $(!1), A = $(null), H = $(/* @__PURE__ */ new Set()), F = $(n.maxItems), k = I(() => n.shops.slice(0, F.value)), C = (d) => {
      A.value = d, _.value = !0, s("shop-click", d);
    }, w = (d) => {
      s("participant-click", d);
    }, L = (d) => {
      ...
      H.value.add(d);
    }, p = (d) => d.image && !H.value.has(d.id), x = I(() => {
      const d = n.itemsPerRow;
      let h = "grid grid-cols-1";
      return d >= 2 && (h += " md:grid-cols-2"), d >= 3 && (h += " lg:grid-cols-3"), d >= 4 && (h += " xl:grid-cols-4"), d >= 5 && (h += " 2xl:grid-cols-5"), d >= 6 && (h += " 2xl:grid-cols-6"), `${h} gap-8`;
    });
    return (d, h) => (l(), t("div", m2, [
      o("div", {
        class: V(x.value)
      }, [
        (l(!0), t(E, null, D(k.value, (m) => (l(), t("div", {
          ...
          o("div", y2, [
            p(m) ? (l(), t("img", {
              ...
              src: m.thumbImgUrl,
              alt: m.marketName,
              onError: (Z) => v(m.collaborationId),
              class: "w-full h-full object-cover"
            }, null, 40, $2)) : (l(), t("div", k2, h[0] || (h[0] = [
              o("div", { class: "w-8 h-8 bg-gray-300 rounded flex items-center justify-center" }, [
                o("svg", {
                  class: "w-4 h-4 text-gray-500",
                  fill: "currentColor",
          ...
          o("div", L2, [
            m.statusMessage ? (l(), t("div", I2, [
              o("div", {
                class: V([L(m.statusMessage), "text-[#303040]"])
              }, [
                o("div", {
                  class: V(y(m.statusMessage))
                }, null, 2),
                P(" " + M(m.statusMessage), 1)
              ], 2)
            ])) : b("", !0),
            o("h3", x2, M(m.marketName), 1),
            m.description ? (l(), t("p", b2, M(m.description), 1)) : b("", !0),
            m.period ? (l(), t("p", M2, M(m.period), 1)) : b("", !0),
            m.hashtags ? (l(), t("p", H2, M(m.hashtags), 1)) : b("", !0),
            m.partnerUsersData && m.partnerUsersData.length > 0 ? (l(), t("div", B2, [
              (l(!0), t(E, null, D(m.partnerUsersData, (Z) => (l(), t("div", {
                key: Z.id,
                ...
                onClick: e1((R) => w(Z), ["stop"])
              }, [
                o("div", Z2, [
                  Z.profileImgUrl ? (l(), t("img", {
                    key: 0,
                    src: Z.profileImgUrl,
                    alt: Z.nickName,
                    class: "w-full h-full object-cover"
                  }, null, 8, A2)) : (l(), t("div", F2, h[1] || (h[1] = [
                    o("svg", {
...
}), E2 = /* @__PURE__ */ j(P2, [["__scopeId", "data-v-5ff36486"]]), D2 = { class: "w-full" }, N2 = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, j2 = ["onClick"], T2 = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
  ...
  setup(r, { emit: e }) {
    const n = r, s = e, _ = $(n.modelValue), A = (k) => {
      _.value = k.id, s("update:modelValue", k.id), s("tab-change", k);
    }, H = (k) => {
      const C = _.value === k.id, w = "flex items-center justify-center focus:outline-none hover:border-[#F66D96] border-1";
      return C ? `${w} bg-[#FFE8F0] border-[#F66D96] border-2` : `${w} bg-white border-[#CFD3DA] border-2`;
    }, F = (k) => {
      const C = _.value === k.id, w = "text-sm font-bold text-center whitespace-nowrap";
    ...
    return Q(
      ...
      o("div", N2, [
        (l(!0), t(E, null, D(r.tabs, (w) => (l(), t("button", {
          key: w.id,
          class: V(H(w)),
          onClick: (L) => A(w),
          type: "button"
...
}, U2 = /* @__PURE__ */ j(T2, [["__scopeId", "data-v-497d3204"]]), z2 = /* @__PURE__ */ a({
  __name: "ElementIcon",
  props: {
    elementIcon: {},
    color: {}
  ...
  setup(r) {
    return (e, n) => e.elementIcon === "IcApp" ? (l(), c(u(t1), {
      key: 0,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChart" ? (l(), c(u(n1), {
      key: 1,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPerson" ? (l(), c(u(d1), {
      key: 2,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcOption" ? (l(), c(u(a1), {
      key: 3,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcHelp" ? (l(), c(u(s1), {
      key: 4,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcInfo" ? (l(), c(u(r1), {
      key: 5,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcNotification" ? (l(), c(u(i1), {
      key: 6,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPayback" ? (l(), c(u(c1), {
      key: 7,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlane" ? (l(), c(u(u1), {
      key: 8,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSetting" ? (l(), c(u(p1), {
      key: 9,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcUpdate" ? (l(), c(u(C1), {
      key: 10,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMedia" ? (l(), c(u(h1), {
      key: 11,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLink" ? (l(), c(u(f1), {
      key: 12,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcArrowRight" ? (l(), c(u(X), {
      key: 13,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDown" ? (l(), c(u(_1), {
      key: 14,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCopy" ? (l(), c(u(v1), {
      key: 15,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDelete" ? (l(), c(u(w1), {
      key: 16,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlus" ? (l(), c(u(m1), {
      key: 17,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMoreVertical" ? (l(), c(u(g1), {
      key: 18,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCancleFill" ? (l(), c(u(y1), {
      key: 19,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChecked" ? (l(), c(u($1), {
      key: 20,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSparkle" ? (l(), c(u(k1), {
      key: 21,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPreview" ? (l(), c(u(L1), {
      key: 22,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLoadingPrimary" ? (l(), c(u(b1), {
      key: 23,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLayer" ? (l(), c(u(M1), {
      key: 24,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCta" ? (l(), c(u(H1), {
      key: 25,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSearch" ? (l(), c(u(I1), {
      key: 26,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcClose" ? (l(), c(u(x1), {
      key: 27,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreUser" ? (l(), c(u(c9), {
      key: 28,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (l(), c(u(f9), {
      key: 29,
      color: e.color
    }, null, 8, ["color"])) : b("", !0);
  }
}), O2 = /* @__PURE__ */ j(z2, [["__scopeId", "data-v-a9ae99e0"]]), X2 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, R2 = ["fill"], t1 = /* @__PURE__ */ a({
  __name: "IcApp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", X2, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, Y2 = ["fill"], n1 = /* @__PURE__ */ a({
  __name: "IcChart",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", W2, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, q2 = ["fill"], s1 = /* @__PURE__ */ a({
  __name: "IcHelp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", G2, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, g3 = { id: "Group 395" }, y3 = ["fill"], $3 = ["fill"], v1 = /* @__PURE__ */ a({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", m3, [
      o("g", g3, [
        o("path", {
          id: "Vector (Stroke)",
          "fill-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, x3 = { id: "ic-plus" }, b3 = ["fill"], m1 = /* @__PURE__ */ a({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, H3 = ["fill"], B3 = ["fill"], V3 = ["fill"], g1 = /* @__PURE__ */ a({
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, A3 = ["fill"], y1 = /* @__PURE__ */ a({
  __name: "IcCancleFill",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", Z3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, N3 = ["fill"], L1 = /* @__PURE__ */ a({
  __name: "IcPreview",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", D3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, R3 = { "clip-path": "url(#clip0_3951_314363)" }, W3 = ["fill"], Y3 = ["fill"], G3 = ["fill"], q3 = ["fill"], K3 = ["fill"], J3 = ["fill"], Q3 = ["fill"], e9 = ["fill"], l9 = /* @__PURE__ */ a({
  __name: "IcLoadingPrimary",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(r) {
    return (e, n) => (l(), t("div", O3, [
      (l(), t("svg", X3, [
        o("g", R3, [
          o("path", {
...
}), b1 = /* @__PURE__ */ j(l9, [["__scopeId", "data-v-9156a366"]]), o9 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, t9 = ["fill"], M1 = /* @__PURE__ */ a({
  __name: "IcLayer",
  props: {
    color: { default: () => "#060608" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", o9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, s9 = ["fill"], H1 = /* @__PURE__ */ a({
  __name: "IcCta",
  props: {
    color: { default: () => "#716497" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", n9, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, i9 = ["stroke"], a9 = ["stroke"], c9 = /* @__PURE__ */ a({
  __name: "IcCoreUser",
  props: {
    color: { default: () => "#303040" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", r9, [
      o("path", {
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, u9 = { "clip-path": "url(#clip0_1979_140961)" }, C9 = ["stroke"], p9 = ["stroke"], h9 = ["stroke"], f9 = /* @__PURE__ */ a({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
  setup(r) {
    return (e, n) => (l(), t("svg", d9, [
      o("g", u9, [
        o("path", {
...
const v9 = {
  ...
  TabGroup: U2,
  Swiper: o1
}, B1 = _9(v9), { AdminCreateCards: y9, UserCreateCards: $9, TabGroup: k9, Swiper: L9 } = B1, J = [
  ...Object.values(B1),
  O2,
  t1,
  n1,
  ...
  install(r, e = {}) {
    J.forEach((n) => {
      const s = n.name || "UnnamedComponent";
      r.component(s, n);
    }), e.prefix && J.forEach((n) => {
      const s = n.name || "UnnamedComponent";
      r.component(`${e.prefix}${s}`, n);
    });
  }
};
typeof window < "u" && window.Vue && window.Vue.use(w9);
export {
  y9 as AdminCreateCards,
  O2 as ElementIcon,
  t1 as IcApp,
  l1 as IcArrowLeft,
  X as IcArrowRight,
  ...
  h1 as IcMedia,
  g1 as IcMoreVertical,
  i1 as IcNotification,
  a1 as IcOption,
  c1 as IcPayback,
  d1 as IcPerson,
  u1 as IcPlane,
