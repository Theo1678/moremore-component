import { defineComponent as a, createElementBlock as s, openBlock as o, createElementVNode as l, ref as $, computed as x, onMounted as X1, onUnmounted as R1, watch as z, createBlock as d, createCommentVNode as L, normalizeClass as H, normalizeStyle as U, Fragment as Z, renderList as F, renderSlot as J, createTextVNode as N, toDisplayString as M, createStaticVNode as Q, createVNode as R, withCtx as W1, withModifiers as o1, unref as u, h as e1 } from "vue";
const Y1 = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
...
}, G1 = ["fill"], t1 = /* @__PURE__ */ a({
  __name: "IcArrowLeft",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", Y1, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  setup(r, { expose: e, emit: t }) {
    const n = r, v = t, A = $(null), B = $(null), P = $(null), k = $(null), C = $(n.initialSlide), w = $(!1), b = $(!1), m = $({ x: 0, y: 0 }), _ = $({ x: 0, y: 0 }), p = $(0), I = $(null), c = x(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), h = x(() => Math.floor(C.value / n.slidesPerView)), g = x(() => {
      const i = Math.ceil(n.items.length / n.slidesPerView);
      return Array.from({ length: i }, (f, y) => y);
    }), S = x(() => (console.log("showPrevButton", n.loop, C.value, c.value), n.loop || C.value > 0)), Y = x(() => (console.log("showNextButton", n.loop, C.value, c.value), n.loop || C.value < c.value)), G = x(() => B.value ? (B.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), S1 = x(() => ({
      overflow: "hidden",
      position: "relative"
    })), F1 = x(() => {
      const i = -(C.value * (G.value + n.spaceBetween)) + p.value;
      return {
        display: "flex",
        transition: w.value && !b.value ? `transform ${n.speed}ms ${n.easing}` : "none",
        transform: `translateX(${i}px)`,
        gap: `${n.spaceBetween}px`
      };
    }), P1 = x(() => {
      if (!n.items.length) return { width: "0%", left: "0%" };
      const i = C.value / c.value, f = n.slidesPerView / n.items.length * 100, y = i * (100 - f);
      return {
        width: `${f}%`,
        left: `${y}%`,
        transition: w.value ? `all ${n.speed}ms ${n.easing}` : "none"
      };
    }), E1 = x(() => ({
      "swiper-pagination-horizontal": !0,
      "swiper-pagination-bullets": !0
    })), N1 = (i, f) => n.keyName && i[n.keyName] ? i[n.keyName] : f, D1 = (i) => ({}), j1 = (i) => ({
      width: `${G.value}px`,
      flexShrink: 0
    }), E = (i, f = n.speed) => {
      if (w.value && !b.value) return;
      const y = Math.max(0, Math.min(i, c.value));
      y !== C.value && (w.value = !0, v("transitionStart", { index: y }), C.value = y, setTimeout(() => {
        w.value = !1, v("transitionEnd", { index: y }), v("slideChange", { index: y, item: n.items[y] }), y === 0 && v("reachBeginning"), y === c.value && v("reachEnd");
      }, f));
    }, D = () => {
      n.loop && C.value === c.value ? E(0) : E(C.value + 1);
    }, T = () => {
      n.loop && C.value === 0 ? E(c.value) : E(C.value - 1);
    }, T1 = (i) => {
      n.allowTouchMove && (b.value = !0, m.value = { x: i.clientX, y: i.clientY }, _.value = { x: i.clientX, y: i.clientY }, document.addEventListener("mousemove", O), document.addEventListener("mouseup", X), v("touchStart", i));
    }, O = (i) => {
      if (!b.value) return;
      _.value = { x: i.clientX, y: i.clientY };
      const f = (_.value.x - m.value.x) * n.touchRatio;
      p.value = f, v("touchMove", i);
    }, X = (i) => {
      if (!b.value) return;
      const f = _.value.x - m.value.x;
      Math.abs(f) > n.threshold && (f > 0 ? T() : D()), b.value = !1, p.value = 0, document.removeEventListener("mousemove", O), document.removeEventListener("mouseup", X), v("touchEnd", i);
    }, U1 = (i) => {
      if (!n.allowTouchMove) return;
      b.value = !0;
      const f = i.touches[0];
      m.value = { x: f.clientX, y: f.clientY }, _.value = { x: f.clientX, y: f.clientY }, v("touchStart", i);
    }, z1 = (i) => {
      if (!b.value) return;
      const f = i.touches[0];
      _.value = { x: f.clientX, y: f.clientY };
      const y = (_.value.x - m.value.x) * n.touchRatio;
      p.value = y, v("touchMove", i);
    }, O1 = (i) => {
      if (!b.value) return;
      const f = _.value.x - m.value.x;
      Math.abs(f) > n.threshold && (f > 0 ? T() : D()), b.value = !1, p.value = 0, v("touchEnd", i);
    }, q = () => {
    ...
    return X1(() => {
      ...
      K(), document.removeEventListener("mousemove", O), document.removeEventListener("mouseup", X);
    }), z(
      () => n.autoplay,
      (i) => {
        i ? q() : K();
      ...
      slideToNext: D,
      slideToPrev: T,
      currentIndex: x(() => C.value),
      isTransitioning: x(() => w.value)
    }), (i, f) => (o(), s("div", {
      class: "swiper-container",
      ref_key: "swiperContainer",
      ref: A
    }, [
      i.showNavigation ? (o(), d(t1, {
        key: 0,
        onClick: T,
      ...
      l("div", {
        ...
        l("div", {
          ...
          (o(!0), s(Z, null, F(i.items, (y, V) => (o(), s("div", {
            key: N1(y, V),
            class: H(["swiper-slide", {
              "swiper-slide-active": V === C.value,
              "swiper-slide-prev": V === C.value - 1,
              "swiper-slide-next": V === C.value + 1,
              ...D1()
            }]),
            style: U(j1())
          }, [
      ...
      i.showNavigation ? (o(), d(W, {
        key: 1,
        onClick: D,
        class: H(["swiper-button-next", {
          "type-multiple": i.multiple,
          "swiper-button-disabled": C.value === c.value,
          "swiper-button-hidden": !Y.value
        }])
      }, null, 8, ["class"])) : L("", !0),
      i.showPagination ? (o(), s("div", {
        key: 2,
        class: H(["swiper-pagination", E1.value])
      }, [
        (o(!0), s(Z, null, F(g.value, (y, V) => (o(), s("button", {
          key: V,
          onClick: (x9) => E(V * i.slidesPerView),
          class: H(["swiper-pagination-bullet", {
            "swiper-pagination-bullet-active": V === h.value
          }])
        }, [
  ...
  for (const [n, v] of e)
    t[n] = v;
  return t;
}, s1 = /* @__PURE__ */ j(Q1, [["__scopeId", "data-v-6ed75995"]]), e2 = { class: "w-full py-6 px-5" }, l2 = { class: "flex gap-2" }, o2 = { class: "p-3" }, t2 = { class: "flex gap-2" }, n1 = /* @__PURE__ */ a({
  __name: "CardSkeleton",
  props: {
    type: { default: "user" }
  },
...
}), s2 = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 !gap-8 mb-12 items-start" }, n2 = { class: "w-full max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 overflow-hidden h-full flex flex-col" }, r2 = ["onClick"], i2 = { class: "flex items-center gap-4 h-full" }, a2 = { class: "w-24 h-24 rounded-full border border-gray-300 bg-gray-50 flex-shrink-0 overflow-hidden" }, c2 = ["src", "alt", "onError"], d2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-1"
}, u2 = { class: "flex-1 min-w-0 text-left flex flex-col justify-center" }, C2 = { class: "flex flex-nowrap items-center justify-between gap-3 mb-2" }, p2 = { class: "font-pretendard text-[17px] font-bold leading-[22px] line-clamp-2 text-[#060608]" }, h2 = {
  key: 0,
  class: "flex items-center gap-2 px-2 py-1 rounded-md flex-shrink-0"
}, f2 = { class: "text-xs font-medium text-[#303040]" }, v2 = {
  key: 0,
...
}, g2 = { class: "w-full py-6 px-5 mt-auto" }, m2 = ["onClick"], w2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, y2 = ["src", "alt"], $2 = {
  key: 1,
  ...
  setup(r, { emit: e }) {
    const t = r, n = e, v = $(/* @__PURE__ */ new Set()), A = $(t.maxItems);
    z(
      () => t.maxItems,
      (m) => {
        A.value = m;
    ...
    const B = x(() => t.shops.slice(0, A.value)), P = (m) => {
      n("shop-click", m);
    }, k = (m) => {
      n("partnerUser-click", m);
    }, C = (m) => {
      const _ = "w-2 h-2 rounded-full";
      switch (m) {
        case "모집중":
          return `${_} bg-[#0E6CF5]`;
        case "모집마감":
      ...
      v.value.add(m);
    }, b = (m) => m.thumbImgUrl && !v.value.has(m.collaborationId);
    return (m, _) => (o(), s("div", s2, [
      m.loading ? (o(), s(Z, { key: 0 }, F(6, (p) => R(n1, {
        key: p,
        type: "admin"
      })), 64)) : (o(!0), s(Z, { key: 1 }, F(B.value, (p) => (o(), s("div", {
            ...
            l("div", i2, [
              l("div", a2, [
                b(p) ? (o(), s("img", {
                  ...
                  src: p.thumbImgUrl,
                  alt: p.marketName,
                  onError: (I) => w(p.collaborationId),
                  class: "w-full h-full object-cover"
                }, null, 40, c2)) : (o(), s("div", d2, _[0] || (_[0] = [
              ...
              l("div", u2, [
                l("div", C2, [
                  l("h2", p2, M(p.marketName), 1),
                  p.statusMessage ? (o(), s("div", h2, [
                    l("div", {
                      class: H(C(p.statusMessage))
                    }, null, 2),
                    l("span", f2, M(p.statusMessage), 1)
                  ])) : L("", !0)
                ]),
                p.description ? (o(), s("p", v2, M(p.description), 1)) : L("", !0),
                p.period ? (o(), s("p", _2, M(p.period), 1)) : L("", !0)
              ])
            ])
          ], 8, r2),
          _[3] || (_[3] = l("div", { class: "border-t border-gray-200" }, null, -1)),
          l("div", g2, [
            _[2] || (_[2] = l("h3", { class: "text-left font-pretendard text-[15px] font-bold leading-[22px] mb-2 text-[#303040]" }, " 참여작가 ", -1)),
...
}), x2 = { class: "w-full" }, I2 = ["onClick"], L2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, M2 = ["src", "alt", "onError"], H2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-2"
}, B2 = { class: "p-3 text-left" }, V2 = {
  key: 0,
  class: "mb-2"
}, Z2 = { class: "text-sm font-bold text-[#060608] mb-2 line-clamp-1" }, A2 = {
  key: 1,
...
}, E2 = ["onClick"], N2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, D2 = ["src", "alt"], j2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, T2 = { class: "text-xs text-[#060608] truncate" }, U2 = /* @__PURE__ */ a({
  ...
  emits: ["shop-click", "partnerUser-click"],
  setup(r, { emit: e }) {
    const t = r, n = e, v = $(!1), A = $(null), B = $(/* @__PURE__ */ new Set()), P = $(t.maxItems);
    z(
      () => t.maxItems,
      (c) => {
        P.value = c;
    ...
    const k = x(() => t.shops.slice(0, P.value)), C = (c) => {
      A.value = c, v.value = !0, n("shop-click", c);
    }, w = (c) => {
      n("partnerUser-click", c);
    }, b = (c) => {
      const h = "inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-medium";
      switch (c) {
        case "모집예정":
          return `${h} bg-[#EFEBFB]`;
        case "모집중":
      ...
      const h = "w-1.5 h-1.5 rounded-full";
      switch (c) {
        case "모집예정":
          return `${h} bg-[#6540DE]`;
        case "모집중":
      ...
      let h = "grid grid-cols-1";
      return c >= 2 && (h += " md:grid-cols-2"), c >= 3 && (h += " lg:grid-cols-3"), c >= 4 && (h += " xl:grid-cols-4"), c >= 5 && (h += " 2xl:grid-cols-5"), c >= 6 && (h += " 2xl:grid-cols-6"), `${h} gap-8`;
    });
    return (c, h) => (o(), s("div", x2, [
      l("div", {
        class: H(I.value)
      }, [
        c.loading ? (o(), s(Z, { key: 0 }, F(6, (g) => R(n1, {
          key: g,
          type: "user"
        })), 64)) : (o(!0), s(Z, { key: 1 }, F(k.value, (g) => (o(), s("div", {
          ...
          l("div", L2, [
            p(g) ? (o(), s("img", {
              ...
              src: g.thumbImgUrl,
              alt: g.marketName,
              onError: (S) => _(g.collaborationId),
              class: "w-full h-full object-cover"
            }, null, 40, M2)) : (o(), s("div", H2, h[0] || (h[0] = [
              l("div", { class: "w-8 h-8 bg-gray-300 rounded flex items-center justify-center" }, [
                l("svg", {
                  class: "w-4 h-4 text-gray-500",
                  fill: "currentColor",
          ...
          l("div", B2, [
            g.statusMessage ? (o(), s("div", V2, [
              l("div", {
                class: H([b(g.statusMessage), "text-[#303040]"])
              }, [
                l("div", {
                  class: H(m(g.statusMessage))
                }, null, 2),
                N(" " + M(g.statusMessage), 1)
              ], 2)
            ])) : L("", !0),
            l("h3", Z2, M(g.marketName), 1),
            g.description ? (o(), s("p", A2, M(g.description), 1)) : L("", !0),
            g.period ? (o(), s("p", S2, M(g.period), 1)) : L("", !0),
            g.hashtags ? (o(), s("p", F2, M(g.hashtags), 1)) : L("", !0),
            g.partnerUsersData && g.partnerUsersData.length > 0 ? (o(), s("div", P2, [
              (o(!0), s(Z, null, F(g.partnerUsersData, (S) => (o(), s("div", {
                key: S.id,
                ...
                onClick: o1((Y) => w(S), ["stop"])
              }, [
                l("div", N2, [
                  S.profileImgUrl ? (o(), s("img", {
                    key: 0,
                    src: S.profileImgUrl,
                    alt: S.nickName,
                    class: "w-full h-full object-cover"
                  }, null, 8, D2)) : (o(), s("div", j2, h[1] || (h[1] = [
                    l("svg", {
...
}), z2 = /* @__PURE__ */ j(U2, [["__scopeId", "data-v-b25940ab"]]), O2 = { class: "w-full" }, X2 = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, R2 = ["onClick"], W2 = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
  ...
  setup(r, { emit: e }) {
    const t = r, n = e, v = $(t.modelValue), A = (k) => {
      v.value = k.id, n("update:modelValue", k.id), n("tab-change", k);
    }, B = (k) => {
      const C = v.value === k.id, w = "flex items-center justify-center focus:outline-none hover:border-[#F66D96] border-1";
      return C ? `${w} bg-[#FFE8F0] border-[#F66D96] border-2` : `${w} bg-white border-[#CFD3DA] border-2`;
    }, P = (k) => {
      const C = v.value === k.id, w = "text-sm font-bold text-center whitespace-nowrap";
      return C ? `${w} text-[#F66D96]` : `${w} text-[#424855]`;
    };
    return z(
      () => t.modelValue,
      (k) => {
      ...
      l("div", X2, [
        (o(!0), s(Z, null, F(r.tabs, (w) => (o(), s("button", {
          key: w.id,
          class: H(B(w)),
          onClick: (b) => A(w),
          type: "button"
...
}, Y2 = /* @__PURE__ */ j(W2, [["__scopeId", "data-v-497d3204"]]), G2 = /* @__PURE__ */ a({
  __name: "ElementIcon",
  props: {
    elementIcon: {},
    color: {}
  ...
  setup(r) {
    return (e, t) => e.elementIcon === "IcApp" ? (o(), d(u(r1), {
      key: 0,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChart" ? (o(), d(u(i1), {
      key: 1,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPerson" ? (o(), d(u(p1), {
      key: 2,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcOption" ? (o(), d(u(u1), {
      key: 3,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcHelp" ? (o(), d(u(a1), {
      key: 4,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcInfo" ? (o(), d(u(c1), {
      key: 5,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcNotification" ? (o(), d(u(d1), {
      key: 6,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPayback" ? (o(), d(u(C1), {
      key: 7,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlane" ? (o(), d(u(h1), {
      key: 8,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSetting" ? (o(), d(u(v1), {
      key: 9,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcUpdate" ? (o(), d(u(f1), {
      key: 10,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMedia" ? (o(), d(u(_1), {
      key: 11,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLink" ? (o(), d(u(g1), {
      key: 12,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcArrowRight" ? (o(), d(u(W), {
      key: 13,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDown" ? (o(), d(u(m1), {
      key: 14,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCopy" ? (o(), d(u(w1), {
      key: 15,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDelete" ? (o(), d(u(y1), {
      key: 16,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlus" ? (o(), d(u($1), {
      key: 17,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMoreVertical" ? (o(), d(u(k1), {
      key: 18,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCancleFill" ? (o(), d(u(b1), {
      key: 19,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChecked" ? (o(), d(u(x1), {
      key: 20,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSparkle" ? (o(), d(u(I1), {
      key: 21,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPreview" ? (o(), d(u(L1), {
      key: 22,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLoadingPrimary" ? (o(), d(u(B1), {
      key: 23,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLayer" ? (o(), d(u(V1), {
      key: 24,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCta" ? (o(), d(u(Z1), {
      key: 25,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSearch" ? (o(), d(u(M1), {
      key: 26,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcClose" ? (o(), d(u(H1), {
      key: 27,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreUser" ? (o(), d(u(f9), {
      key: 28,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (o(), d(u(y9), {
      key: 29,
      color: e.color
    }, null, 8, ["color"])) : L("", !0);
  }
}), q2 = /* @__PURE__ */ j(G2, [["__scopeId", "data-v-a9ae99e0"]]), K2 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, J2 = ["fill"], r1 = /* @__PURE__ */ a({
  __name: "IcApp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", K2, [
      l("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, e3 = ["fill"], i1 = /* @__PURE__ */ a({
  __name: "IcChart",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", Q2, [
      l("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, I3 = { id: "Group 395" }, L3 = ["fill"], M3 = ["fill"], w1 = /* @__PURE__ */ a({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, F3 = ["fill"], P3 = ["fill"], E3 = ["fill"], k1 = /* @__PURE__ */ a({
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, J3 = { "clip-path": "url(#clip0_3951_314363)" }, Q3 = ["fill"], e9 = ["fill"], l9 = ["fill"], o9 = ["fill"], t9 = ["fill"], s9 = ["fill"], n9 = ["fill"], r9 = ["fill"], i9 = /* @__PURE__ */ a({
  __name: "IcLoadingPrimary",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(r) {
    return (e, t) => (o(), s("div", q3, [
      (o(), s("svg", K3, [
        l("g", J3, [
          l("path", {
...
}), B1 = /* @__PURE__ */ j(i9, [["__scopeId", "data-v-9156a366"]]), a9 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, c9 = ["fill"], V1 = /* @__PURE__ */ a({
  __name: "IcLayer",
  props: {
    color: { default: () => "#060608" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", a9, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, u9 = ["fill"], Z1 = /* @__PURE__ */ a({
  __name: "IcCta",
  props: {
    color: { default: () => "#716497" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", d9, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, p9 = ["stroke"], h9 = ["stroke"], f9 = /* @__PURE__ */ a({
  __name: "IcCoreUser",
  props: {
    color: { default: () => "#303040" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", C9, [
      l("path", {
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, _9 = { "clip-path": "url(#clip0_1979_140961)" }, g9 = ["stroke"], m9 = ["stroke"], w9 = ["stroke"], y9 = /* @__PURE__ */ a({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
...
const k9 = {
  ...
  TabGroup: Y2,
  Swiper: s1
}, A1 = $9(k9), { AdminCreateCards: L9, UserCreateCards: M9, TabGroup: H9, Swiper: B9 } = A1, l1 = [
  ...Object.values(A1),
  q2,
  r1,
  i1,
