...
const K1 = {
  ...
  setup(r, { expose: e, emit: t }) {
    const n = r, _ = t, E = $(null), B = $(null), T = $(null), k = $(null), u = $(n.initialSlide), w = $(!1), b = $(!1), Z = $({ x: 0, y: 0 }), h = $({ x: 0, y: 0 }), m = $(0), p = $(null), I = x(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), C = x(() => Math.floor(u.value / n.slidesPerView)), v = x(() => {
      ...
      const i = -(u.value * (j.value + n.spaceBetween)) + m.value;
      return {
        display: "flex",
      ...
      y !== u.value && (w.value = !0, _("transitionStart", { index: y }), u.value = y, setTimeout(() => {
        w.value = !1, _("transitionEnd", { index: y }), _("slideChange", { index: y, item: n.items[y] }), y === 0 && _("reachBeginning"), y === I.value && _("reachEnd");
      }, f));
    }, D = () => {
      ...
      m.value = f, _("touchMove", i);
    }, X = (i) => {
      if (!b.value) return;
      const f = h.value.x - Z.value.x;
      Math.abs(f) > n.threshold && (f > 0 ? G() : D()), b.value = !1, m.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", X), _("touchEnd", i);
    }, G1 = (i) => {
      ...
      m.value = y, _("touchMove", i);
    }, O1 = (i) => {
      if (!b.value) return;
      const f = h.value.x - Z.value.x;
      Math.abs(f) > n.threshold && (f > 0 ? G() : D()), b.value = !1, m.value = 0, _("touchEnd", i);
    }, Y = () => {
    ...
    return j1(() => {
      ...
      i.showPagination ? (o(), s("div", {
        ...
        (o(!0), s(N, null, S(v.value, (y, V) => (o(), s("button", {
          key: V,
          onClick: (b9) => F(V * i.slidesPerView),
...
}, g2 = { class: "w-full py-6 px-5 mt-auto" }, m2 = ["onClick"], w2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, y2 = ["src", "alt"], I2 = {
  key: 1,
    ...
    return (h, m) => (o(), s("div", s2, [
      h.loading ? (o(), s(N, { key: 0 }, S(6, (p) => K(n1, {
        ...
        l("div", n2, [
          ...
          m[3] || (m[3] = l("div", { class: "border-t border-gray-200" }, null, -1)),
          l("div", g2, [
            m[2] || (m[2] = l("h3", { class: "text-left font-pretendard text-[15px] font-bold leading-[22px] mb-2 text-[#303040]" }, " 참여작가 ", -1)),
  ...
  setup(r, { emit: e }) {
    const t = r, n = e, _ = $(t.modelValue), E = (k) => {
      ...
      const u = _.value === k.id, w = "flex items-center justify-center focus:outline-none hover:border-[#F66D96] border-1";
      return u ? `${w} bg-[#FFE8F0] border-[#F66D96] border-2` : `${w} bg-white border-[#CFD3DA] border-2`;
    }, T = (k) => {
      const u = _.value === k.id, w = "text-sm font-bold text-center whitespace-nowrap";
      return u ? `${w} text-[#F66D96]` : `${w} text-[#424855]`;
    };
    return O(
      () => t.modelValue,
      (k) => {
      ...
      l("div", j2, [
        (o(!0), s(N, null, S(r.tabs, (w) => (o(), s("button", {
          key: w.id,
          class: H(B(w)),
          onClick: (b) => E(w),
          type: "button"
...
}, K2 = /* @__PURE__ */ P(X2, [["__scopeId", "data-v-497d3204"]]), W2 = /* @__PURE__ */ a({
  __name: "ElementIcon",
  props: {
    elementIcon: {},
    color: {}
  ...
  setup(r) {
    return (e, t) => e.elementIcon === "IcApp" ? (o(), c(d(r1), {
      ...
      key: 13,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDown" ? (o(), c(d(m1), {
      key: 14,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCopy" ? (o(), c(d(w1), {
      key: 15,
      color: e.color
      ...
      key: 27,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreUser" ? (o(), c(d(f9), {
      key: 28,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (o(), c(d(y9), {
      key: 29,
      color: e.color
    }, null, 8, ["color"])) : L("", !0);
  }
}), Y2 = /* @__PURE__ */ P(W2, [["__scopeId", "data-v-a9ae99e0"]]), q2 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, x3 = { id: "Group 395" }, L3 = ["fill"], M3 = ["fill"], w1 = /* @__PURE__ */ a({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, N3 = { id: "ic-plus" }, E3 = ["fill"], I1 = /* @__PURE__ */ a({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, A3 = ["fill"], S3 = ["fill"], T3 = ["fill"], $1 = /* @__PURE__ */ a({
...
}), B1 = /* @__PURE__ */ P(i9, [["__scopeId", "data-v-9156a366"]]), a9 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, v9 = { "clip-path": "url(#clip0_1979_140961)" }, g9 = ["stroke"], m9 = ["stroke"], w9 = ["stroke"], y9 = /* @__PURE__ */ a({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
...
const $9 = {
  ...
  TabGroup: K2,
  Swiper: s1
}, E1 = I9($9), { AdminCreateCards: L9, UserCreateCards: M9, TabGroup: H9, Swiper: B9 } = E1, l1 = [
  ...Object.values(E1),
  Y2,
  r1,
  i1,
...
typeof window < "u" && window.Vue && window.Vue.use(k9);
export {
