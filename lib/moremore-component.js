...
const X1 = {
  ...
  setup(i, { expose: e, emit: s }) {
    const n = i, v = s, A = $(null), V = $(null), S = $(null), L = $(null), d = $(n.initialSlide), g = $(!1), x = $(!1), B = $({ x: 0, y: 0 }), f = $({ x: 0, y: 0 }), _ = $(0), C = $(null), a = I(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), w = I(() => Math.floor(d.value / n.slidesPerView)), m = I(() => {
      const r = Math.ceil(n.items.length / n.slidesPerView);
      return Array.from({ length: r }, (p, y) => y);
    }), Z = I(() => (console.log("showPrevButton", n.loop, d.value, a.value), n.loop || d.value > 0)), O = I(() => (console.log("showNextButton", n.loop, d.value, a.value), n.loop || d.value < a.value)), W = I(() => V.value ? (V.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), k1 = I(() => ({
      overflow: "hidden",
      position: "relative"
    })), H1 = I(() => {
      const r = -(d.value * (W.value + n.spaceBetween)) + _.value;
      return {
        display: "flex",
        transition: g.value && !x.value ? `transform ${n.speed}ms ${n.easing}` : "none",
        transform: `translateX(${r}px)`,
        gap: `${n.spaceBetween}px`
      };
    }), M1 = I(() => {
      if (!n.items.length) return { width: "0%", left: "0%" };
      const r = d.value / a.value, p = n.slidesPerView / n.items.length * 100, y = r * (100 - p);
      return {
        width: `${p}%`,
        left: `${y}%`,
    ...
    })), B1 = (r, p) => n.keyName && r[n.keyName] ? r[n.keyName] : p, Z1 = (r) => ({}), A1 = (r) => ({
      width: `${W.value}px`,
      flexShrink: 0
    }), P = (r, p = n.speed) => {
      ...
      y !== d.value && (g.value = !0, v("transitionStart", { index: y }), d.value = y, setTimeout(() => {
        g.value = !1, v("transitionEnd", { index: y }), v("slideChange", { index: y, item: n.items[y] }), y === 0 && v("reachBeginning"), y === a.value && v("reachEnd");
      }, p));
    }, N = () => {
      n.loop && d.value === a.value ? P(0) : P(d.value + 1);
    }, D = () => {
      n.loop && d.value === 0 ? P(a.value) : P(d.value - 1);
    }, S1 = (r) => {
      n.allowTouchMove && (x.value = !0, B.value = { x: r.clientX, y: r.clientY }, f.value = { x: r.clientX, y: r.clientY }, document.addEventListener("mousemove", z), document.addEventListener("mouseup", U), v("touchStart", r));
    }, z = (r) => {
      if (!x.value) return;
      f.value = { x: r.clientX, y: r.clientY };
      const p = (f.value.x - B.value.x) * n.touchRatio;
      _.value = p, v("touchMove", r);
    }, U = (r) => {
      if (!x.value) return;
      const p = f.value.x - B.value.x;
      Math.abs(p) > n.threshold && (p > 0 ? D() : N()), x.value = !1, _.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", U), v("touchEnd", r);
    }, P1 = (r) => {
      if (!n.allowTouchMove) return;
      x.value = !0;
      const p = r.touches[0];
      B.value = { x: p.clientX, y: p.clientY }, f.value = { x: p.clientX, y: p.clientY }, v("touchStart", r);
    }, E1 = (r) => {
      if (!x.value) return;
      const p = r.touches[0];
      f.value = { x: p.clientX, y: p.clientY };
      const y = (f.value.x - B.value.x) * n.touchRatio;
      _.value = y, v("touchMove", r);
    }, F1 = (r) => {
      if (!x.value) return;
      const p = f.value.x - B.value.x;
      Math.abs(p) > n.threshold && (p > 0 ? D() : N()), x.value = !1, _.value = 0, v("touchEnd", r);
    }, Y = () => {
    ...
    return T1(() => {
      ...
      t("div", {
        ...
        t("div", {
          ...
          (l(!0), o(F, null, T(r.items, (y, M) => (l(), o("div", {
            key: B1(y, M),
            class: H(["swiper-slide", {
              "swiper-slide-active": M === d.value,
              "swiper-slide-prev": M === d.value - 1,
              "swiper-slide-next": M === d.value + 1,
              ...Z1()
            }]),
            style: X(A1())
          }, [
      ...
      r.showPagination ? (l(), o("div", {
        key: 2,
        class: H(["swiper-pagination", V1.value])
      }, [
        (l(!0), o(F, null, T(m.value, (y, M) => (l(), o("button", {
          key: M,
          onClick: (J3) => P(M * r.slidesPerView),
          class: H(["swiper-pagination-bullet", {
            "swiper-pagination-bullet-active": M === w.value
          }])
        }, [
  ...
  setup(i, { emit: e }) {
    const s = i, n = e, v = $(/* @__PURE__ */ new Set()), A = $(s.maxItems), V = I(() => s.shops.slice(0, A.value)), S = (f) => {
      n("shop-click", f);
    }, L = (f) => {
      n("participant-click", f);
    }, d = (f) => {
      ...
      v.value.add(f);
    }, B = (f) => f.image && !v.value.has(f.id);
    return (f, _) => (l(), o("div", Y1, [
      (l(!0), o(F, null, T(V.value, (C) => (l(), o("div", {
        key: C.id,
        ...
        t("div", q1, [
            ...
            t("div", K1, [
              ...
              t("div", l2, [
                t("div", t2, [
                  ...
                  C.badge ? (l(), o("div", {
                    key: 0,
                    class: H([d(C.badgeColor), "flex-shrink-0"])
                  }, [
                    t("div", {
                      class: H(g(C.badgeColor))
                    }, null, 2),
          ...
          t("div", i2, [
            ...
            C.participants && C.participants.length > 0 ? (l(), o("div", {
              key: 0,
              class: H(C.participants.length > 4 ? "px-8" : "")
            }, [
              j1(l1, {
...
}, b2 = ["onClick"], k2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, H2 = ["src", "alt"], M2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, V2 = { class: "text-xs text-[#060608] truncate" }, B2 = /* @__PURE__ */ c({
  ...
  emits: ["shop-click", "participant-click"],
  setup(i, { emit: e }) {
    const s = i, n = e, v = $(!1), A = $(null), V = $(/* @__PURE__ */ new Set()), S = $(s.maxItems), L = I(() => s.shops.slice(0, S.value)), d = (a) => {
      A.value = a, v.value = !0, n("shop-click", a);
    }, g = (a) => {
      n("participant-click", a);
    }, x = (a) => {
      ...
      V.value.add(a);
    }, _ = (a) => a.image && !V.value.has(a.id), C = I(() => {
      const a = s.itemsPerRow;
      ...
      t("div", {
        ...
        (l(!0), o(F, null, T(L.value, (m) => (l(), o("div", {
          ...
          t("div", g2, [
            m.badge ? (l(), o("div", m2, [
              t("div", {
                class: H([x(m.badgeColor), "text-[#303040]"])
              }, [
                t("div", {
                  class: H(B(m.badgeColor))
                }, null, 2),
                E(" " + k(m.badge), 1)
              ], 2)
            ])) : b("", !0),
...
}), Z2 = /* @__PURE__ */ j(B2, [["__scopeId", "data-v-d3412538"]]), A2 = { class: "w-full" }, S2 = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, P2 = ["onClick"], E2 = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
  ...
  setup(i, { emit: e }) {
    const s = i, n = e, v = $(s.modelValue), A = (L) => {
      v.value = L.id, n("update:modelValue", L.id), n("tab-change", L);
    }, V = (L) => {
  ...
  setup(i) {
    return (e, s) => e.elementIcon === "IcApp" ? (l(), u(h(t1), {
      key: 0,
      color: e.color
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, H3 = ["fill"], m1 = /* @__PURE__ */ c({
  __name: "IcCancleFill",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(i) {
    return (e, s) => (l(), o("svg", k3, [
      t("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, F3 = { "clip-path": "url(#clip0_3951_314363)" }, T3 = ["fill"], N3 = ["fill"], j3 = ["fill"], D3 = ["fill"], X3 = ["fill"], z3 = ["fill"], U3 = ["fill"], R3 = ["fill"], O3 = /* @__PURE__ */ c({
  __name: "IcLoadingPrimary",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(i) {
    return (e, s) => (l(), o("div", P3, [
      (l(), o("svg", E3, [
        t("g", F3, [
          t("path", {
...
}), x1 = /* @__PURE__ */ j(O3, [["__scopeId", "data-v-9156a366"]]), W3 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, Y3 = ["fill"], I1 = /* @__PURE__ */ c({
  __name: "IcLayer",
  props: {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, G3 = ["fill"], b1 = /* @__PURE__ */ c({
  __name: "IcCta",
  props: {
    color: { default: () => "#716497" }
  },
  setup(i) {
    return (e, s) => (l(), o("svg", q3, [
      t("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  install(i, e = {}) {
    K.forEach((s) => {
      const n = s.__name || s.name || "UnnamedComponent";
      i.component(n, s);
    }), e.prefix && K.forEach((s) => {
      const n = s.__name || s.name || "UnnamedComponent";
      i.component(`${e.prefix}${n}`, s);
    });
  }
};
typeof window < "u" && window.Vue && window.Vue.use(K3);
export {
