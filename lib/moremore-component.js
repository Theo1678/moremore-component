import { defineComponent as a, createElementBlock as s, openBlock as o, createElementVNode as l, ref as $, computed as L, onMounted as j1, onUnmounted as z1, watch as O, createBlock as c, createCommentVNode as x, normalizeClass as H, normalizeStyle as U, Fragment as N, renderList as S, renderSlot as J, createTextVNode as D, toDisplayString as M, createStaticVNode as Q, createVNode as K, withCtx as X1, withModifiers as o1, resolveComponent as K1, unref as d, h as e1 } from "vue";
const W1 = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
  ...
  setup(r, { expose: e, emit: t }) {
    const n = r, _ = t, E = $(null), B = $(null), F = $(null), k = $(null), u = $(n.initialSlide), g = $(!1), b = $(!1), Z = $({ x: 0, y: 0 }), h = $({ x: 0, y: 0 }), w = $(0), p = $(null), I = L(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), C = L(() => Math.floor(u.value / n.slidesPerView)), v = L(() => {
      const i = Math.ceil(n.items.length / n.slidesPerView);
      return Array.from({ length: i }, (f, y) => y);
    }), m = L(() => (console.log("showPrevButton", n.loop, u.value, I.value), n.loop || u.value > 0)), A = L(() => (console.log("showNextButton", n.loop, u.value, I.value), n.loop || u.value < I.value)), j = L(() => B.value ? (B.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), Z1 = L(() => ({
      overflow: "hidden",
      position: "relative"
    })), A1 = L(() => {
      const i = -(u.value * (j.value + n.spaceBetween)) + w.value;
      return {
        display: "flex",
        transition: g.value && !b.value ? `transform ${n.speed}ms ${n.easing}` : "none",
        transform: `translateX(${i}px)`,
        gap: `${n.spaceBetween}px`
      };
    }), S1 = L(() => {
      if (!n.items.length) return { width: "0%", left: "0%" };
      const i = u.value / I.value, f = n.slidesPerView / n.items.length * 100, y = i * (100 - f);
      return {
        width: `${f}%`,
        left: `${y}%`,
        transition: g.value ? `all ${n.speed}ms ${n.easing}` : "none"
      };
    }), F1 = L(() => ({
      "swiper-pagination-horizontal": !0,
      "swiper-pagination-bullets": !0
    })), T1 = (i, f) => n.keyName && i[n.keyName] ? i[n.keyName] : f, D1 = (i) => ({}), G1 = (i) => ({
      width: `${j.value}px`,
      flexShrink: 0
    }), T = (i, f = n.speed) => {
      if (g.value && !b.value) return;
      const y = Math.max(0, Math.min(i, I.value));
      y !== u.value && (g.value = !0, _("transitionStart", { index: y }), u.value = y, setTimeout(() => {
        g.value = !1, _("transitionEnd", { index: y }), _("slideChange", { index: y, item: n.items[y] }), y === 0 && _("reachBeginning"), y === I.value && _("reachEnd");
      }, f));
    }, G = () => {
      n.loop && u.value === I.value ? T(0) : T(u.value + 1);
    }, P = () => {
      n.loop && u.value === 0 ? T(I.value) : T(u.value - 1);
    }, R1 = (i) => {
      n.allowTouchMove && (b.value = !0, Z.value = { x: i.clientX, y: i.clientY }, h.value = { x: i.clientX, y: i.clientY }, document.addEventListener("mousemove", z), document.addEventListener("mouseup", X), _("touchStart", i));
    }, z = (i) => {
      if (!b.value) return;
      h.value = { x: i.clientX, y: i.clientY };
      const f = (h.value.x - Z.value.x) * n.touchRatio;
      w.value = f, _("touchMove", i);
    }, X = (i) => {
      if (!b.value) return;
      const f = h.value.x - Z.value.x;
      Math.abs(f) > n.threshold && (f > 0 ? P() : G()), b.value = !1, w.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", X), _("touchEnd", i);
    }, P1 = (i) => {
      if (!n.allowTouchMove) return;
      b.value = !0;
      const f = i.touches[0];
      Z.value = { x: f.clientX, y: f.clientY }, h.value = { x: f.clientX, y: f.clientY }, _("touchStart", i);
    }, U1 = (i) => {
      if (!b.value) return;
      const f = i.touches[0];
      h.value = { x: f.clientX, y: f.clientY };
      const y = (h.value.x - Z.value.x) * n.touchRatio;
      w.value = y, _("touchMove", i);
    }, O1 = (i) => {
      if (!b.value) return;
      const f = h.value.x - Z.value.x;
      Math.abs(f) > n.threshold && (f > 0 ? P() : G()), b.value = !1, w.value = 0, _("touchEnd", i);
    }, Y = () => {
    ...
    return j1(() => {
      ...
      slideToNext: G,
      slideToPrev: P,
      currentIndex: L(() => u.value),
      isTransitioning: L(() => g.value)
    }), (i, f) => (o(), s("div", {
      class: "swiper-container",
      ref_key: "swiperContainer",
      ref: E
    }, [
      i.showNavigation ? (o(), c(t1, {
        key: 0,
        onClick: P,
        class: H(["swiper-button-prev", {
          "type-multiple": i.multiple,
          "swiper-button-disabled": u.value === 0,
          "swiper-button-hidden": !m.value
        }])
      }, null, 8, ["class"])) : x("", !0),
      l("div", {
        ...
        l("div", {
          ...
          (o(!0), s(N, null, S(i.items, (y, V) => (o(), s("div", {
            key: T1(y, V),
            class: H(["swiper-slide", {
              "swiper-slide-active": V === u.value,
              "swiper-slide-prev": V === u.value - 1,
              "swiper-slide-next": V === u.value + 1,
              ...D1()
            }]),
            style: U(G1())
          }, [
      ...
      i.showNavigation ? (o(), c(W, {
        key: 1,
        onClick: G,
        class: H(["swiper-button-next", {
          "type-multiple": i.multiple,
          "swiper-button-disabled": u.value === I.value,
          "swiper-button-hidden": !A.value
        }])
      }, null, 8, ["class"])) : x("", !0),
      i.showPagination ? (o(), s("div", {
        key: 2,
        class: H(["swiper-pagination", F1.value])
      }, [
        (o(!0), s(N, null, S(v.value, (y, V) => (o(), s("button", {
          key: V,
          onClick: (V9) => T(V * i.slidesPerView),
          class: H(["swiper-pagination-bullet", {
            "swiper-pagination-bullet-active": V === C.value
          }])
        }, [
          J(i.$slots, "pagination-bullet", {
            ...
            f[0] || (f[0] = l("span", { class: "swiper-bullet-dot" }, null, -1))
          ], !0)
        ], 10, Q1))), 128))
      ], 2)) : x("", !0),
      i.showScrollbar ? (o(), s("div", {
        key: 3,
  ...
  for (const [n, _] of e)
    t[n] = _;
  return t;
}, s1 = /* @__PURE__ */ R(e2, [["__scopeId", "data-v-6ed75995"]]), l2 = { class: "w-full py-6 px-5" }, o2 = { class: "flex gap-2" }, t2 = { class: "p-3" }, s2 = { class: "flex gap-2" }, n1 = /* @__PURE__ */ a({
  __name: "CardSkeleton",
  props: {
    type: { default: "user" }
  },
  setup(r) {
    return (e, t) => (o(), s("div", {
      ...
      e.type === "admin" ? (o(), s(N, { key: 0 }, [
        t[2] || (t[2] = Q('<div class="px-3 py-[20px] md:py-[26px]"><div class="flex items-center gap-4"><div class="w-24 h-24 rounded-full bg-gray-200 flex-shrink-0"></div><div class="flex-1"><div class="flex items-center justify-between gap-3 mb-2"><div class="h-[22px] bg-gray-200 rounded w-3/4"></div><div class="h-[22px] bg-gray-200 rounded w-[80px]"></div></div><div class="space-y-2 mt-4"><div class="h-[22px] bg-gray-200 rounded w-full"></div><div class="h-[22px] bg-gray-200 rounded w-4/5"></div></div><div class="h-[20px] bg-gray-200 rounded w-1/3 mt-4"></div></div></div></div><div class="border-t border-gray-200"></div>', 2)),
        l("div", l2, [
          t[1] || (t[1] = l("div", { class: "h-[22px] bg-gray-200 rounded w-[80px] mb-4" }, null, -1)),
          l("div", o2, [
            (o(), s(N, null, S(4, (n) => l("div", {
              key: n,
              class: "flex flex-col items-center gap-2"
            }, t[0] || (t[0] = [
              l("div", { class: "w-8 h-8 rounded-full bg-gray-200" }, null, -1),
              l("div", { class: "w-16 h-4 bg-gray-200 rounded" }, null, -1)
            ]))), 64))
          ])
        ])
      ], 64)) : (o(), s(N, { key: 1 }, [
        t[4] || (t[4] = l("div", { class: "aspect-[4/3] bg-gray-200 rounded-lg" }, null, -1)),
        l("div", t2, [
          t[3] || (t[3] = Q('<div class="h-6 bg-gray-200 rounded w-[80px] mb-2"></div><div class="h-5 bg-gray-200 rounded w-3/4 mb-2"></div><div class="space-y-2 mb-3"><div class="h-4 bg-gray-200 rounded w-full"></div><div class="h-4 bg-gray-200 rounded w-5/6"></div></div><div class="h-4 bg-gray-200 rounded w-1/2 mb-3"></div><div class="h-4 bg-gray-200 rounded w-2/3 mb-3"></div>', 5)),
          l("div", s2, [
            (o(), s(N, null, S(3, (n) => l("div", {
              key: n,
...
}, C2 = { class: "flex-1 min-w-0 text-left flex flex-col justify-center" }, p2 = { class: "flex flex-nowrap items-center justify-between gap-3 mb-2" }, h2 = { class: "font-pretendard text-[17px] font-bold leading-[22px] line-clamp-2 text-[#060608]" }, f2 = {
  key: 0,
  class: "flex items-center gap-2 px-2 py-1 rounded-md flex-shrink-0"
}, _2 = { class: "text-xs font-medium text-[#303040]" }, v2 = {
  key: 0,
...
}, w2 = { class: "w-full py-6 px-5 mt-auto" }, g2 = ["onClick"], y2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, I2 = ["src", "alt"], $2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, k2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, b2 = /* @__PURE__ */ a({
  ...
  setup(r, { emit: e }) {
    const t = r, n = e, _ = $(/* @__PURE__ */ new Set()), E = $(t.maxItems);
    O(
      () => t.maxItems,
      (h) => {
        E.value = h;
    ...
    const B = L(() => t.shops.slice(0, E.value)), F = (h) => {
      n("shop-click", h);
    }, k = (h) => {
      n("partnerUser-click", h);
    }, u = (h) => {
      const w = "w-2 h-2 rounded-full";
      switch (h) {
      ...
      _.value.add(h);
    }, Z = (h) => h.thumbImgUrl && !_.value.has(h.collaborationId);
    return (h, w) => (o(), s("div", n2, [
      h.loading ? (o(), s(N, { key: 0 }, S(6, (p) => K(n1, {
        key: p,
        type: "admin"
      })), 64)) : (o(!0), s(N, { key: 1 }, S(B.value, (p) => (o(), s("div", {
            ...
            l("div", a2, [
              l("div", c2, [
                Z(p) ? (o(), s("img", {
                  ...
                  src: p.thumbImgUrl,
                  alt: p.marketName,
                  onError: (I) => b(p.collaborationId),
                  class: "w-full h-full object-cover"
                }, null, 40, d2)) : (o(), s("div", u2, w[0] || (w[0] = [
              ...
              l("div", C2, [
                l("div", p2, [
                  l("h2", h2, M(p.marketName), 1),
                  p.statusCode ? (o(), s("div", f2, [
                    l("div", {
                      class: H(u(p.statusCode))
                    }, null, 2),
                    l("span", _2, M(g(p.statusCode)), 1)
                  ])) : x("", !0)
                ]),
                p.description ? (o(), s("p", v2, M(p.description), 1)) : x("", !0),
                p.period ? (o(), s("p", m2, M(p.period), 1)) : x("", !0)
              ])
            ])
          ], 8, i2),
          w[3] || (w[3] = l("div", { class: "border-t border-gray-200" }, null, -1)),
          l("div", w2, [
            w[2] || (w[2] = l("h3", { class: "text-left font-pretendard text-[15px] font-bold leading-[22px] mb-2 text-[#303040]" }, " 참여작가 ", -1)),
            p.partnerUsersData && p.partnerUsersData.length > 0 ? (o(), s("div", {
              key: 0,
              ...
              K(s1, {
                ...
                spaceBetween: 8,
                "show-pagination": !1,
                showNavigation: p.partnerUsersData.length > 4
              }, {
                default: X1(({ item: I }) => [
                  l("div", {
                    class: "w-16 flex flex-col items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity",
                    onClick: o1((C) => k(I), ["stop"])
                  }, [
                    l("div", y2, [
                      I.profileImgUrl ? (o(), s("img", {
                        key: 0,
                        src: I.profileImgUrl,
                        alt: I.nickName,
                        class: "w-full h-full object-cover"
                      }, null, 8, I2)) : (o(), s("div", $2, w[1] || (w[1] = [
                        l("svg", {
...
}), L2 = { class: "w-full" }, x2 = ["onClick"], M2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, H2 = ["src", "alt", "onError"], B2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-2"
}, V2 = { class: "p-3 text-left" }, N2 = {
  key: 0,
  class: "mb-2"
}, E2 = { class: "text-sm font-bold text-[#060608] mb-2 line-clamp-1" }, Z2 = {
  key: 1,
...
}, T2 = ["onClick"], D2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, G2 = ["src", "alt"], R2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, P2 = { class: "text-xs text-[#060608] truncate" }, U2 = /* @__PURE__ */ a({
  ...
  emits: ["shop-click", "partnerUser-click"],
  setup(r, { emit: e }) {
    const t = r, n = e, _ = $(!1), E = $(null), B = $(/* @__PURE__ */ new Set()), F = $(t.maxItems);
    O(
      () => t.maxItems,
      (C) => {
        F.value = C;
    ...
    const k = L(() => t.shops.slice(0, F.value)), u = (C) => {
      E.value = C, _.value = !0, n("shop-click", C);
    }, g = (C) => {
      ...
      B.value.add(C);
    }, p = (C) => C.thumbImgUrl && !B.value.has(C.collaborationId), I = L(() => {
      const C = t.itemsPerRow;
    ...
    return (C, v) => (o(), s("div", L2, [
      l("div", {
        class: H(I.value)
      }, [
        C.loading ? (o(), s(N, { key: 0 }, S(6, (m) => K(n1, {
          key: m,
          type: "user"
        })), 64)) : (o(!0), s(N, { key: 1 }, S(k.value, (m) => (o(), s("div", {
          ...
          l("div", M2, [
            p(m) ? (o(), s("img", {
              ...
              src: m.thumbImgUrl,
              alt: m.marketName,
              onError: (A) => w(m.collaborationId),
              class: "w-full h-full object-cover"
            }, null, 40, H2)) : (o(), s("div", B2, v[0] || (v[0] = [
              l("div", { class: "w-8 h-8 bg-gray-300 rounded flex items-center justify-center" }, [
                l("svg", {
                  class: "w-4 h-4 text-gray-500",
                  fill: "currentColor",
          ...
          l("div", V2, [
            m.statusCode ? (o(), s("div", N2, [
              l("div", {
                class: H([b(m.statusCode), "text-[#303040]"])
              }, [
                l("div", {
                  class: H(Z(m.statusCode))
                }, null, 2),
                D(" " + M(h(m.statusCode)), 1)
              ], 2)
            ])) : x("", !0),
            l("h3", E2, M(m.marketName), 1),
            m.description ? (o(), s("p", Z2, M(m.description), 1)) : x("", !0),
            m.period ? (o(), s("p", A2, M(m.period), 1)) : x("", !0),
            m.hashtags ? (o(), s("p", S2, M(m.hashtags), 1)) : x("", !0),
            m.partnerUsersData && m.partnerUsersData.length > 0 ? (o(), s("div", F2, [
              (o(!0), s(N, null, S(m.partnerUsersData, (A) => (o(), s("div", {
                key: A.id,
                ...
                onClick: o1((j) => g(A), ["stop"])
              }, [
                l("div", D2, [
                  A.profileImgUrl ? (o(), s("img", {
                    key: 0,
                    src: A.profileImgUrl,
                    alt: A.nickName,
                    class: "w-full h-full object-cover"
                  }, null, 8, G2)) : (o(), s("div", R2, v[1] || (v[1] = [
                    l("svg", {
...
}), O2 = /* @__PURE__ */ R(U2, [["__scopeId", "data-v-1b1ac295"]]), j2 = { class: "w-full" }, z2 = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, X2 = ["onClick"], K2 = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
  ...
  setup(r, { emit: e }) {
    const t = r, n = e, _ = $(t.modelValue), E = (k) => {
      _.value = k.id, n("update:modelValue", k.id), n("tab-change", k);
    }, B = (k) => {
      const u = _.value === k.id, g = "flex items-center justify-center focus:outline-none hover:border-[#F66D96] border-1";
      return u ? `${g} bg-[#FFE8F0] border-[#F66D96] border-2` : `${g} bg-white border-[#CFD3DA] border-2`;
    }, F = (k) => {
      const u = _.value === k.id, g = "text-sm font-bold text-center whitespace-nowrap";
      return u ? `${g} text-[#F66D96]` : `${g} text-[#424855]`;
    };
    return O(
      () => t.modelValue,
      (k) => {
      ...
      l("div", z2, [
        (o(!0), s(N, null, S(r.tabs, (g) => (o(), s("button", {
          key: g.id,
          class: H(B(g)),
          onClick: (b) => E(g),
          type: "button"
...
}, W2 = /* @__PURE__ */ R(K2, [["__scopeId", "data-v-497d3204"]]), Y2 = {
  xmlns: "http://www.w3.org/2000/svg",
  width: "20",
  height: "21",
  viewBox: "0 0 20 21",
  fill: "none"
}, q2 = ["fill"], J2 = /* @__PURE__ */ a({
  __name: "IcStock",
  props: {
    color: { default: () => "#060608" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", Y2, [
      l("path", {
  ...
  setup(r) {
    return (e, t) => {
      const n = K1("IcGraphicEmpty");
      return e.elementIcon === "IcApp" ? (o(), c(d(r1), {
        key: 0,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcChart" ? (o(), c(d(i1), {
        key: 1,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcPerson" ? (o(), c(d(p1), {
        key: 2,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcOption" ? (o(), c(d(u1), {
        key: 3,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcHelp" ? (o(), c(d(a1), {
        key: 4,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcInfo" ? (o(), c(d(c1), {
        key: 5,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcNotification" ? (o(), c(d(d1), {
        key: 6,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcPayback" ? (o(), c(d(C1), {
        key: 7,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcPlane" ? (o(), c(d(h1), {
        key: 8,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcSetting" ? (o(), c(d(_1), {
        key: 9,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcUpdate" ? (o(), c(d(f1), {
        key: 10,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcMedia" ? (o(), c(d(v1), {
        key: 11,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcLink" ? (o(), c(d(m1), {
        key: 12,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcArrowRight" ? (o(), c(d(W), {
        key: 13,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcDown" ? (o(), c(d(w1), {
        key: 14,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcGraphicEmpty" ? (o(), c(n, {
        key: 15,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcCopy" ? (o(), c(d(g1), {
        key: 16,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcDelete" ? (o(), c(d(y1), {
        key: 17,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcPlus" ? (o(), c(d(I1), {
        key: 18,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcMoreVertical" ? (o(), c(d($1), {
        key: 19,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcCancleFill" ? (o(), c(d(k1), {
        key: 20,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcChecked" ? (o(), c(d(b1), {
        key: 21,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcSparkle" ? (o(), c(d(L1), {
        key: 22,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcStock" ? (o(), c(J2, {
        key: 23,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcPreview" ? (o(), c(d(x1), {
        key: 24,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcLoadingPrimary" ? (o(), c(d(B1), {
        key: 25,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcLayer" ? (o(), c(d(V1), {
        key: 26,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcCta" ? (o(), c(d(N1), {
        key: 27,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcSearch" ? (o(), c(d(M1), {
        key: 28,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcClose" ? (o(), c(d(H1), {
        key: 29,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcCoreUser" ? (o(), c(d(y9), {
        key: 30,
        color: e.color
      }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (o(), c(d(x9), {
        key: 31,
        color: e.color
      }, null, 8, ["color"])) : x("", !0);
    };
  }
}), e3 = /* @__PURE__ */ R(Q2, [["__scopeId", "data-v-bd17bdc7"]]), l3 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, o3 = ["fill"], r1 = /* @__PURE__ */ a({
  __name: "IcApp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", l3, [
      l("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, s3 = ["fill"], i1 = /* @__PURE__ */ a({
  __name: "IcChart",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", t3, [
      l("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, r3 = ["fill"], a1 = /* @__PURE__ */ a({
  __name: "IcHelp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", n3, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, a3 = ["fill"], c1 = /* @__PURE__ */ a({
  __name: "IcInfo",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", i3, [
      t[0] || (t[0] = l("circle", {
        cx: "12",
        cy: "11.9922",
        r: "6",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, d3 = ["fill"], d1 = /* @__PURE__ */ a({
  __name: "IcNotification",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", c3, [
      l("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, C3 = ["fill"], u1 = /* @__PURE__ */ a({
  __name: "IcOption",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", u3, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, h3 = ["fill"], C1 = /* @__PURE__ */ a({
  __name: "IcPayback",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", p3, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, _3 = ["fill"], p1 = /* @__PURE__ */ a({
  __name: "IcPerson",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", f3, [
      l("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, g3 = ["fill"], f1 = /* @__PURE__ */ a({
  __name: "IcUpdate",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", w3, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, I3 = ["fill"], _1 = /* @__PURE__ */ a({
  __name: "IcSetting",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", y3, [
      l("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, k3 = ["fill"], v1 = /* @__PURE__ */ a({
  __name: "IcMedia",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", $3, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, L3 = ["fill"], m1 = /* @__PURE__ */ a({
  __name: "IcLink",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", b3, [
      l("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, M3 = ["fill"], w1 = /* @__PURE__ */ a({
  __name: "IcDown",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", x3, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, N3 = { id: "Group 395" }, E3 = ["fill"], Z3 = ["fill"], g1 = /* @__PURE__ */ a({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, S3 = ["fill"], y1 = /* @__PURE__ */ a({
  __name: "IcDelete",
  props: {
    color: { default: () => "#FF4136" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", A3, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, T3 = { id: "ic-plus" }, D3 = ["fill"], I1 = /* @__PURE__ */ a({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, R3 = ["fill"], P3 = ["fill"], U3 = ["fill"], $1 = /* @__PURE__ */ a({
  __name: "IcMoreVertical",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", G3, [
      l("ellipse", {
        cx: "10",
        cy: "15.8333",
        rx: "1.25",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, j3 = ["fill"], k1 = /* @__PURE__ */ a({
  __name: "IcCancleFill",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", O3, [
      l("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, X3 = ["fill"], b1 = /* @__PURE__ */ a({
  __name: "IcChecked",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", z3, [
      l("circle", {
        cx: "8",
        cy: "8",
        r: "8",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, W3 = ["fill"], L1 = /* @__PURE__ */ a({
  __name: "IcSparkle",
  props: {
    color: { default: () => "#0080FF" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", K3, [
      l("path", {
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, Q3 = ["fill"], M1 = /* @__PURE__ */ a({
  __name: "IcSearch",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", J3, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, l9 = ["fill"], H1 = /* @__PURE__ */ a({
  __name: "IcClose",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", e9, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, s9 = { "clip-path": "url(#clip0_3951_314363)" }, n9 = ["fill"], r9 = ["fill"], i9 = ["fill"], a9 = ["fill"], c9 = ["fill"], d9 = ["fill"], u9 = ["fill"], C9 = ["fill"], p9 = /* @__PURE__ */ a({
  __name: "IcLoadingPrimary",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(r) {
    return (e, t) => (o(), s("div", o9, [
      (o(), s("svg", t9, [
        l("g", s9, [
          l("path", {
        ...
        t[0] || (t[0] = l("defs", null, [
          l("clipPath", { id: "clip0_3951_314363" }, [
            l("rect", {
              width: "20",
              height: "20",
              fill: "white"
...
}), B1 = /* @__PURE__ */ R(p9, [["__scopeId", "data-v-9156a366"]]), h9 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, f9 = ["fill"], V1 = /* @__PURE__ */ a({
  __name: "IcLayer",
  props: {
    color: { default: () => "#060608" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", h9, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, v9 = ["fill"], N1 = /* @__PURE__ */ a({
  __name: "IcCta",
  props: {
    color: { default: () => "#716497" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", _9, [
      l("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, w9 = ["stroke"], g9 = ["stroke"], y9 = /* @__PURE__ */ a({
  __name: "IcCoreUser",
  props: {
    color: { default: () => "#303040" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", m9, [
      l("path", {
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, $9 = { "clip-path": "url(#clip0_1979_140961)" }, k9 = ["stroke"], b9 = ["stroke"], L9 = ["stroke"], x9 = /* @__PURE__ */ a({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
  setup(r) {
    return (e, t) => (o(), s("svg", I9, [
      l("g", $9, [
        l("path", {
      ...
      t[0] || (t[0] = l("defs", null, [
        l("clipPath", { id: "clip0_1979_140961" }, [
          l("rect", {
            width: "22",
            height: "22",
            fill: "white"
...
const H9 = {
  ...
  TabGroup: W2,
  Swiper: s1
}, E1 = M9(H9), { AdminCreateCards: E9, UserCreateCards: Z9, TabGroup: A9, Swiper: S9 } = E1, l1 = [
  ...Object.values(E1),
  e3,
  r1,
  i1,
  ...
  install(r, e = {}) {
    l1.forEach((t) => {
      ...
      r.component(n, t);
    }), e.prefix && l1.forEach((t) => {
      const n = t.name || "UnnamedComponent";
      r.component(`${e.prefix}${n}`, t);
    });
  }
};
typeof window < "u" && window.Vue && window.Vue.use(B9);
export {
  E9 as AdminCreateCards,
  e3 as ElementIcon,
  r1 as IcApp,
  t1 as IcArrowLeft,
  W as IcArrowRight,
  ...
  y1 as IcDelete,
  w1 as IcDown,
  B3 as IcGraphicEmpty,
  a1 as IcHelp,
  c1 as IcInfo,
  V1 as IcLayer,
  m1 as IcLink,
  B1 as IcLoadingPrimary,
  v1 as IcMedia,
  $1 as IcMoreVertical,
