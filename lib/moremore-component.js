import { defineComponent as u, createElementBlock as s, openBlock as l, createElementVNode as o, computed as L, ref as b, onMounted as J1, onUnmounted as Q1, watch as j, createBlock as C, createCommentVNode as E, normalizeClass as x, normalizeStyle as U, Fragment as B, renderList as N, renderSlot as o1, createStaticVNode as t1, createVNode as q, createTextVNode as R, toDisplayString as H, withModifiers as Y, withCtx as n1, unref as p, h as s1 } from "vue";
const e2 = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, t2 = ["fill"], J = /* @__PURE__ */ u({
  __name: "IcArrowRight",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", o2, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  setup(i, { expose: e, emit: t }) {
    const n = i, $ = L(() => {
      var r;
      return ((r = n.items) == null ? void 0 : r.filter(Boolean)) || [];
    }), y = t, Z = b(null), A = b(null), F = b(null), T = b(null), v = b(n.initialSlide), _ = b(!1), m = b(!1), a = b({ x: 0, y: 0 }), c = b({ x: 0, y: 0 }), h = b(0), I = b(null), V = L(() => {
      var r, d;
      return n.loop ? ((r = $.value) == null ? void 0 : r.length) - 1 : Math.max(0, ((d = $.value) == null ? void 0 : d.length) - n.slidesPerView);
    }), f = L(() => Math.floor(v.value / n.slidesPerView)), w = L(() => {
      var d;
      const r = Math.ceil(((d = $.value) == null ? void 0 : d.length) / n.slidesPerView);
      return Array.from({ length: r }, (k, M) => M);
    }), g = L(() => (console.log("showPrevButton", n.loop, v.value, V.value), n.loop || v.value > 0)), S = L(() => (console.log("showNextButton", n.loop, v.value, V.value), n.loop || v.value < V.value)), z = L(() => A.value ? (A.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), R1 = L(() => ({
      overflow: "hidden",
      position: "relative"
    })), G1 = L(() => {
      const r = -(v.value * (z.value + n.spaceBetween)) + h.value;
      return {
        display: "flex",
        transition: _.value && !m.value ? `transform ${n.speed}ms ${n.easing}` : "none",
        transform: `translateX(${r}px)`,
        gap: `${n.spaceBetween}px`
      };
    }), U1 = L(() => {
      var M, W;
      if (!((M = $.value) != null && M.length)) return { width: "0%", left: "0%" };
      const r = v.value / V.value, d = n.slidesPerView / ((W = $.value) == null ? void 0 : W.length) * 100, k = r * (100 - d);
      return {
        width: `${d}%`,
        left: `${k}%`,
        transition: _.value ? `all ${n.speed}ms ${n.easing}` : "none"
      };
    }), j1 = L(() => ({
      "swiper-pagination-horizontal": !0,
      "swiper-pagination-bullets": !0
    })), O1 = (r, d) => n.keyName && r[n.keyName] ? r[n.keyName] : d, z1 = (r) => ({}), X1 = (r) => ({
      width: `${z.value}px`,
      flexShrink: 0
    }), P = (r, d = n.speed) => {
      try {
        if (_.value && !m.value) return;
        const k = Math.max(0, Math.min(r, V.value));
        if (k === v.value) return;
        _.value = !0, y("transitionStart", { index: k }), v.value = k, setTimeout(() => {
          _.value = !1, y("transitionEnd", { index: k }), y("slideChange", {
            index: k,
            item: $.value[k]
          }), k === 0 && y("reachBeginning"), k === V.value && y("reachEnd");
        }, d);
      } catch (k) {
        console.error("Error in slideTo method:", k);
      }
    }, D = () => {
      try {
        n.loop && v.value === V.value ? P(0) : P(v.value + 1);
      } catch (r) {
        console.error("Error in slideToNext method:", r);
      }
    }, G = () => {
      try {
        n.loop && v.value === 0 ? P(V.value) : P(v.value - 1);
      } catch (r) {
        console.error("Error in slideToPrev method:", r);
      }
    }, K1 = (r) => {
      try {
        if (!n.allowTouchMove) return;
        m.value = !0, a.value = { x: r.clientX, y: r.clientY }, c.value = { x: r.clientX, y: r.clientY }, document.addEventListener("mousemove", X), document.addEventListener("mouseup", K), y("touchStart", r);
      } catch (d) {
        console.error("Error in handleMouseDown method:", d);
      }
    }, X = (r) => {
      try {
        if (!m.value) return;
        c.value = { x: r.clientX, y: r.clientY };
        const d = (c.value.x - a.value.x) * n.touchRatio;
        h.value = d, y("touchMove", r);
      } catch (d) {
        console.error("Error in handleMouseMove method:", d);
      }
    }, K = (r) => {
      try {
        if (!m.value) return;
        const d = c.value.x - a.value.x;
        Math.abs(d) > n.threshold && (d > 0 ? G() : D()), m.value = !1, h.value = 0, document.removeEventListener("mousemove", X), document.removeEventListener("mouseup", K), y("touchEnd", r);
      } catch (d) {
        console.error("Error in handleMouseUp method:", d);
      }
    }, W1 = (r) => {
      try {
        if (!n.allowTouchMove) return;
        m.value = !0;
        const d = r.touches[0];
        a.value = { x: d.clientX, y: d.clientY }, c.value = { x: d.clientX, y: d.clientY }, y("touchStart", r);
      } catch (d) {
        console.error("Error in handleTouchStart method:", d);
      }
    }, Y1 = (r) => {
      try {
        if (!m.value) return;
        const d = r.touches[0];
        c.value = { x: d.clientX, y: d.clientY };
        const k = (c.value.x - a.value.x) * n.touchRatio;
        h.value = k, y("touchMove", r);
      } catch (d) {
        console.error("Error in handleTouchMove method:", d);
      }
    }, q1 = (r) => {
      try {
        if (!m.value) return;
        const d = c.value.x - a.value.x;
        Math.abs(d) > n.threshold && (d > 0 ? G() : D()), m.value = !1, h.value = 0, y("touchEnd", r);
      } catch (d) {
        console.error("Error in handleTouchEnd method:", d);
      }
    }, e1 = () => {
      try {
        if (!n.autoplay) return;
        const r = typeof n.autoplay == "object" && n.autoplay.delay || 3e3;
        I.value = setInterval(() => {
          D();
        }, r);
      } catch (r) {
        console.error("Error in startAutoplay method:", r);
      }
    }, l1 = () => {
      try {
        I.value && (clearInterval(I.value), I.value = null);
      } catch (r) {
        console.error("Error in stopAutoplay method:", r);
      }
    };
    return J1(() => {
      n.autoplay && e1();
    }), Q1(() => {
      l1(), document.removeEventListener("mousemove", X), document.removeEventListener("mouseup", K);
    }), j(
      () => n.autoplay,
      (r) => {
        r ? e1() : l1();
      ...
      slideToNext: D,
      slideToPrev: G,
      currentIndex: L(() => v.value),
      isTransitioning: L(() => _.value)
    }), (r, d) => (l(), s("div", {
      class: "swiper-container",
      ref_key: "swiperContainer",
      ref: Z
    }, [
      r.showNavigation ? (l(), C(i1, {
        key: 0,
        onClick: G,
        class: x(["swiper-button-prev", {
          "type-multiple": r.multiple,
          "swiper-button-disabled": v.value === 0,
          "swiper-button-hidden": !g.value
        }])
      }, null, 8, ["class"])) : E("", !0),
      o("div", {
        ...
        o("div", {
          ...
          (l(!0), s(B, null, N($.value, (k, M) => (l(), s("div", {
            key: O1(k, M),
            class: x(["swiper-slide", {
              "swiper-slide-active": M === v.value,
              "swiper-slide-prev": M === v.value - 1,
              "swiper-slide-next": M === v.value + 1,
              "swiper-width-100": r.slidesPerView === 1,
              ...z1()
            }]),
            style: U(X1())
          }, [
      ...
      r.showNavigation ? (l(), C(J, {
        key: 1,
        onClick: D,
        class: x(["swiper-button-next", {
          "type-multiple": r.multiple,
          "swiper-button-disabled": v.value === V.value,
          "swiper-button-hidden": !S.value
        }])
      }, null, 8, ["class"])) : E("", !0),
      r.showPagination ? (l(), s("div", {
        key: 2,
        class: x(["swiper-pagination", j1.value])
      }, [
        (l(!0), s(B, null, N(w.value, (k, M) => (l(), s("button", {
          key: M,
          onClick: (W) => P(M * r.slidesPerView),
          class: x(["swiper-pagination-bullet", {
            "swiper-pagination-bullet-active": M === f.value
          }])
        }, [
          o1(r.$slots, "pagination-bullet", {
            index: M,
            isActive: M === f.value
          }, () => [
            d[0] || (d[0] = o("span", { class: "swiper-bullet-dot" }, null, -1))
          ], !0)
        ], 10, s2))), 128))
      ], 2)) : E("", !0),
      r.showScrollbar ? (l(), s("div", {
        key: 3,
  ...
  for (const [n, $] of e)
    t[n] = $;
  return t;
}, Q = /* @__PURE__ */ O(r2, [["__scopeId", "data-v-e6e87461"]]), n2 = { class: "w-full py-6 px-5" }, i2 = { class: "flex gap-2" }, a2 = { class: "p-3" }, c2 = { class: "flex gap-2" }, a1 = /* @__PURE__ */ u({
  __name: "CardSkeleton",
  props: {
    type: { default: "user" }
  },
  setup(i) {
    return (e, t) => (l(), s("div", {
      ...
      e.type === "admin" ? (l(), s(B, { key: 0 }, [
        t[2] || (t[2] = t1('<div class="px-3 py-[20px] md:py-[26px]"><div class="flex items-center gap-4"><div class="w-24 h-24 rounded-full bg-gray-200 flex-shrink-0"></div><div class="flex-1"><div class="flex items-center justify-between gap-3 mb-2"><div class="h-[22px] bg-gray-200 rounded w-3/4"></div><div class="h-[22px] bg-gray-200 rounded w-[80px]"></div></div><div class="space-y-2 mt-4"><div class="h-[22px] bg-gray-200 rounded w-full"></div><div class="h-[22px] bg-gray-200 rounded w-4/5"></div></div><div class="h-[20px] bg-gray-200 rounded w-1/3 mt-4"></div></div></div></div><div class="border-t border-gray-200"></div>', 2)),
        o("div", n2, [
          t[1] || (t[1] = o("div", { class: "h-[22px] bg-gray-200 rounded w-[80px] mb-4" }, null, -1)),
          o("div", i2, [
            (l(), s(B, null, N(4, (n) => o("div", {
              key: n,
        ...
        o("div", a2, [
          t[3] || (t[3] = t1('<div class="h-6 bg-gray-200 rounded w-[80px] mb-2"></div><div class="h-5 bg-gray-200 rounded w-3/4 mb-2"></div><div class="space-y-2 mb-3"><div class="h-4 bg-gray-200 rounded w-full"></div><div class="h-4 bg-gray-200 rounded w-5/6"></div></div><div class="h-4 bg-gray-200 rounded w-1/2 mb-3"></div><div class="h-4 bg-gray-200 rounded w-2/3 mb-3"></div>', 5)),
          o("div", c2, [
            (l(), s(B, null, N(3, (n) => o("div", {
              key: n,
...
}), d2 = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 !gap-8 mb-12 items-stretch" }, u2 = { class: "w-full max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 overflow-hidden h-full flex flex-col" }, C2 = ["onClick"], p2 = { class: "flex items-center gap-4 h-full" }, h2 = ["src", "alt", "onError"], f2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-1"
}, v2 = { class: "flex-1 min-w-0 text-left flex flex-col justify-center" }, _2 = { class: "font-pretendard text-[17px] font-bold leading-[22px] line-clamp-2 text-[#060608]" }, w2 = {
  key: 0,
  class: "flex items-center gap-2 px-2 py-1 rounded-md flex-shrink-0"
}, g2 = { class: "text-xs font-medium text-[#303040]" }, m2 = {
  key: 0,
...
}, I2 = { class: "w-full py-6 px-5 mt-auto" }, $2 = {
  key: 0,
  class: "flex items-center justify-center gap-2"
}, k2 = ["onClick"], x2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, L2 = ["src", "alt"], b2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, M2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, H2 = ["onClick"], B2 = { class: "w-8 h-8 rounded-full border border-gray-300 bg-gray-50 overflow-hidden" }, V2 = ["src", "alt"], E2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, N2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, Z2 = {
  key: 1,
  class: "flex items-center justify-center h-[60px]"
}, A2 = /* @__PURE__ */ u({
  ...
  setup(i, { emit: e }) {
    const t = i, n = e, $ = b(/* @__PURE__ */ new Set()), y = b(t.maxItems);
    j(
      () => t.maxItems,
      (a) => {
        y.value = a;
    ...
    const Z = L(() => t.shops.slice(0, y.value)), A = (a) => {
      n("shop-click", a);
    }, F = (a) => {
      n("partnerUser-click", a);
    }, T = (a) => {
      ...
      $.value.add(a);
    }, m = (a) => a.thumbImgUrl && !$.value.has(a.collaborationId);
    return (a, c) => (l(), s("div", d2, [
      a.loading ? (l(), s(B, { key: 0 }, N(6, (h) => q(a1, {
        key: h,
        type: "admin"
      })), 64)) : (l(!0), s(B, { key: 1 }, N(Z.value, (h) => (l(), s("div", {
        ...
        o("div", u2, [
          o("div", {
            ...
            o("div", p2, [
              o("div", {
                class: x(["rounded-full border border-gray-300 bg-gray-50 flex-shrink-0 overflow-hidden", a.isMobile ? "w-20 h-20" : "w-24 h-24"])
              }, [
                m(h) ? (l(), s("img", {
                  key: 0,
                  src: h.thumbImgUrl,
                  alt: h.marketName,
                  onError: (I) => _(h.collaborationId),
                  class: "w-full h-full object-cover"
                }, null, 40, h2)) : (l(), s("div", f2, c[0] || (c[0] = [
              ...
              o("div", v2, [
                o("div", {
                  class: x([
                    ...
                    a.isMobile ? "flex-col items-start gap-2" : "flex-row items-center gap-3"
                  ])
                }, [
                  o("h2", _2, H(h.marketName), 1),
                  h.statusCode ? (l(), s("div", w2, [
                    o("div", {
                      class: x(T(h.statusCode))
                    }, null, 2),
                    o("span", g2, H(v(h.statusCode)), 1)
                  ])) : E("", !0)
                ], 2),
                h.description ? (l(), s("p", m2, H(h.description), 1)) : E("", !0),
                h.period ? (l(), s("p", y2, H(h.period), 1)) : E("", !0)
              ])
            ])
          ], 8, C2),
          c[5] || (c[5] = o("div", { class: "border-t border-gray-200" }, null, -1)),
          o("div", I2, [
            c[4] || (c[4] = o("h3", { class: "text-left font-pretendard text-[15px] font-bold leading-[22px] mb-2 text-[#303040]" }, " 참여작가 ", -1)),
            h.partnerUsersData && h.partnerUsersData.length > 0 ? (l(), s("div", {
              key: 0,
              class: x(h.partnerUsersData.length > 4 ? "px-8" : "")
            }, [
              h.partnerUsersData.length <= 4 ? (l(), s("div", $2, [
                (l(!0), s(B, null, N(h.partnerUsersData, (I) => (l(), s("div", {
                  key: I.id || I.nickName,
                  class: "w-16 flex flex-col items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity",
                  onClick: Y((V) => F(I), ["stop"])
                }, [
                  o("div", x2, [
                    I.profileImgUrl ? (l(), s("img", {
                      key: 0,
                      src: I.profileImgUrl,
                      alt: I.nickName,
                      class: "w-full h-full object-cover"
                    }, null, 8, L2)) : (l(), s("div", b2, c[1] || (c[1] = [
                      o("svg", {
                ...
                default: n1(({ item: I }) => [
                  o("div", {
                    ...
                    o("span", N2, H(I.nickName), 1)
                  ], 8, H2)
                ]),
                _: 2
              }, 1032, ["items"]))
            ], 2)) : (l(), s("div", Z2, c[3] || (c[3] = [
              o("span", { class: "text-gray-400 text-sm" }, "참여작가가 없습니다", -1)
            ])))
          ])
        ])
      ]))), 128))
...
}), S2 = { class: "w-full" }, T2 = ["onClick"], F2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, P2 = ["src", "alt", "onError"], D2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-2"
}, R2 = { class: "p-3 text-left" }, G2 = {
  key: 0,
  class: "mb-2"
}, U2 = { class: "text-sm font-bold text-[#060608] mb-2 line-clamp-1" }, j2 = {
  key: 1,
...
}, K2 = ["onClick"], W2 = { class: "w-5 h-5 rounded-full border border-gray-300 bg-white overflow-hidden flex-shrink-0" }, Y2 = ["src", "alt"], q2 = {
  key: 1,
  class: "w-full h-full flex items-center justify-center"
}, J2 = {
  ...
  emits: ["shop-click", "partnerUser-click"],
  setup(i, { emit: e }) {
    const t = i, n = e, $ = b(!1), y = b(null), Z = b(/* @__PURE__ */ new Set()), A = b(t.maxItems);
    j(
      () => t.maxItems,
      (f) => {
        A.value = f;
    ...
    const F = L(() => t.shops.filter((f) => !f.isHide)), T = L(() => F.value.slice(0, A.value)), v = (f) => {
      y.value = f, $.value = !0, n("shop-click", f);
    }, _ = (f) => {
      n("partnerUser-click", f);
    }, m = (f) => {
      const w = "inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-medium";
      switch (f) {
        case "RECRUITING_PENDING":
          return `${w} bg-[#EFEBFB]`;
        case "RECRUITING_ONGOING":
      ...
      const w = "w-1.5 h-1.5 rounded-full";
      switch (f) {
        case "RECRUITING_PENDING":
          return `${w} bg-[#6540DE]`;
        case "RECRUITING_ONGOING":
      ...
      Z.value.add(f);
    }, I = (f) => f.thumbImgUrl && !Z.value.has(f.collaborationId), V = L(() => {
      const f = t.itemsPerRow;
      let w = "grid grid-cols-1";
      return f >= 2 && (w += " md:grid-cols-2"), f >= 3 && (w += " lg:grid-cols-3"), f >= 4 && (w += " xl:grid-cols-4"), f >= 5 && (w += " 2xl:grid-cols-5"), f >= 6 && (w += " 2xl:grid-cols-6"), `${w} gap-8`;
    });
    return (f, w) => (l(), s("div", S2, [
      o("div", {
        class: x(V.value)
      }, [
        f.loading ? (l(), s(B, { key: 0 }, N(6, (g) => q(a1, {
          key: g,
          type: "user"
        })), 64)) : (l(!0), s(B, { key: 1 }, N(T.value, (g) => (l(), s("div", {
          ...
          o("div", F2, [
            I(g) ? (l(), s("img", {
              ...
              src: g.thumbImgUrl,
              alt: g.marketName,
              onError: (S) => h(g.collaborationId),
              class: "w-full h-full object-cover"
            }, null, 40, P2)) : (l(), s("div", D2, w[0] || (w[0] = [
              o("div", { class: "w-8 h-8 bg-gray-300 rounded flex items-center justify-center" }, [
                o("svg", {
                  class: "w-4 h-4 text-gray-500",
                  fill: "currentColor",
          ...
          o("div", R2, [
            g.statusCode ? (l(), s("div", G2, [
              o("div", {
                class: x([m(g.statusCode), "text-[#303040]"])
              }, [
                o("div", {
                  class: x(a(g.statusCode))
                }, null, 2),
                R(" " + H(c(g.statusCode)), 1)
              ], 2)
            ])) : E("", !0),
            o("h3", U2, H(g.marketName), 1),
            g.description ? (l(), s("p", j2, H(g.description), 1)) : E("", !0),
            g.period ? (l(), s("p", O2, H(g.period), 1)) : E("", !0),
            g.hashtags ? (l(), s("p", z2, H(g.hashtags), 1)) : E("", !0),
            g.partnerUsersData && g.partnerUsersData.length > 0 ? (l(), s("div", X2, [
              (l(!0), s(B, null, N(g.partnerUsersData, (S) => (l(), s("div", {
                key: S.id,
...
}), e3 = /* @__PURE__ */ O(Q2, [["__scopeId", "data-v-dc4bb508"]]), l3 = { class: "w-full" }, o3 = {
  key: 0,
  class: "relative"
}, t3 = ["onClick"], s3 = {
  key: 1,
  ...
  setup(i, { emit: e }) {
    const t = i, n = e, $ = b(t.modelValue), y = (_) => {
      $.value = _.id, n("update:modelValue", _.id), n("tab-change", _);
    }, Z = (_) => {
      const m = $.value === _.id, a = "flex items-center justify-center focus:outline-none hover:border-[#F66D96] border-1 rounded-xl";
      return m ? `${a} bg-[#FFE8F0] border-[#F66D96] border-2` : `${a} bg-white border-[#CFD3DA] border-2`;
    }, A = (_) => {
      const m = $.value === _.id, c = `${t.isMobile ? "text-xs" : "text-sm"} font-bold text-center whitespace-nowrap`;
      return m ? `${c} text-[#F66D96]` : `${c} text-[#424855]`;
    }, F = L(() => {
      if (t.tabs.length <= 10) {
        const a = [];
        for (let c = 0; c < t.tabs.length; c += 5)
          a.push(t.tabs.slice(c, c + 5));
        return a;
      } else {
        const a = [];
        for (let c = 0; c < t.tabs.length; c += 8)
          a.push(t.tabs.slice(c, c + 8));
        return a;
      }
    }), T = L(() => t.tabs.length > 10), v = L(
      () => t.isMobile && t.tabs.length > (T.value ? 6 : 5)
    );
    return j(
      () => t.modelValue,
      (_) => {
      ...
      _.isMobile && v.value ? (l(), s("div", o3, [
            ...
            default: n1(({ item: a }) => [
              o("div", {
                class: x([
                  ...
                  T.value ? "grid-cols-4" : "grid-cols-5"
                ])
              }, [
                (l(!0), s(B, null, N(a, (c) => (l(), s("button", {
                  key: c.id,
                  class: x([Z(c), "px-3 py-2"]),
                  onClick: (h) => y(c),
                  type: "button"
                }, [
                  o("span", {
        ...
        m[0] || (m[0] = o("div", { class: "absolute top-0 right-0 w-8 h-full pointer-events-none" }, [
          o("div", { class: "w-full h-full bg-gradient-to-l from-white via-white/60 to-transparent" })
        ], -1))
      ])) : _.isMobile ? (l(), s("div", s3, [
        o("div", {
          class: x([
            "grid gap-2 auto-rows-fr",
            T.value ? "grid-cols-3" : "grid-cols-5"
          ])
        }, [
          (l(!0), s(B, null, N(_.tabs, (a) => (l(), s("button", {
            key: a.id,
            class: x([Z(a), "px-3 py-2"]),
            onClick: (c) => y(a),
            type: "button"
          }, [
            o("span", {
  ...
  setup(i) {
    return (e, t) => e.elementIcon === "IcApp" ? (l(), C(p(c1), {
      key: 0,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChart" ? (l(), C(p(d1), {
      key: 1,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPerson" ? (l(), C(p(v1), {
      key: 2,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcOption" ? (l(), C(p(h1), {
      key: 3,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcHelp" ? (l(), C(p(u1), {
      key: 4,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcInfo" ? (l(), C(p(C1), {
      key: 5,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcNotification" ? (l(), C(p(p1), {
      key: 6,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPayback" ? (l(), C(p(f1), {
      key: 7,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlane" ? (l(), C(p(_1), {
      key: 8,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSetting" ? (l(), C(p(g1), {
      key: 9,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcUpdate" ? (l(), C(p(w1), {
      key: 10,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMedia" ? (l(), C(p(m1), {
      key: 11,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMinus" ? (l(), C(p(y1), {
      key: 12,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLink" ? (l(), C(p(I1), {
      key: 13,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcArrowRight" ? (l(), C(p(J), {
      key: 14,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDown" ? (l(), C(p($1), {
      key: 15,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcEdit" ? (l(), C(p(k1), {
      key: 16,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcFill" ? (l(), C(p(x1), {
      key: 17,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcGraphicEmpty" ? (l(), C(p(L1), {
      key: 18,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCopy" ? (l(), C(p(b1), {
      key: 19,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDelete" ? (l(), C(p(M1), {
      key: 20,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlus" ? (l(), C(p(H1), {
      key: 21,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcMoreVertical" ? (l(), C(p(B1), {
      key: 22,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCancleFill" ? (l(), C(p(V1), {
      key: 23,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChecked" ? (l(), C(p(E1), {
      key: 24,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSparkle" ? (l(), C(p(N1), {
      key: 25,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcStock" ? (l(), C(p(p6), {
      key: 26,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPreview" ? (l(), C(p(Z1), {
      key: 27,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLoadingPrimary" ? (l(), C(p(T1), {
      key: 28,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLayer" ? (l(), C(p(F1), {
      key: 29,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCta" ? (l(), C(p(P1), {
      key: 30,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSearch" ? (l(), C(p(A1), {
      key: 31,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcClose" ? (l(), C(p(S1), {
      key: 32,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreUser" ? (l(), C(p(P6), {
      key: 33,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcCoreCart" ? (l(), C(p(O6), {
      key: 34,
      color: e.color
    }, null, 8, ["color"])) : E("", !0);
  }
}), d3 = /* @__PURE__ */ O(c3, [["__scopeId", "data-v-f9e2815a"]]), u3 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, C3 = ["fill"], c1 = /* @__PURE__ */ u({
  __name: "IcApp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", u3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, I3 = ["fill"], h1 = /* @__PURE__ */ u({
  __name: "IcOption",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", y3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, k3 = ["fill"], f1 = /* @__PURE__ */ u({
  __name: "IcPayback",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", $3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, L3 = ["fill"], v1 = /* @__PURE__ */ u({
  __name: "IcPerson",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", x3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, E3 = ["fill"], g1 = /* @__PURE__ */ u({
  __name: "IcSetting",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", V3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, F3 = ["fill"], I1 = /* @__PURE__ */ u({
  __name: "IcLink",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", T3, [
      o("path", {
  ...
  viewBox: "0 0 20 20",
  fill: "none"
}, G3 = ["fill"], k1 = /* @__PURE__ */ u({
  __name: "IcEdit",
  props: {
    color: { default: () => "#060608" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", R3, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, X3 = { id: "Group 395" }, K3 = ["fill"], W3 = ["fill"], b1 = /* @__PURE__ */ u({
  __name: "IcCopy",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, Q3 = { id: "ic-plus" }, e6 = ["fill"], H1 = /* @__PURE__ */ u({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", J3, [
      o("g", Q3, [
        o("path", {
          id: "Union",
          "fill-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, o6 = ["fill"], t6 = ["fill"], s6 = ["fill"], B1 = /* @__PURE__ */ u({
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, n6 = ["fill"], V1 = /* @__PURE__ */ u({
  __name: "IcCancleFill",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", r6, [
      o("path", {
  ...
  viewBox: "0 0 20 21",
  fill: "none"
}, C6 = ["fill"], p6 = /* @__PURE__ */ u({
  __name: "IcStock",
  props: {
    color: { default: () => "#060608" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", u6, [
      o("path", {
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, _6 = ["fill"], A1 = /* @__PURE__ */ u({
  __name: "IcSearch",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", v6, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, g6 = ["fill"], S1 = /* @__PURE__ */ u({
  __name: "IcClose",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", w6, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, I6 = { "clip-path": "url(#clip0_3951_314363)" }, $6 = ["fill"], k6 = ["fill"], x6 = ["fill"], L6 = ["fill"], b6 = ["fill"], M6 = ["fill"], H6 = ["fill"], B6 = ["fill"], V6 = /* @__PURE__ */ u({
  __name: "IcLoadingPrimary",
  props: {
    color: { default: () => "#6540DE" }
  },
  setup(i) {
    return (e, t) => (l(), s("div", m6, [
      (l(), s("svg", y6, [
        o("g", I6, [
          o("path", {
...
}), T1 = /* @__PURE__ */ O(V6, [["__scopeId", "data-v-9156a366"]]), E6 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, N6 = ["fill"], F1 = /* @__PURE__ */ u({
  __name: "IcLayer",
  props: {
    color: { default: () => "#060608" }
  },
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, A6 = ["fill"], P1 = /* @__PURE__ */ u({
  __name: "IcCta",
  props: {
    color: { default: () => "#716497" }
  },
  setup(i) {
    return (e, t) => (l(), s("svg", Z6, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, T6 = ["stroke"], F6 = ["stroke"], P6 = /* @__PURE__ */ u({
  __name: "IcCoreUser",
  props: {
    color: { default: () => "#303040" }
  },
  ...
  viewBox: "0 0 22 22",
  fill: "none"
}, R6 = { "clip-path": "url(#clip0_1979_140961)" }, G6 = ["stroke"], U6 = ["stroke"], j6 = ["stroke"], O6 = /* @__PURE__ */ u({
  __name: "IcCoreCart",
  props: {
    color: { default: () => "#303040" }
  },
...
const X6 = {
  ...
  TabGroup: a3,
  Swiper: Q
}, D1 = z6(X6), { AdminCreateCards: Y6, UserCreateCards: q6, TabGroup: J6, Swiper: Q6 } = D1, r1 = [
  ...Object.values(D1),
  d3,
  c1,
  d1,
  ...
  install(i, e = {}) {
    r1.forEach((t) => {
      ...
      i.component(n, t);
    }), e.prefix && r1.forEach((t) => {
      const n = t.name || "UnnamedComponent";
      i.component(`${e.prefix}${n}`, t);
    });
  }
};
typeof window < "u" && window.Vue && window.Vue.use(K6);
export {
  Y6 as AdminCreateCards,
  d3 as ElementIcon,
  c1 as IcApp,
  i1 as IcArrowLeft,
  J as IcArrowRight,
  ...
  k1 as IcEdit,
  x1 as IcFill,
  L1 as IcGraphicEmpty,
  u1 as IcHelp,
  C1 as IcInfo,
  F1 as IcLayer,
  I1 as IcLink,
  T1 as IcLoadingPrimary,
  m1 as IcMedia,
  y1 as IcMinus,
  B1 as IcMoreVertical,
  p1 as IcNotification,
  h1 as IcOption,
  f1 as IcPayback,
  v1 as IcPerson,
  _1 as IcPlane,
