import { defineComponent as c, createElementBlock as o, openBlock as l, createElementVNode as t, ref as $, computed as I, onMounted as N1, onUnmounted as j1, watch as J, createBlock as d, createCommentVNode as b, normalizeClass as M, normalizeStyle as X, Fragment as E, renderList as T, renderSlot as G, createTextVNode as P, toDisplayString as k, createVNode as X1, withCtx as z1, withModifiers as Q, unref as C } from "vue";
const U1 = {
  width: "24",
  height: "25",
  viewBox: "0 0 24 25",
  ...
  setup(i, { expose: e, emit: n }) {
    const s = i, w = n, A = $(null), B = $(null), F = $(null), L = $(null), u = $(s.initialSlide), m = $(!1), x = $(!1), V = $({ x: 0, y: 0 }), _ = $({ x: 0, y: 0 }), v = $(0), p = $(null), a = I(() => s.loop ? s.items.length - 1 : Math.max(0, s.items.length - s.slidesPerView)), h = I(() => Math.floor(u.value / s.slidesPerView)), g = I(() => {
      const r = Math.ceil(s.items.length / s.slidesPerView);
      return Array.from({ length: r }, (f, y) => y);
      ...
      const r = -(u.value * (W.value + s.spaceBetween)) + v.value;
      return {
        display: "flex",
      ...
      const r = u.value / a.value, f = s.slidesPerView / s.items.length * 100, y = r * (100 - f);
      return {
        width: `${f}%`,
        left: `${y}%`,
    ...
    })), A1 = (r, f) => s.keyName && r[s.keyName] ? r[s.keyName] : f, F1 = (r) => ({}), S1 = (r) => ({
      width: `${W.value}px`,
      flexShrink: 0
    }), S = (r, f = s.speed) => {
      if (m.value && !x.value) return;
      const y = Math.max(0, Math.min(r, a.value));
      y !== u.value && (m.value = !0, w("transitionStart", { index: y }), u.value = y, setTimeout(() => {
        m.value = !1, w("transitionEnd", { index: y }), w("slideChange", { index: y, item: s.items[y] }), y === 0 && w("reachBeginning"), y === a.value && w("reachEnd");
      }, f));
    }, D = () => {
      s.loop && u.value === a.value ? S(0) : S(u.value + 1);
    }, j = () => {
      s.loop && u.value === 0 ? S(a.value) : S(u.value - 1);
    }, P1 = (r) => {
      s.allowTouchMove && (x.value = !0, V.value = { x: r.clientX, y: r.clientY }, _.value = { x: r.clientX, y: r.clientY }, document.addEventListener("mousemove", z), document.addEventListener("mouseup", U), w("touchStart", r));
    }, z = (r) => {
      if (!x.value) return;
      _.value = { x: r.clientX, y: r.clientY };
      const f = (_.value.x - V.value.x) * s.touchRatio;
      v.value = f, w("touchMove", r);
    }, U = (r) => {
      if (!x.value) return;
      const f = _.value.x - V.value.x;
      Math.abs(f) > s.threshold && (f > 0 ? j() : D()), x.value = !1, v.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", U), w("touchEnd", r);
    }, E1 = (r) => {
      if (!s.allowTouchMove) return;
      x.value = !0;
      const f = r.touches[0];
      V.value = { x: f.clientX, y: f.clientY }, _.value = { x: f.clientX, y: f.clientY }, w("touchStart", r);
    }, T1 = (r) => {
      if (!x.value) return;
      const f = r.touches[0];
      _.value = { x: f.clientX, y: f.clientY };
      const y = (_.value.x - V.value.x) * s.touchRatio;
      v.value = y, w("touchMove", r);
    }, D1 = (r) => {
      if (!x.value) return;
      const f = _.value.x - V.value.x;
      Math.abs(f) > s.threshold && (f > 0 ? j() : D()), x.value = !1, v.value = 0, w("touchEnd", r);
    }, Y = () => {
    ...
    return N1(() => {
      ...
      t("div", {
        ...
        t("div", {
          ...
          (l(!0), o(E, null, T(r.items, (y, H) => (l(), o("div", {
            key: A1(y, H),
      ...
      r.showPagination ? (l(), o("div", {
        ...
        (l(!0), o(E, null, T(g.value, (y, H) => (l(), o("button", {
          key: H,
          onClick: (n9) => S(H * r.slidesPerView),
          ...
          G(r.$slots, "pagination-bullet", {
            ...
            f[0] || (f[0] = t("span", { class: "swiper-bullet-dot" }, null, -1))
          ], !0)
        ], 10, Y1))), 128))
      ], 2)) : b("", !0),
  ...
  for (const [s, w] of e)
    n[s] = w;
  return n;
}, l1 = /* @__PURE__ */ N(q1, [["__scopeId", "data-v-6ed75995"]]), G1 = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 !gap-8 mb-12 items-start" }, K1 = { class: "w-full max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 overflow-hidden h-full flex flex-col" }, J1 = ["onClick"], Q1 = { class: "flex items-center gap-4 h-full" }, e2 = { class: "w-24 h-24 rounded-full border border-gray-300 bg-gray-50 flex-shrink-0 overflow-hidden" }, l2 = ["src", "alt", "onError"], t2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-1"
}, o2 = { class: "flex-1 min-w-0 text-left flex flex-col justify-center" }, n2 = { class: "flex flex-nowrap items-center justify-between gap-3 mb-2" }, s2 = { class: "font-pretendard text-[17px] font-bold leading-[22px] line-clamp-2 text-[#060608]" }, r2 = { class: "text-xs font-medium text-[#303040]" }, i2 = {
  key: 0,
  ...
  setup(i, { emit: e }) {
    const n = i, s = e, w = $(/* @__PURE__ */ new Set()), A = $(n.maxItems), B = I(() => n.shops.slice(0, A.value)), F = (_) => {
      s("shop-click", _);
    }, L = (_) => {
    ...
    return (_, v) => (l(), o("div", G1, [
      (l(!0), o(E, null, T(B.value, (p) => (l(), o("div", {
        key: p.id,
              ...
              t("div", o2, [
                t("div", n2, [
                  ...
                  p.badge ? (l(), o("div", {
                    ...
                    t("span", r2, k(p.badge), 1)
                  ], 2)) : b("", !0)
                ]),
                p.description ? (l(), o("p", i2, k(p.description), 1)) : b("", !0),
                p.period ? (l(), o("p", a2, k(p.period), 1)) : b("", !0)
              ])
            ])
          ], 8, J1),
          v[3] || (v[3] = t("div", { class: "border-t border-gray-200" }, null, -1)),
          t("div", c2, [
            v[2] || (v[2] = t("h3", { class: "text-left font-pretendard text-[15px] font-bold leading-[22px] mb-2 text-[#303040]" }, " 참여작가 ", -1)),
  ...
  emits: ["shop-click", "participant-click"],
  setup(i, { emit: e }) {
    const n = i, s = e, w = $(!1), A = $(null), B = $(/* @__PURE__ */ new Set()), F = $(n.maxItems), L = I(() => n.shops.slice(0, F.value)), u = (a) => {
    ...
    return (a, h) => (l(), o("div", _2, [
      t("div", {
        class: M(p.value)
      }, [
        (l(!0), o(E, null, T(L.value, (g) => (l(), o("div", {
          key: g.id,
          ...
          t("div", y2, [
            ...
            t("h3", L2, k(g.title), 1),
            g.description ? (l(), o("p", x2, k(g.description), 1)) : b("", !0),
            g.period ? (l(), o("p", I2, k(g.period), 1)) : b("", !0),
            g.hashtags ? (l(), o("p", b2, k(g.hashtags), 1)) : b("", !0),
            g.participants && g.participants.length > 0 ? (l(), o("div", k2, [
              (l(!0), o(E, null, T(g.participants, (Z) => (l(), o("div", {
                key: Z.id,
...
}), F2 = /* @__PURE__ */ N(A2, [["__scopeId", "data-v-b37b33f4"]]), S2 = { class: "w-full" }, P2 = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, E2 = ["onClick"], T2 = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
  ...
  setup(i, { emit: e }) {
    const n = i, s = e, w = $(n.modelValue), A = (L) => {
      w.value = L.id, s("update:modelValue", L.id), s("tab-change", L);
    }, B = (L) => {
      const u = w.value === L.id, m = "flex items-center justify-center focus:outline-none hover:border-[#F66D96] border-1";
      return u ? `${m} bg-[#FFE8F0] border-[#F66D96] border-2` : `${m} bg-white border-[#CFD3DA]`;
    }, F = (L) => {
      const u = w.value === L.id, m = "text-sm font-bold text-center whitespace-nowrap";
    ...
    return J(
      ...
      t("div", P2, [
        (l(!0), o(E, null, T(i.tabs, (m) => (l(), o("button", {
          key: m.id,
          class: M(B(m)),
          onClick: (x) => A(m),
          type: "button"
...
}, D2 = /* @__PURE__ */ N(T2, [["__scopeId", "data-v-f10093a6"]]), N2 = /* @__PURE__ */ c({
  __name: "ElementIcon",
  props: {
    elementIcon: {},
    color: {}
  ...
  setup(i) {
    return (e, n) => e.elementIcon === "IcApp" ? (l(), d(C(t1), {
      ...
      key: 22,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLoadingPrimary" ? (l(), d(C(b1), {
      key: 23,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcLayer" ? (l(), d(C(k1), {
      key: 24,
      color: e.color
...
}), j2 = /* @__PURE__ */ N(N2, [["__scopeId", "data-v-c7e0d0ce"]]), X2 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, b3 = ["fill"], k3 = ["fill"], M3 = ["fill"], m1 = /* @__PURE__ */ c({
...
}), b1 = /* @__PURE__ */ N(J3, [["__scopeId", "data-v-9156a366"]]), Q3 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, e9 = ["fill"], k1 = /* @__PURE__ */ c({
  __name: "IcLayer",
  props: {
