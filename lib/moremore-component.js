...
const R1 = {
  ...
  setup(r, { expose: e, emit: s }) {
    const n = r, _ = s, A = $(null), H = $(null), F = $(null), k = $(null), C = $(n.initialSlide), m = $(!1), I = $(!1), y = $({ x: 0, y: 0 }), v = $({ x: 0, y: 0 }), p = $(0), x = $(null), d = L(() => n.loop ? n.items.length - 1 : Math.max(0, n.items.length - n.slidesPerView)), h = L(() => Math.floor(C.value / n.slidesPerView)), w = L(() => {
      const i = Math.ceil(n.items.length / n.slidesPerView);
      return Array.from({ length: i }, (f, g) => g);
    }), Z = L(() => (console.log("showPrevButton", n.loop, C.value, d.value), n.loop || C.value > 0)), R = L(() => (console.log("showNextButton", n.loop, C.value, d.value), n.loop || C.value < d.value)), W = L(() => H.value ? (H.value.clientWidth - (n.slidesPerView - 1) * n.spaceBetween) / n.slidesPerView : 0), V1 = L(() => ({
      overflow: "hidden",
      position: "relative"
    })), Z1 = L(() => {
      const i = -(C.value * (W.value + n.spaceBetween)) + p.value;
      return {
        display: "flex",
        transition: m.value && !I.value ? `transform ${n.speed}ms ${n.easing}` : "none",
        transform: `translateX(${i}px)`,
        gap: `${n.spaceBetween}px`
      };
    }), A1 = L(() => {
      if (!n.items.length) return { width: "0%", left: "0%" };
      const i = C.value / d.value, f = n.slidesPerView / n.items.length * 100, g = i * (100 - f);
      return {
        width: `${f}%`,
        left: `${g}%`,
    ...
    })), S1 = (i, f) => n.keyName && i[n.keyName] ? i[n.keyName] : f, P1 = (i) => ({}), E1 = (i) => ({
      width: `${W.value}px`,
      flexShrink: 0
    }), S = (i, f = n.speed) => {
      if (m.value && !I.value) return;
      const g = Math.max(0, Math.min(i, d.value));
      g !== C.value && (m.value = !0, _("transitionStart", { index: g }), C.value = g, setTimeout(() => {
        m.value = !1, _("transitionEnd", { index: g }), _("slideChange", { index: g, item: n.items[g] }), g === 0 && _("reachBeginning"), g === d.value && _("reachEnd");
      }, f));
    }, N = () => {
      n.loop && C.value === d.value ? S(0) : S(C.value + 1);
    }, T = () => {
      n.loop && C.value === 0 ? S(d.value) : S(C.value - 1);
    }, D1 = (i) => {
      n.allowTouchMove && (I.value = !0, y.value = { x: i.clientX, y: i.clientY }, v.value = { x: i.clientX, y: i.clientY }, document.addEventListener("mousemove", z), document.addEventListener("mouseup", O), _("touchStart", i));
    }, z = (i) => {
      if (!I.value) return;
      v.value = { x: i.clientX, y: i.clientY };
      const f = (v.value.x - y.value.x) * n.touchRatio;
      p.value = f, _("touchMove", i);
    }, O = (i) => {
      if (!I.value) return;
      const f = v.value.x - y.value.x;
      Math.abs(f) > n.threshold && (f > 0 ? T() : N()), I.value = !1, p.value = 0, document.removeEventListener("mousemove", z), document.removeEventListener("mouseup", O), _("touchEnd", i);
    }, N1 = (i) => {
      ...
      const g = (v.value.x - y.value.x) * n.touchRatio;
      p.value = g, _("touchMove", i);
    }, T1 = (i) => {
      if (!I.value) return;
      const f = v.value.x - y.value.x;
      Math.abs(f) > n.threshold && (f > 0 ? T() : N()), I.value = !1, p.value = 0, _("touchEnd", i);
    }, Y = () => {
    ...
    return U1(() => {
      ...
      i.showPagination ? (l(), t("div", {
        ...
        (l(!0), t(E, null, D(w.value, (g, B) => (l(), t("button", {
          key: B,
          onClick: (w9) => S(B * i.slidesPerView),
  ...
  for (const [n, _] of e)
    s[n] = _;
  return s;
}, o1 = /* @__PURE__ */ j(K1, [["__scopeId", "data-v-6ed75995"]]), J1 = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 !gap-8 mb-12 items-start" }, Q1 = { class: "w-full max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 overflow-hidden h-full flex flex-col" }, e2 = ["onClick"], l2 = { class: "flex items-center gap-4 h-full" }, o2 = { class: "w-24 h-24 rounded-full border border-gray-300 bg-gray-50 flex-shrink-0 overflow-hidden" }, t2 = ["src", "alt", "onError"], s2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-1"
}, n2 = { class: "flex-1 min-w-0 text-left flex flex-col justify-center" }, r2 = { class: "flex flex-nowrap items-center justify-between gap-3 mb-2" }, i2 = { class: "font-pretendard text-[17px] font-bold leading-[22px] line-clamp-2 text-[#060608]" }, a2 = {
  key: 0,
...
}, v2 = { class: "font-pretendard text-[13px] font-normal leading-[20px] line-clamp-1 text-center text-[#303040]" }, m2 = /* @__PURE__ */ a({
  ...
  setup(r, { emit: e }) {
    const s = r, n = e, _ = $(/* @__PURE__ */ new Set()), A = $(s.maxItems), H = L(() => s.shops.slice(0, A.value)), F = (y) => {
      n("shop-click", y);
    }, k = (y) => {
      n("partnerUser-click", y);
    }, C = (y) => {
      ...
      _.value.add(y);
    }, I = (y) => y.thumbImgUrl && !_.value.has(y.collaborationId);
            ...
            o("div", l2, [
              o("div", o2, [
                I(p) ? (l(), t("img", {
                  ...
                  src: p.thumbImgUrl,
                  alt: p.marketName,
                  onError: (x) => m(p.collaborationId),
                  class: "w-full h-full object-cover"
                }, null, 40, t2)) : (l(), t("div", s2, v[0] || (v[0] = [
...
}), w2 = { class: "w-full" }, g2 = ["onClick"], y2 = { class: "relative aspect-[4/3] rounded-lg border border-gray-200" }, $2 = ["src", "alt", "onError"], k2 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center gap-2"
}, I2 = { class: "p-3 text-left" }, L2 = {
  key: 0,
  class: "mb-2"
  ...
  emits: ["shop-click", "partnerUser-click"],
  setup(r, { emit: e }) {
    const s = r, n = e, _ = $(!1), A = $(null), H = $(/* @__PURE__ */ new Set()), F = $(s.maxItems), k = L(() => s.shops.slice(0, F.value)), C = (d) => {
      A.value = d, _.value = !0, n("shop-click", d);
    }, m = (d) => {
      n("partnerUser-click", d);
    }, I = (d) => {
      ...
      H.value.add(d);
    }, p = (d) => d.thumbImgUrl && !H.value.has(d.collaborationId), x = L(() => {
      const d = s.itemsPerRow;
    ...
    return (d, h) => (l(), t("div", w2, [
      o("div", {
        class: V(x.value)
      }, [
        (l(!0), t(E, null, D(k.value, (w) => (l(), t("div", {
          ...
          o("div", I2, [
            w.statusMessage ? (l(), t("div", L2, [
              o("div", {
                class: V([I(w.statusMessage), "text-[#303040]"])
              }, [
                o("div", {
                  class: V(y(w.statusMessage))
                }, null, 2),
                P(" " + M(w.statusMessage), 1)
              ], 2)
            ])) : b("", !0),
            o("h3", x2, M(w.marketName), 1),
            w.description ? (l(), t("p", b2, M(w.description), 1)) : b("", !0),
            w.period ? (l(), t("p", M2, M(w.period), 1)) : b("", !0),
            w.hashtags ? (l(), t("p", H2, M(w.hashtags), 1)) : b("", !0),
            w.partnerUsersData && w.partnerUsersData.length > 0 ? (l(), t("div", B2, [
              (l(!0), t(E, null, D(w.partnerUsersData, (Z) => (l(), t("div", {
                key: Z.id,
...
}), E2 = /* @__PURE__ */ j(P2, [["__scopeId", "data-v-2f954e6f"]]), D2 = { class: "w-full" }, N2 = { class: "flex items-stretch gap-4 px-5 flex-wrap" }, j2 = ["onClick"], T2 = {
  __name: "TabGroup",
  props: {
    tabs: {
      type: Array,
  ...
  setup(r, { emit: e }) {
    const s = r, n = e, _ = $(s.modelValue), A = (k) => {
      _.value = k.id, n("update:modelValue", k.id), n("tab-change", k);
    }, H = (k) => {
      const C = _.value === k.id, m = "flex items-center justify-center focus:outline-none hover:border-[#F66D96] border-1";
      return C ? `${m} bg-[#FFE8F0] border-[#F66D96] border-2` : `${m} bg-white border-[#CFD3DA] border-2`;
    }, F = (k) => {
      const C = _.value === k.id, m = "text-sm font-bold text-center whitespace-nowrap";
      return C ? `${m} text-[#F66D96]` : `${m} text-[#424855]`;
    };
    return Q(
      () => s.modelValue,
      (k) => {
      ...
      o("div", N2, [
        (l(!0), t(E, null, D(r.tabs, (m) => (l(), t("button", {
          key: m.id,
          class: V(H(m)),
          onClick: (I) => A(m),
          type: "button"
  ...
  setup(r) {
    return (e, s) => e.elementIcon === "IcApp" ? (l(), c(u(t1), {
      key: 0,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcChart" ? (l(), c(u(s1), {
      key: 1,
      color: e.color
      ...
      key: 3,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcHelp" ? (l(), c(u(n1), {
      key: 4,
      color: e.color
      ...
      key: 15,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcDelete" ? (l(), c(u(m1), {
      key: 16,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPlus" ? (l(), c(u(w1), {
      key: 17,
      color: e.color
      ...
      key: 21,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcPreview" ? (l(), c(u(I1), {
      key: 22,
      color: e.color
      ...
      key: 25,
      color: e.color
    }, null, 8, ["color"])) : e.elementIcon === "IcSearch" ? (l(), c(u(L1), {
      key: 26,
      color: e.color
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, Y2 = ["fill"], s1 = /* @__PURE__ */ a({
  __name: "IcChart",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", W2, [
      o("path", {
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, q2 = ["fill"], n1 = /* @__PURE__ */ a({
  __name: "IcHelp",
  props: {
    color: { default: () => "#ABAFB9" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", G2, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, x3 = { id: "ic-plus" }, b3 = ["fill"], w1 = /* @__PURE__ */ a({
  __name: "IcPlus",
  props: {
    color: { default: () => "#5C6476" }
  },
  ...
  viewBox: "0 0 21 21",
  fill: "none"
}, T3 = ["fill"], L1 = /* @__PURE__ */ a({
  __name: "IcSearch",
  props: {
    color: { default: () => "#5C6476" }
  },
  setup(r) {
    return (e, s) => (l(), t("svg", j3, [
      o("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
...
const v9 = {
  ...
  TabGroup: U2,
  Swiper: o1
}, B1 = _9(v9), { AdminCreateCards: y9, UserCreateCards: $9, TabGroup: k9, Swiper: I9 } = B1, J = [
  ...Object.values(B1),
  O2,
  t1,
  s1,
  ...
  install(r, e = {}) {
    J.forEach((s) => {
      ...
      r.component(n, s);
    }), e.prefix && J.forEach((s) => {
      const n = s.name || "UnnamedComponent";
      r.component(`${e.prefix}${n}`, s);
    });
  }
};
typeof window < "u" && window.Vue && window.Vue.use(m9);
export {
